...
import org.edfi.model.resource.EdFiStudentAcademicRecord;
...
public class StudentAcademicRecordsApi {
    ...
    private com.squareup.okhttp.Call deleteStudentAcademicRecordByIdCall(String id, String ifMatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/ed-fi/studentAcademicRecords/{id}".replaceAll("\\{format\\}","json")
    ...
    public ApiResponse<Void> deleteStudentAcademicRecordByIdWithHttpInfo(String id, String ifMatch) throws ApiException {
        com.squareup.okhttp.Call call = deleteStudentAcademicRecordByIdCall(id, ifMatch, null, null);
     ...
     */
    public com.squareup.okhttp.Call deleteStudentAcademicRecordByIdAsync(String id, String ifMatch, final ApiCallback<Void> callback) throws ApiException {
    ...
    public ApiResponse<List<EdFiStudentAcademicRecord>> getStudentAcademicRecordsWithHttpInfo(Integer offset, Integer limit, Boolean totalCount, String termDescriptor, Integer educationOrganizationId, Integer schoolYear, String studentUniqueId, String cumulativeEarnedCreditTypeDescriptor, String cumulativeAttemptedCreditTypeDescriptor, String sessionEarnedCreditTypeDescriptor, String sessionAttemptedCreditTypeDescriptor, Double cumulativeAttemptedCreditConversion, Double cumulativeAttemptedCredits, Double cumulativeEarnedCreditConversion, Double cumulativeEarnedCredits, Double cumulativeGradePointAverage, Double cumulativeGradePointsEarned, String gradeValueQualifier, String id, LocalDate projectedGraduationDate, Double sessionAttemptedCreditConversion, Double sessionAttemptedCredits, Double sessionEarnedCreditConversion, Double sessionEarnedCredits, Double sessionGradePointAverage, Double sessionGradePointsEarned) throws ApiException {
        com.squareup.okhttp.Call call = getStudentAcademicRecordsCall(offset, limit, totalCount, termDescriptor, educationOrganizationId, schoolYear, studentUniqueId, cumulativeEarnedCreditTypeDescriptor, cumulativeAttemptedCreditTypeDescriptor, sessionEarnedCreditTypeDescriptor, sessionAttemptedCreditTypeDescriptor, cumulativeAttemptedCreditConversion, cumulativeAttemptedCredits, cumulativeEarnedCreditConversion, cumulativeEarnedCredits, cumulativeGradePointAverage, cumulativeGradePointsEarned, gradeValueQualifier, id, projectedGraduationDate, sessionAttemptedCreditConversion, sessionAttemptedCredits, sessionEarnedCreditConversion, sessionEarnedCredits, sessionGradePointAverage, sessionGradePointsEarned, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getStudentAcademicRecordsAsync(Integer offset, Integer limit, Boolean totalCount, String termDescriptor, Integer educationOrganizationId, Integer schoolYear, String studentUniqueId, String cumulativeEarnedCreditTypeDescriptor, String cumulativeAttemptedCreditTypeDescriptor, String sessionEarnedCreditTypeDescriptor, String sessionAttemptedCreditTypeDescriptor, Double cumulativeAttemptedCreditConversion, Double cumulativeAttemptedCredits, Double cumulativeEarnedCreditConversion, Double cumulativeEarnedCredits, Double cumulativeGradePointAverage, Double cumulativeGradePointsEarned, String gradeValueQualifier, String id, LocalDate projectedGraduationDate, Double sessionAttemptedCreditConversion, Double sessionAttemptedCredits, Double sessionEarnedCreditConversion, Double sessionEarnedCredits, Double sessionGradePointAverage, Double sessionGradePointsEarned, final ApiCallback<List<EdFiStudentAcademicRecord>> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call getStudentAcademicRecordsByIdCall(String id, String ifNoneMatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public EdFiStudentAcademicRecord getStudentAcademicRecordsById(String id, String ifNoneMatch) throws ApiException {
        ApiResponse<EdFiStudentAcademicRecord> resp = getStudentAcademicRecordsByIdWithHttpInfo(id, ifNoneMatch);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<EdFiStudentAcademicRecord> getStudentAcademicRecordsByIdWithHttpInfo(String id, String ifNoneMatch) throws ApiException {
        com.squareup.okhttp.Call call = getStudentAcademicRecordsByIdCall(id, ifNoneMatch, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getStudentAcademicRecordsByIdAsync(String id, String ifNoneMatch, final ApiCallback<EdFiStudentAcademicRecord> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getStudentAcademicRecordsByIdCall(id, ifNoneMatch, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<EdFiStudentAcademicRecord>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for postStudentAcademicRecord */
    private com.squareup.okhttp.Call postStudentAcademicRecordCall(EdFiStudentAcademicRecord studentAcademicRecord, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> postStudentAcademicRecordWithHttpInfo(EdFiStudentAcademicRecord studentAcademicRecord) throws ApiException {
        com.squareup.okhttp.Call call = postStudentAcademicRecordCall(studentAcademicRecord, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postStudentAcademicRecordAsync(EdFiStudentAcademicRecord studentAcademicRecord, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postStudentAcademicRecordCall(studentAcademicRecord, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /* Build call for putStudentAcademicRecord */
    private com.squareup.okhttp.Call putStudentAcademicRecordCall(String id, EdFiStudentAcademicRecord studentAcademicRecord, String ifMatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = studentAcademicRecord;
    ...
    public ApiResponse<Void> putStudentAcademicRecordWithHttpInfo(String id, EdFiStudentAcademicRecord studentAcademicRecord, String ifMatch) throws ApiException {
        com.squareup.okhttp.Call call = putStudentAcademicRecordCall(id, studentAcademicRecord, ifMatch, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call putStudentAcademicRecordAsync(String id, EdFiStudentAcademicRecord studentAcademicRecord, String ifMatch, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = putStudentAcademicRecordCall(id, studentAcademicRecord, ifMatch, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
