...
import org.edfi.model.resource.EdFiCourseOffering;
...
public class CourseOfferingsApi {
    ...
    private com.squareup.okhttp.Call deleteCourseOfferingByIdCall(String id, String ifMatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/ed-fi/courseOfferings/{id}".replaceAll("\\{format\\}","json")
    ...
    public ApiResponse<Void> deleteCourseOfferingByIdWithHttpInfo(String id, String ifMatch) throws ApiException {
        com.squareup.okhttp.Call call = deleteCourseOfferingByIdCall(id, ifMatch, null, null);
     ...
     */
    public com.squareup.okhttp.Call deleteCourseOfferingByIdAsync(String id, String ifMatch, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteCourseOfferingByIdCall(id, ifMatch, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /* Build call for getCourseOfferings */
    private com.squareup.okhttp.Call getCourseOfferingsCall(Integer offset, Integer limit, Boolean totalCount, String localCourseCode, Integer schoolId, Integer schoolYear, String sessionName, String courseCode, Integer educationOrganizationId, String id, Integer instructionalTimePlanned, String localCourseTitle, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/ed-fi/courseOfferings".replaceAll("\\{format\\}","json");
        ...
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "instructionalTimePlanned", instructionalTimePlanned));
        if (localCourseTitle != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "localCourseTitle", localCourseTitle));
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<EdFiCourseOffering> getCourseOfferings(Integer offset, Integer limit, Boolean totalCount, String localCourseCode, Integer schoolId, Integer schoolYear, String sessionName, String courseCode, Integer educationOrganizationId, String id, Integer instructionalTimePlanned, String localCourseTitle) throws ApiException {
        ApiResponse<List<EdFiCourseOffering>> resp = getCourseOfferingsWithHttpInfo(offset, limit, totalCount, localCourseCode, schoolId, schoolYear, sessionName, courseCode, educationOrganizationId, id, instructionalTimePlanned, localCourseTitle);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<EdFiCourseOffering>> getCourseOfferingsWithHttpInfo(Integer offset, Integer limit, Boolean totalCount, String localCourseCode, Integer schoolId, Integer schoolYear, String sessionName, String courseCode, Integer educationOrganizationId, String id, Integer instructionalTimePlanned, String localCourseTitle) throws ApiException {
        com.squareup.okhttp.Call call = getCourseOfferingsCall(offset, limit, totalCount, localCourseCode, schoolId, schoolYear, sessionName, courseCode, educationOrganizationId, id, instructionalTimePlanned, localCourseTitle, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCourseOfferingsAsync(Integer offset, Integer limit, Boolean totalCount, String localCourseCode, Integer schoolId, Integer schoolYear, String sessionName, String courseCode, Integer educationOrganizationId, String id, Integer instructionalTimePlanned, String localCourseTitle, final ApiCallback<List<EdFiCourseOffering>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCourseOfferingsCall(offset, limit, totalCount, localCourseCode, schoolId, schoolYear, sessionName, courseCode, educationOrganizationId, id, instructionalTimePlanned, localCourseTitle, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<EdFiCourseOffering>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for getCourseOfferingsById */
    private com.squareup.okhttp.Call getCourseOfferingsByIdCall(String id, String ifNoneMatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public EdFiCourseOffering getCourseOfferingsById(String id, String ifNoneMatch) throws ApiException {
        ApiResponse<EdFiCourseOffering> resp = getCourseOfferingsByIdWithHttpInfo(id, ifNoneMatch);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<EdFiCourseOffering> getCourseOfferingsByIdWithHttpInfo(String id, String ifNoneMatch) throws ApiException {
        com.squareup.okhttp.Call call = getCourseOfferingsByIdCall(id, ifNoneMatch, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCourseOfferingsByIdAsync(String id, String ifNoneMatch, final ApiCallback<EdFiCourseOffering> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCourseOfferingsByIdCall(id, ifNoneMatch, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<EdFiCourseOffering>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for postCourseOffering */
    private com.squareup.okhttp.Call postCourseOfferingCall(EdFiCourseOffering courseOffering, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> postCourseOfferingWithHttpInfo(EdFiCourseOffering courseOffering) throws ApiException {
        com.squareup.okhttp.Call call = postCourseOfferingCall(courseOffering, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postCourseOfferingAsync(EdFiCourseOffering courseOffering, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postCourseOfferingCall(courseOffering, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /* Build call for putCourseOffering */
    private com.squareup.okhttp.Call putCourseOfferingCall(String id, EdFiCourseOffering courseOffering, String ifMatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = courseOffering;
    ...
    public ApiResponse<Void> putCourseOfferingWithHttpInfo(String id, EdFiCourseOffering courseOffering, String ifMatch) throws ApiException {
        com.squareup.okhttp.Call call = putCourseOfferingCall(id, courseOffering, ifMatch, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call putCourseOfferingAsync(String id, EdFiCourseOffering courseOffering, String ifMatch, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = putCourseOfferingCall(id, courseOffering, ifMatch, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
