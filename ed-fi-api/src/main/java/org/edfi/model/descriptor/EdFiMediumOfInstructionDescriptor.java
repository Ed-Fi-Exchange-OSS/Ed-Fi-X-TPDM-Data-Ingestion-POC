...
public class EdFiMediumOfInstructionDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("mediumOfInstructionDescriptorId")
  private Integer mediumOfInstructionDescriptorId = null;
  ...
  public EdFiMediumOfInstructionDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiMediumOfInstructionDescriptor mediumOfInstructionDescriptorId(Integer mediumOfInstructionDescriptorId) {
    this.mediumOfInstructionDescriptorId = mediumOfInstructionDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return mediumOfInstructionDescriptorId
  **/
  ...
  public Integer getMediumOfInstructionDescriptorId() {
    return mediumOfInstructionDescriptorId;
  }

  public void setMediumOfInstructionDescriptorId(Integer mediumOfInstructionDescriptorId) {
    this.mediumOfInstructionDescriptorId = mediumOfInstructionDescriptorId;
  }

  public EdFiMediumOfInstructionDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiMediumOfInstructionDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiMediumOfInstructionDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiMediumOfInstructionDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiMediumOfInstructionDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiMediumOfInstructionDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiMediumOfInstructionDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiMediumOfInstructionDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiMediumOfInstructionDescriptor edFiMediumOfInstructionDescriptor = (EdFiMediumOfInstructionDescriptor) o;
    return Objects.equals(this.id, edFiMediumOfInstructionDescriptor.id) &&
        Objects.equals(this.mediumOfInstructionDescriptorId, edFiMediumOfInstructionDescriptor.mediumOfInstructionDescriptorId) &&
        Objects.equals(this.codeValue, edFiMediumOfInstructionDescriptor.codeValue) &&
        Objects.equals(this.description, edFiMediumOfInstructionDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiMediumOfInstructionDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiMediumOfInstructionDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiMediumOfInstructionDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiMediumOfInstructionDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiMediumOfInstructionDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiMediumOfInstructionDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, mediumOfInstructionDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiMediumOfInstructionDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    mediumOfInstructionDescriptorId: ").append(toIndentedString(mediumOfInstructionDescriptorId)).append("\n");
