...
public class EdFiAcademicSubjectDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("academicSubjectDescriptorId")
  private Integer academicSubjectDescriptorId = null;
  ...
  public EdFiAcademicSubjectDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiAcademicSubjectDescriptor academicSubjectDescriptorId(Integer academicSubjectDescriptorId) {
    this.academicSubjectDescriptorId = academicSubjectDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return academicSubjectDescriptorId
  **/
  ...
  public Integer getAcademicSubjectDescriptorId() {
    return academicSubjectDescriptorId;
  }

  public void setAcademicSubjectDescriptorId(Integer academicSubjectDescriptorId) {
    this.academicSubjectDescriptorId = academicSubjectDescriptorId;
  }

  public EdFiAcademicSubjectDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiAcademicSubjectDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiAcademicSubjectDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiAcademicSubjectDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiAcademicSubjectDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiAcademicSubjectDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiAcademicSubjectDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiAcademicSubjectDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiAcademicSubjectDescriptor edFiAcademicSubjectDescriptor = (EdFiAcademicSubjectDescriptor) o;
    return Objects.equals(this.id, edFiAcademicSubjectDescriptor.id) &&
        Objects.equals(this.academicSubjectDescriptorId, edFiAcademicSubjectDescriptor.academicSubjectDescriptorId) &&
        Objects.equals(this.codeValue, edFiAcademicSubjectDescriptor.codeValue) &&
        Objects.equals(this.description, edFiAcademicSubjectDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiAcademicSubjectDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiAcademicSubjectDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiAcademicSubjectDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiAcademicSubjectDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiAcademicSubjectDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiAcademicSubjectDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, academicSubjectDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiAcademicSubjectDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    academicSubjectDescriptorId: ").append(toIndentedString(academicSubjectDescriptorId)).append("\n");
