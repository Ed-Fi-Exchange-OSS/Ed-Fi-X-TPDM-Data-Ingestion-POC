...
public class EdFiEventCircumstanceDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("eventCircumstanceDescriptorId")
  private Integer eventCircumstanceDescriptorId = null;
  ...
  public EdFiEventCircumstanceDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiEventCircumstanceDescriptor eventCircumstanceDescriptorId(Integer eventCircumstanceDescriptorId) {
    this.eventCircumstanceDescriptorId = eventCircumstanceDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return eventCircumstanceDescriptorId
  **/
  ...
  public Integer getEventCircumstanceDescriptorId() {
    return eventCircumstanceDescriptorId;
  }

  public void setEventCircumstanceDescriptorId(Integer eventCircumstanceDescriptorId) {
    this.eventCircumstanceDescriptorId = eventCircumstanceDescriptorId;
  }

  public EdFiEventCircumstanceDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiEventCircumstanceDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiEventCircumstanceDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiEventCircumstanceDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiEventCircumstanceDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiEventCircumstanceDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiEventCircumstanceDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiEventCircumstanceDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiEventCircumstanceDescriptor edFiEventCircumstanceDescriptor = (EdFiEventCircumstanceDescriptor) o;
    return Objects.equals(this.id, edFiEventCircumstanceDescriptor.id) &&
        Objects.equals(this.eventCircumstanceDescriptorId, edFiEventCircumstanceDescriptor.eventCircumstanceDescriptorId) &&
        Objects.equals(this.codeValue, edFiEventCircumstanceDescriptor.codeValue) &&
        Objects.equals(this.description, edFiEventCircumstanceDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiEventCircumstanceDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiEventCircumstanceDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiEventCircumstanceDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiEventCircumstanceDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiEventCircumstanceDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiEventCircumstanceDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, eventCircumstanceDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiEventCircumstanceDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    eventCircumstanceDescriptorId: ").append(toIndentedString(eventCircumstanceDescriptorId)).append("\n");
