...
public class EdFiLocaleDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("localeDescriptorId")
  private Integer localeDescriptorId = null;
  ...
  public EdFiLocaleDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiLocaleDescriptor localeDescriptorId(Integer localeDescriptorId) {
    this.localeDescriptorId = localeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return localeDescriptorId
  **/
  ...
  public Integer getLocaleDescriptorId() {
    return localeDescriptorId;
  }

  public void setLocaleDescriptorId(Integer localeDescriptorId) {
    this.localeDescriptorId = localeDescriptorId;
  }

  public EdFiLocaleDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiLocaleDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiLocaleDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiLocaleDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiLocaleDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiLocaleDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiLocaleDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiLocaleDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiLocaleDescriptor edFiLocaleDescriptor = (EdFiLocaleDescriptor) o;
    return Objects.equals(this.id, edFiLocaleDescriptor.id) &&
        Objects.equals(this.localeDescriptorId, edFiLocaleDescriptor.localeDescriptorId) &&
        Objects.equals(this.codeValue, edFiLocaleDescriptor.codeValue) &&
        Objects.equals(this.description, edFiLocaleDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiLocaleDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiLocaleDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiLocaleDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiLocaleDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiLocaleDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiLocaleDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, localeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiLocaleDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    localeDescriptorId: ").append(toIndentedString(localeDescriptorId)).append("\n");
