...
public class EdFiProviderCategoryDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("providerCategoryDescriptorId")
  private Integer providerCategoryDescriptorId = null;
  ...
  public EdFiProviderCategoryDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiProviderCategoryDescriptor providerCategoryDescriptorId(Integer providerCategoryDescriptorId) {
   ...
   * @return providerCategoryDescriptorId
  **/
  ...
  public Integer getProviderCategoryDescriptorId() {
    return providerCategoryDescriptorId;
  }

  public void setProviderCategoryDescriptorId(Integer providerCategoryDescriptorId) {
    this.providerCategoryDescriptorId = providerCategoryDescriptorId;
  }

  public EdFiProviderCategoryDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiProviderCategoryDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiProviderCategoryDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiProviderCategoryDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiProviderCategoryDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiProviderCategoryDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiProviderCategoryDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiProviderCategoryDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiProviderCategoryDescriptor edFiProviderCategoryDescriptor = (EdFiProviderCategoryDescriptor) o;
    return Objects.equals(this.id, edFiProviderCategoryDescriptor.id) &&
        Objects.equals(this.providerCategoryDescriptorId, edFiProviderCategoryDescriptor.providerCategoryDescriptorId) &&
        Objects.equals(this.codeValue, edFiProviderCategoryDescriptor.codeValue) &&
        Objects.equals(this.description, edFiProviderCategoryDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiProviderCategoryDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiProviderCategoryDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiProviderCategoryDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiProviderCategoryDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiProviderCategoryDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiProviderCategoryDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, providerCategoryDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }
  ...
  public String toString() {
    ...
    sb.append("    providerCategoryDescriptorId: ").append(toIndentedString(providerCategoryDescriptorId)).append("\n");
