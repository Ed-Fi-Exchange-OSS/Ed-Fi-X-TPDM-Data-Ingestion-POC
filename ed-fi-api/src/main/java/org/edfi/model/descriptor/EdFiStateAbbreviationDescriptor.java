...
public class EdFiStateAbbreviationDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("stateAbbreviationDescriptorId")
  private Integer stateAbbreviationDescriptorId = null;
  ...
  public EdFiStateAbbreviationDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiStateAbbreviationDescriptor stateAbbreviationDescriptorId(Integer stateAbbreviationDescriptorId) {
    this.stateAbbreviationDescriptorId = stateAbbreviationDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return stateAbbreviationDescriptorId
  **/
  ...
  public Integer getStateAbbreviationDescriptorId() {
    return stateAbbreviationDescriptorId;
  }

  public void setStateAbbreviationDescriptorId(Integer stateAbbreviationDescriptorId) {
    this.stateAbbreviationDescriptorId = stateAbbreviationDescriptorId;
  }

  public EdFiStateAbbreviationDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiStateAbbreviationDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiStateAbbreviationDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiStateAbbreviationDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiStateAbbreviationDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiStateAbbreviationDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiStateAbbreviationDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiStateAbbreviationDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiStateAbbreviationDescriptor edFiStateAbbreviationDescriptor = (EdFiStateAbbreviationDescriptor) o;
    return Objects.equals(this.id, edFiStateAbbreviationDescriptor.id) &&
        Objects.equals(this.stateAbbreviationDescriptorId, edFiStateAbbreviationDescriptor.stateAbbreviationDescriptorId) &&
        Objects.equals(this.codeValue, edFiStateAbbreviationDescriptor.codeValue) &&
        Objects.equals(this.description, edFiStateAbbreviationDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiStateAbbreviationDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiStateAbbreviationDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiStateAbbreviationDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiStateAbbreviationDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiStateAbbreviationDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiStateAbbreviationDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, stateAbbreviationDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiStateAbbreviationDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    stateAbbreviationDescriptorId: ").append(toIndentedString(stateAbbreviationDescriptorId)).append("\n");
