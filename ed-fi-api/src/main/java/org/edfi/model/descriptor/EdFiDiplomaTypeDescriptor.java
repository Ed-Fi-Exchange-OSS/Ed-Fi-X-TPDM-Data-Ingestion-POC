...
public class EdFiDiplomaTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("diplomaTypeDescriptorId")
  private Integer diplomaTypeDescriptorId = null;
  ...
  public EdFiDiplomaTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiDiplomaTypeDescriptor diplomaTypeDescriptorId(Integer diplomaTypeDescriptorId) {
    this.diplomaTypeDescriptorId = diplomaTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return diplomaTypeDescriptorId
  **/
  ...
  public Integer getDiplomaTypeDescriptorId() {
    return diplomaTypeDescriptorId;
  }

  public void setDiplomaTypeDescriptorId(Integer diplomaTypeDescriptorId) {
    this.diplomaTypeDescriptorId = diplomaTypeDescriptorId;
  }

  public EdFiDiplomaTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiDiplomaTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiDiplomaTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiDiplomaTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiDiplomaTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiDiplomaTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiDiplomaTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiDiplomaTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiDiplomaTypeDescriptor edFiDiplomaTypeDescriptor = (EdFiDiplomaTypeDescriptor) o;
    return Objects.equals(this.id, edFiDiplomaTypeDescriptor.id) &&
        Objects.equals(this.diplomaTypeDescriptorId, edFiDiplomaTypeDescriptor.diplomaTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiDiplomaTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiDiplomaTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiDiplomaTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiDiplomaTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiDiplomaTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiDiplomaTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiDiplomaTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiDiplomaTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, diplomaTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiDiplomaTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    diplomaTypeDescriptorId: ").append(toIndentedString(diplomaTypeDescriptorId)).append("\n");
