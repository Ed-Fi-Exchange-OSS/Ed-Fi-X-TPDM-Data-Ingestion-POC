...
public class EdFiCurriculumUsedDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("curriculumUsedDescriptorId")
  private Integer curriculumUsedDescriptorId = null;
  ...
  public EdFiCurriculumUsedDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCurriculumUsedDescriptor curriculumUsedDescriptorId(Integer curriculumUsedDescriptorId) {
    this.curriculumUsedDescriptorId = curriculumUsedDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return curriculumUsedDescriptorId
  **/
  ...
  public Integer getCurriculumUsedDescriptorId() {
    return curriculumUsedDescriptorId;
  }

  public void setCurriculumUsedDescriptorId(Integer curriculumUsedDescriptorId) {
    this.curriculumUsedDescriptorId = curriculumUsedDescriptorId;
  }

  public EdFiCurriculumUsedDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCurriculumUsedDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCurriculumUsedDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCurriculumUsedDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCurriculumUsedDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCurriculumUsedDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCurriculumUsedDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCurriculumUsedDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCurriculumUsedDescriptor edFiCurriculumUsedDescriptor = (EdFiCurriculumUsedDescriptor) o;
    return Objects.equals(this.id, edFiCurriculumUsedDescriptor.id) &&
        Objects.equals(this.curriculumUsedDescriptorId, edFiCurriculumUsedDescriptor.curriculumUsedDescriptorId) &&
        Objects.equals(this.codeValue, edFiCurriculumUsedDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCurriculumUsedDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCurriculumUsedDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCurriculumUsedDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCurriculumUsedDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCurriculumUsedDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCurriculumUsedDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCurriculumUsedDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, curriculumUsedDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCurriculumUsedDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    curriculumUsedDescriptorId: ").append(toIndentedString(curriculumUsedDescriptorId)).append("\n");
