...
/**
 * TpdmGpaTypeDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmGpaTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("gpaTypeDescriptorId")
  private Integer gpaTypeDescriptorId = null;
  ...
  public TpdmGpaTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmGpaTypeDescriptor gpaTypeDescriptorId(Integer gpaTypeDescriptorId) {
    this.gpaTypeDescriptorId = gpaTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return gpaTypeDescriptorId
  **/
  ...
  public Integer getGpaTypeDescriptorId() {
    return gpaTypeDescriptorId;
  }

  public void setGpaTypeDescriptorId(Integer gpaTypeDescriptorId) {
    this.gpaTypeDescriptorId = gpaTypeDescriptorId;
  }

  public TpdmGpaTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmGpaTypeDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmGpaTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmGpaTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmGpaTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmGpaTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmGpaTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmGpaTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmGpaTypeDescriptor tpdmGpaTypeDescriptor = (TpdmGpaTypeDescriptor) o;
    return Objects.equals(this.id, tpdmGpaTypeDescriptor.id) &&
        Objects.equals(this.gpaTypeDescriptorId, tpdmGpaTypeDescriptor.gpaTypeDescriptorId) &&
        Objects.equals(this.codeValue, tpdmGpaTypeDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmGpaTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmGpaTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmGpaTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmGpaTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmGpaTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmGpaTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmGpaTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, gpaTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmGpaTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    gpaTypeDescriptorId: ").append(toIndentedString(gpaTypeDescriptorId)).append("\n");
