...
public class EdFiParticipationDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("participationDescriptorId")
  private Integer participationDescriptorId = null;
  ...
  public EdFiParticipationDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiParticipationDescriptor participationDescriptorId(Integer participationDescriptorId) {
    this.participationDescriptorId = participationDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return participationDescriptorId
  **/
  ...
  public Integer getParticipationDescriptorId() {
    return participationDescriptorId;
  }

  public void setParticipationDescriptorId(Integer participationDescriptorId) {
    this.participationDescriptorId = participationDescriptorId;
  }

  public EdFiParticipationDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiParticipationDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiParticipationDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiParticipationDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiParticipationDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiParticipationDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiParticipationDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiParticipationDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiParticipationDescriptor edFiParticipationDescriptor = (EdFiParticipationDescriptor) o;
    return Objects.equals(this.id, edFiParticipationDescriptor.id) &&
        Objects.equals(this.participationDescriptorId, edFiParticipationDescriptor.participationDescriptorId) &&
        Objects.equals(this.codeValue, edFiParticipationDescriptor.codeValue) &&
        Objects.equals(this.description, edFiParticipationDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiParticipationDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiParticipationDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiParticipationDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiParticipationDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiParticipationDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiParticipationDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, participationDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiParticipationDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    participationDescriptorId: ").append(toIndentedString(participationDescriptorId)).append("\n");
