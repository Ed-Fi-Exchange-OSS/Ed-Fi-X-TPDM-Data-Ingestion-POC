...
/**
 * TpdmStudentGrowthTypeDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmStudentGrowthTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("studentGrowthTypeDescriptorId")
  private Integer studentGrowthTypeDescriptorId = null;
  ...
  public TpdmStudentGrowthTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmStudentGrowthTypeDescriptor studentGrowthTypeDescriptorId(Integer studentGrowthTypeDescriptorId) {
    this.studentGrowthTypeDescriptorId = studentGrowthTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return studentGrowthTypeDescriptorId
  **/
  ...
  public Integer getStudentGrowthTypeDescriptorId() {
    return studentGrowthTypeDescriptorId;
  }

  public void setStudentGrowthTypeDescriptorId(Integer studentGrowthTypeDescriptorId) {
    this.studentGrowthTypeDescriptorId = studentGrowthTypeDescriptorId;
  }

  public TpdmStudentGrowthTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmStudentGrowthTypeDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmStudentGrowthTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmStudentGrowthTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmStudentGrowthTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmStudentGrowthTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmStudentGrowthTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmStudentGrowthTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmStudentGrowthTypeDescriptor tpdmStudentGrowthTypeDescriptor = (TpdmStudentGrowthTypeDescriptor) o;
    return Objects.equals(this.id, tpdmStudentGrowthTypeDescriptor.id) &&
        Objects.equals(this.studentGrowthTypeDescriptorId, tpdmStudentGrowthTypeDescriptor.studentGrowthTypeDescriptorId) &&
        Objects.equals(this.codeValue, tpdmStudentGrowthTypeDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmStudentGrowthTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmStudentGrowthTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmStudentGrowthTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmStudentGrowthTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmStudentGrowthTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmStudentGrowthTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmStudentGrowthTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, studentGrowthTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmStudentGrowthTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    studentGrowthTypeDescriptorId: ").append(toIndentedString(studentGrowthTypeDescriptorId)).append("\n");
