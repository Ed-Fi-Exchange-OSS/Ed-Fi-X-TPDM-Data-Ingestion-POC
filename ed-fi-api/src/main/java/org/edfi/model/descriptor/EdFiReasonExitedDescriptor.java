...
public class EdFiReasonExitedDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("reasonExitedDescriptorId")
  private Integer reasonExitedDescriptorId = null;
  ...
  public EdFiReasonExitedDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiReasonExitedDescriptor reasonExitedDescriptorId(Integer reasonExitedDescriptorId) {
    this.reasonExitedDescriptorId = reasonExitedDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return reasonExitedDescriptorId
  **/
  ...
  public Integer getReasonExitedDescriptorId() {
    return reasonExitedDescriptorId;
  }

  public void setReasonExitedDescriptorId(Integer reasonExitedDescriptorId) {
    this.reasonExitedDescriptorId = reasonExitedDescriptorId;
  }

  public EdFiReasonExitedDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiReasonExitedDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiReasonExitedDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiReasonExitedDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiReasonExitedDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiReasonExitedDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiReasonExitedDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiReasonExitedDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiReasonExitedDescriptor edFiReasonExitedDescriptor = (EdFiReasonExitedDescriptor) o;
    return Objects.equals(this.id, edFiReasonExitedDescriptor.id) &&
        Objects.equals(this.reasonExitedDescriptorId, edFiReasonExitedDescriptor.reasonExitedDescriptorId) &&
        Objects.equals(this.codeValue, edFiReasonExitedDescriptor.codeValue) &&
        Objects.equals(this.description, edFiReasonExitedDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiReasonExitedDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiReasonExitedDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiReasonExitedDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiReasonExitedDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiReasonExitedDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiReasonExitedDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, reasonExitedDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiReasonExitedDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    reasonExitedDescriptorId: ").append(toIndentedString(reasonExitedDescriptorId)).append("\n");
