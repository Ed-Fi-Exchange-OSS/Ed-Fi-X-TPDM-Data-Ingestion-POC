...
public class EdFiLicenseStatusDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("licenseStatusDescriptorId")
  private Integer licenseStatusDescriptorId = null;
  ...
  public EdFiLicenseStatusDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiLicenseStatusDescriptor licenseStatusDescriptorId(Integer licenseStatusDescriptorId) {
    this.licenseStatusDescriptorId = licenseStatusDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return licenseStatusDescriptorId
  **/
  ...
  public Integer getLicenseStatusDescriptorId() {
    return licenseStatusDescriptorId;
  }

  public void setLicenseStatusDescriptorId(Integer licenseStatusDescriptorId) {
    this.licenseStatusDescriptorId = licenseStatusDescriptorId;
  }

  public EdFiLicenseStatusDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiLicenseStatusDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiLicenseStatusDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiLicenseStatusDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiLicenseStatusDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiLicenseStatusDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiLicenseStatusDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiLicenseStatusDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiLicenseStatusDescriptor edFiLicenseStatusDescriptor = (EdFiLicenseStatusDescriptor) o;
    return Objects.equals(this.id, edFiLicenseStatusDescriptor.id) &&
        Objects.equals(this.licenseStatusDescriptorId, edFiLicenseStatusDescriptor.licenseStatusDescriptorId) &&
        Objects.equals(this.codeValue, edFiLicenseStatusDescriptor.codeValue) &&
        Objects.equals(this.description, edFiLicenseStatusDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiLicenseStatusDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiLicenseStatusDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiLicenseStatusDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiLicenseStatusDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiLicenseStatusDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiLicenseStatusDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, licenseStatusDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiLicenseStatusDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    licenseStatusDescriptorId: ").append(toIndentedString(licenseStatusDescriptorId)).append("\n");
