...
public class EdFiCountryDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("countryDescriptorId")
  private Integer countryDescriptorId = null;
  ...
  public EdFiCountryDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCountryDescriptor countryDescriptorId(Integer countryDescriptorId) {
    this.countryDescriptorId = countryDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return countryDescriptorId
  **/
  ...
  public Integer getCountryDescriptorId() {
    return countryDescriptorId;
  }

  public void setCountryDescriptorId(Integer countryDescriptorId) {
    this.countryDescriptorId = countryDescriptorId;
  }

  public EdFiCountryDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCountryDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCountryDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCountryDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCountryDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCountryDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCountryDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCountryDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCountryDescriptor edFiCountryDescriptor = (EdFiCountryDescriptor) o;
    return Objects.equals(this.id, edFiCountryDescriptor.id) &&
        Objects.equals(this.countryDescriptorId, edFiCountryDescriptor.countryDescriptorId) &&
        Objects.equals(this.codeValue, edFiCountryDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCountryDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCountryDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCountryDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCountryDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCountryDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCountryDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCountryDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, countryDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCountryDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    countryDescriptorId: ").append(toIndentedString(countryDescriptorId)).append("\n");
