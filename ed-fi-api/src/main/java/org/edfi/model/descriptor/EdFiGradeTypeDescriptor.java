...
public class EdFiGradeTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("gradeTypeDescriptorId")
  private Integer gradeTypeDescriptorId = null;
  ...
  public EdFiGradeTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiGradeTypeDescriptor gradeTypeDescriptorId(Integer gradeTypeDescriptorId) {
    this.gradeTypeDescriptorId = gradeTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return gradeTypeDescriptorId
  **/
  ...
  public Integer getGradeTypeDescriptorId() {
    return gradeTypeDescriptorId;
  }

  public void setGradeTypeDescriptorId(Integer gradeTypeDescriptorId) {
    this.gradeTypeDescriptorId = gradeTypeDescriptorId;
  }

  public EdFiGradeTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiGradeTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiGradeTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiGradeTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiGradeTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiGradeTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiGradeTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiGradeTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiGradeTypeDescriptor edFiGradeTypeDescriptor = (EdFiGradeTypeDescriptor) o;
    return Objects.equals(this.id, edFiGradeTypeDescriptor.id) &&
        Objects.equals(this.gradeTypeDescriptorId, edFiGradeTypeDescriptor.gradeTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiGradeTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiGradeTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiGradeTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiGradeTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiGradeTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiGradeTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiGradeTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiGradeTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, gradeTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiGradeTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    gradeTypeDescriptorId: ").append(toIndentedString(gradeTypeDescriptorId)).append("\n");
