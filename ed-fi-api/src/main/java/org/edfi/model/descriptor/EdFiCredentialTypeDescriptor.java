...
public class EdFiCredentialTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("credentialTypeDescriptorId")
  private Integer credentialTypeDescriptorId = null;
  ...
  public EdFiCredentialTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCredentialTypeDescriptor credentialTypeDescriptorId(Integer credentialTypeDescriptorId) {
    this.credentialTypeDescriptorId = credentialTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return credentialTypeDescriptorId
  **/
  ...
  public Integer getCredentialTypeDescriptorId() {
    return credentialTypeDescriptorId;
  }

  public void setCredentialTypeDescriptorId(Integer credentialTypeDescriptorId) {
    this.credentialTypeDescriptorId = credentialTypeDescriptorId;
  }

  public EdFiCredentialTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCredentialTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCredentialTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCredentialTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCredentialTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCredentialTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCredentialTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCredentialTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCredentialTypeDescriptor edFiCredentialTypeDescriptor = (EdFiCredentialTypeDescriptor) o;
    return Objects.equals(this.id, edFiCredentialTypeDescriptor.id) &&
        Objects.equals(this.credentialTypeDescriptorId, edFiCredentialTypeDescriptor.credentialTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiCredentialTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCredentialTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCredentialTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCredentialTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCredentialTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCredentialTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCredentialTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCredentialTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, credentialTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCredentialTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    credentialTypeDescriptorId: ").append(toIndentedString(credentialTypeDescriptorId)).append("\n");
