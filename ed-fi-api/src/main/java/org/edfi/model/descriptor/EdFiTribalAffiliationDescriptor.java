...
public class EdFiTribalAffiliationDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("tribalAffiliationDescriptorId")
  private Integer tribalAffiliationDescriptorId = null;
  ...
  public EdFiTribalAffiliationDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiTribalAffiliationDescriptor tribalAffiliationDescriptorId(Integer tribalAffiliationDescriptorId) {
    this.tribalAffiliationDescriptorId = tribalAffiliationDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return tribalAffiliationDescriptorId
  **/
  ...
  public Integer getTribalAffiliationDescriptorId() {
    return tribalAffiliationDescriptorId;
  }

  public void setTribalAffiliationDescriptorId(Integer tribalAffiliationDescriptorId) {
    this.tribalAffiliationDescriptorId = tribalAffiliationDescriptorId;
  }

  public EdFiTribalAffiliationDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiTribalAffiliationDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiTribalAffiliationDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiTribalAffiliationDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiTribalAffiliationDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiTribalAffiliationDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiTribalAffiliationDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiTribalAffiliationDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiTribalAffiliationDescriptor edFiTribalAffiliationDescriptor = (EdFiTribalAffiliationDescriptor) o;
    return Objects.equals(this.id, edFiTribalAffiliationDescriptor.id) &&
        Objects.equals(this.tribalAffiliationDescriptorId, edFiTribalAffiliationDescriptor.tribalAffiliationDescriptorId) &&
        Objects.equals(this.codeValue, edFiTribalAffiliationDescriptor.codeValue) &&
        Objects.equals(this.description, edFiTribalAffiliationDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiTribalAffiliationDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiTribalAffiliationDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiTribalAffiliationDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiTribalAffiliationDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiTribalAffiliationDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiTribalAffiliationDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tribalAffiliationDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiTribalAffiliationDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    tribalAffiliationDescriptorId: ").append(toIndentedString(tribalAffiliationDescriptorId)).append("\n");
