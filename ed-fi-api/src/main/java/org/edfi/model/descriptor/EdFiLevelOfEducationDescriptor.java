...
public class EdFiLevelOfEducationDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("levelOfEducationDescriptorId")
  private Integer levelOfEducationDescriptorId = null;
  ...
  public EdFiLevelOfEducationDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiLevelOfEducationDescriptor levelOfEducationDescriptorId(Integer levelOfEducationDescriptorId) {
    this.levelOfEducationDescriptorId = levelOfEducationDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return levelOfEducationDescriptorId
  **/
  ...
  public Integer getLevelOfEducationDescriptorId() {
    return levelOfEducationDescriptorId;
  }

  public void setLevelOfEducationDescriptorId(Integer levelOfEducationDescriptorId) {
    this.levelOfEducationDescriptorId = levelOfEducationDescriptorId;
  }

  public EdFiLevelOfEducationDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiLevelOfEducationDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiLevelOfEducationDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiLevelOfEducationDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiLevelOfEducationDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiLevelOfEducationDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiLevelOfEducationDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiLevelOfEducationDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiLevelOfEducationDescriptor edFiLevelOfEducationDescriptor = (EdFiLevelOfEducationDescriptor) o;
    return Objects.equals(this.id, edFiLevelOfEducationDescriptor.id) &&
        Objects.equals(this.levelOfEducationDescriptorId, edFiLevelOfEducationDescriptor.levelOfEducationDescriptorId) &&
        Objects.equals(this.codeValue, edFiLevelOfEducationDescriptor.codeValue) &&
        Objects.equals(this.description, edFiLevelOfEducationDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiLevelOfEducationDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiLevelOfEducationDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiLevelOfEducationDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiLevelOfEducationDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiLevelOfEducationDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiLevelOfEducationDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, levelOfEducationDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiLevelOfEducationDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    levelOfEducationDescriptorId: ").append(toIndentedString(levelOfEducationDescriptorId)).append("\n");
