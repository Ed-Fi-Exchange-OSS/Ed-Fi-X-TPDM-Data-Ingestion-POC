...
public class EdFiLanguageDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("languageDescriptorId")
  private Integer languageDescriptorId = null;
  ...
  public EdFiLanguageDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiLanguageDescriptor languageDescriptorId(Integer languageDescriptorId) {
    this.languageDescriptorId = languageDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return languageDescriptorId
  **/
  ...
  public Integer getLanguageDescriptorId() {
    return languageDescriptorId;
  }

  public void setLanguageDescriptorId(Integer languageDescriptorId) {
    this.languageDescriptorId = languageDescriptorId;
  }

  public EdFiLanguageDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiLanguageDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiLanguageDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiLanguageDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiLanguageDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiLanguageDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiLanguageDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiLanguageDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiLanguageDescriptor edFiLanguageDescriptor = (EdFiLanguageDescriptor) o;
    return Objects.equals(this.id, edFiLanguageDescriptor.id) &&
        Objects.equals(this.languageDescriptorId, edFiLanguageDescriptor.languageDescriptorId) &&
        Objects.equals(this.codeValue, edFiLanguageDescriptor.codeValue) &&
        Objects.equals(this.description, edFiLanguageDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiLanguageDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiLanguageDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiLanguageDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiLanguageDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiLanguageDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiLanguageDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, languageDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiLanguageDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    languageDescriptorId: ").append(toIndentedString(languageDescriptorId)).append("\n");
