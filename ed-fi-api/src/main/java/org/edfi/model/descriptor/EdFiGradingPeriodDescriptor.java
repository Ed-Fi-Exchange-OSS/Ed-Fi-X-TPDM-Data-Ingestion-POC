...
public class EdFiGradingPeriodDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("gradingPeriodDescriptorId")
  private Integer gradingPeriodDescriptorId = null;
  ...
  public EdFiGradingPeriodDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiGradingPeriodDescriptor gradingPeriodDescriptorId(Integer gradingPeriodDescriptorId) {
    this.gradingPeriodDescriptorId = gradingPeriodDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return gradingPeriodDescriptorId
  **/
  ...
  public Integer getGradingPeriodDescriptorId() {
    return gradingPeriodDescriptorId;
  }

  public void setGradingPeriodDescriptorId(Integer gradingPeriodDescriptorId) {
    this.gradingPeriodDescriptorId = gradingPeriodDescriptorId;
  }

  public EdFiGradingPeriodDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiGradingPeriodDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiGradingPeriodDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiGradingPeriodDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiGradingPeriodDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiGradingPeriodDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiGradingPeriodDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiGradingPeriodDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiGradingPeriodDescriptor edFiGradingPeriodDescriptor = (EdFiGradingPeriodDescriptor) o;
    return Objects.equals(this.id, edFiGradingPeriodDescriptor.id) &&
        Objects.equals(this.gradingPeriodDescriptorId, edFiGradingPeriodDescriptor.gradingPeriodDescriptorId) &&
        Objects.equals(this.codeValue, edFiGradingPeriodDescriptor.codeValue) &&
        Objects.equals(this.description, edFiGradingPeriodDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiGradingPeriodDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiGradingPeriodDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiGradingPeriodDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiGradingPeriodDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiGradingPeriodDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiGradingPeriodDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, gradingPeriodDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiGradingPeriodDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    gradingPeriodDescriptorId: ").append(toIndentedString(gradingPeriodDescriptorId)).append("\n");
