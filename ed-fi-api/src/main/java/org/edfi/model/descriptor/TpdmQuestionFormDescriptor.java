...
/**
 * TpdmQuestionFormDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmQuestionFormDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("questionFormDescriptorId")
  private Integer questionFormDescriptorId = null;
  ...
  public TpdmQuestionFormDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmQuestionFormDescriptor questionFormDescriptorId(Integer questionFormDescriptorId) {
    this.questionFormDescriptorId = questionFormDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return questionFormDescriptorId
  **/
  ...
  public Integer getQuestionFormDescriptorId() {
    return questionFormDescriptorId;
  }

  public void setQuestionFormDescriptorId(Integer questionFormDescriptorId) {
    this.questionFormDescriptorId = questionFormDescriptorId;
  }

  public TpdmQuestionFormDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmQuestionFormDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmQuestionFormDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmQuestionFormDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmQuestionFormDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmQuestionFormDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmQuestionFormDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmQuestionFormDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmQuestionFormDescriptor tpdmQuestionFormDescriptor = (TpdmQuestionFormDescriptor) o;
    return Objects.equals(this.id, tpdmQuestionFormDescriptor.id) &&
        Objects.equals(this.questionFormDescriptorId, tpdmQuestionFormDescriptor.questionFormDescriptorId) &&
        Objects.equals(this.codeValue, tpdmQuestionFormDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmQuestionFormDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmQuestionFormDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmQuestionFormDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmQuestionFormDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmQuestionFormDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmQuestionFormDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmQuestionFormDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, questionFormDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmQuestionFormDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    questionFormDescriptorId: ").append(toIndentedString(questionFormDescriptorId)).append("\n");
