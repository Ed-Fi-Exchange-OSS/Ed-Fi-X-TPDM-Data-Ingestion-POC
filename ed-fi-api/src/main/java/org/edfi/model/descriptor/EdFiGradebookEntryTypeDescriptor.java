...
public class EdFiGradebookEntryTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("gradebookEntryTypeDescriptorId")
  private Integer gradebookEntryTypeDescriptorId = null;
  ...
  public EdFiGradebookEntryTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiGradebookEntryTypeDescriptor gradebookEntryTypeDescriptorId(Integer gradebookEntryTypeDescriptorId) {
    this.gradebookEntryTypeDescriptorId = gradebookEntryTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return gradebookEntryTypeDescriptorId
  **/
  ...
  public Integer getGradebookEntryTypeDescriptorId() {
    return gradebookEntryTypeDescriptorId;
  }

  public void setGradebookEntryTypeDescriptorId(Integer gradebookEntryTypeDescriptorId) {
    this.gradebookEntryTypeDescriptorId = gradebookEntryTypeDescriptorId;
  }

  public EdFiGradebookEntryTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiGradebookEntryTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiGradebookEntryTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiGradebookEntryTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiGradebookEntryTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiGradebookEntryTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiGradebookEntryTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiGradebookEntryTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiGradebookEntryTypeDescriptor edFiGradebookEntryTypeDescriptor = (EdFiGradebookEntryTypeDescriptor) o;
    return Objects.equals(this.id, edFiGradebookEntryTypeDescriptor.id) &&
        Objects.equals(this.gradebookEntryTypeDescriptorId, edFiGradebookEntryTypeDescriptor.gradebookEntryTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiGradebookEntryTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiGradebookEntryTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiGradebookEntryTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiGradebookEntryTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiGradebookEntryTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiGradebookEntryTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiGradebookEntryTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiGradebookEntryTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, gradebookEntryTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiGradebookEntryTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    gradebookEntryTypeDescriptorId: ").append(toIndentedString(gradebookEntryTypeDescriptorId)).append("\n");
