...
public class EdFiStaffLeaveEventCategoryDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("staffLeaveEventCategoryDescriptorId")
  private Integer staffLeaveEventCategoryDescriptorId = null;
  ...
  public EdFiStaffLeaveEventCategoryDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiStaffLeaveEventCategoryDescriptor staffLeaveEventCategoryDescriptorId(Integer staffLeaveEventCategoryDescriptorId) {
   ...
   * @return staffLeaveEventCategoryDescriptorId
  **/
  ...
  public Integer getStaffLeaveEventCategoryDescriptorId() {
    return staffLeaveEventCategoryDescriptorId;
  }

  public void setStaffLeaveEventCategoryDescriptorId(Integer staffLeaveEventCategoryDescriptorId) {
    this.staffLeaveEventCategoryDescriptorId = staffLeaveEventCategoryDescriptorId;
  }

  public EdFiStaffLeaveEventCategoryDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiStaffLeaveEventCategoryDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiStaffLeaveEventCategoryDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiStaffLeaveEventCategoryDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiStaffLeaveEventCategoryDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiStaffLeaveEventCategoryDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiStaffLeaveEventCategoryDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiStaffLeaveEventCategoryDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiStaffLeaveEventCategoryDescriptor edFiStaffLeaveEventCategoryDescriptor = (EdFiStaffLeaveEventCategoryDescriptor) o;
    return Objects.equals(this.id, edFiStaffLeaveEventCategoryDescriptor.id) &&
        Objects.equals(this.staffLeaveEventCategoryDescriptorId, edFiStaffLeaveEventCategoryDescriptor.staffLeaveEventCategoryDescriptorId) &&
        Objects.equals(this.codeValue, edFiStaffLeaveEventCategoryDescriptor.codeValue) &&
        Objects.equals(this.description, edFiStaffLeaveEventCategoryDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiStaffLeaveEventCategoryDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiStaffLeaveEventCategoryDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiStaffLeaveEventCategoryDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiStaffLeaveEventCategoryDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiStaffLeaveEventCategoryDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiStaffLeaveEventCategoryDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, staffLeaveEventCategoryDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiStaffLeaveEventCategoryDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    staffLeaveEventCategoryDescriptorId: ").append(toIndentedString(staffLeaveEventCategoryDescriptorId)).append("\n");
