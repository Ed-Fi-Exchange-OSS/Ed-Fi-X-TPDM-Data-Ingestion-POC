...
/**
 * TpdmTppProgramPathwayDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmTppProgramPathwayDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("tppProgramPathwayDescriptorId")
  private Integer tppProgramPathwayDescriptorId = null;
  ...
  public TpdmTppProgramPathwayDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmTppProgramPathwayDescriptor tppProgramPathwayDescriptorId(Integer tppProgramPathwayDescriptorId) {
    this.tppProgramPathwayDescriptorId = tppProgramPathwayDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return tppProgramPathwayDescriptorId
  **/
  ...
  public Integer getTppProgramPathwayDescriptorId() {
    return tppProgramPathwayDescriptorId;
  }

  public void setTppProgramPathwayDescriptorId(Integer tppProgramPathwayDescriptorId) {
    this.tppProgramPathwayDescriptorId = tppProgramPathwayDescriptorId;
  }

  public TpdmTppProgramPathwayDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmTppProgramPathwayDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmTppProgramPathwayDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmTppProgramPathwayDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmTppProgramPathwayDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmTppProgramPathwayDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmTppProgramPathwayDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmTppProgramPathwayDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmTppProgramPathwayDescriptor tpdmTppProgramPathwayDescriptor = (TpdmTppProgramPathwayDescriptor) o;
    return Objects.equals(this.id, tpdmTppProgramPathwayDescriptor.id) &&
        Objects.equals(this.tppProgramPathwayDescriptorId, tpdmTppProgramPathwayDescriptor.tppProgramPathwayDescriptorId) &&
        Objects.equals(this.codeValue, tpdmTppProgramPathwayDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmTppProgramPathwayDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmTppProgramPathwayDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmTppProgramPathwayDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmTppProgramPathwayDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmTppProgramPathwayDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmTppProgramPathwayDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmTppProgramPathwayDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tppProgramPathwayDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmTppProgramPathwayDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    tppProgramPathwayDescriptorId: ").append(toIndentedString(tppProgramPathwayDescriptorId)).append("\n");
