...
public class EdFiAchievementCategoryDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("achievementCategoryDescriptorId")
  private Integer achievementCategoryDescriptorId = null;
  ...
  public EdFiAchievementCategoryDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiAchievementCategoryDescriptor achievementCategoryDescriptorId(Integer achievementCategoryDescriptorId) {
   ...
   * @return achievementCategoryDescriptorId
  **/
  ...
  public Integer getAchievementCategoryDescriptorId() {
    return achievementCategoryDescriptorId;
  }

  public void setAchievementCategoryDescriptorId(Integer achievementCategoryDescriptorId) {
    this.achievementCategoryDescriptorId = achievementCategoryDescriptorId;
  }

  public EdFiAchievementCategoryDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiAchievementCategoryDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiAchievementCategoryDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiAchievementCategoryDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiAchievementCategoryDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiAchievementCategoryDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiAchievementCategoryDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiAchievementCategoryDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiAchievementCategoryDescriptor edFiAchievementCategoryDescriptor = (EdFiAchievementCategoryDescriptor) o;
    return Objects.equals(this.id, edFiAchievementCategoryDescriptor.id) &&
        Objects.equals(this.achievementCategoryDescriptorId, edFiAchievementCategoryDescriptor.achievementCategoryDescriptorId) &&
        Objects.equals(this.codeValue, edFiAchievementCategoryDescriptor.codeValue) &&
        Objects.equals(this.description, edFiAchievementCategoryDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiAchievementCategoryDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiAchievementCategoryDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiAchievementCategoryDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiAchievementCategoryDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiAchievementCategoryDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiAchievementCategoryDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, achievementCategoryDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }
  ...
  public String toString() {
    ...
    sb.append("    achievementCategoryDescriptorId: ").append(toIndentedString(achievementCategoryDescriptorId)).append("\n");
