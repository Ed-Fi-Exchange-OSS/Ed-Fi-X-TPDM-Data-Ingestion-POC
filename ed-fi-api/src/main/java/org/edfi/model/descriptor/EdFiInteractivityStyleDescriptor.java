...
public class EdFiInteractivityStyleDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("interactivityStyleDescriptorId")
  private Integer interactivityStyleDescriptorId = null;
  ...
  public EdFiInteractivityStyleDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiInteractivityStyleDescriptor interactivityStyleDescriptorId(Integer interactivityStyleDescriptorId) {
    this.interactivityStyleDescriptorId = interactivityStyleDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return interactivityStyleDescriptorId
  **/
  ...
  public Integer getInteractivityStyleDescriptorId() {
    return interactivityStyleDescriptorId;
  }

  public void setInteractivityStyleDescriptorId(Integer interactivityStyleDescriptorId) {
    this.interactivityStyleDescriptorId = interactivityStyleDescriptorId;
  }

  public EdFiInteractivityStyleDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiInteractivityStyleDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiInteractivityStyleDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiInteractivityStyleDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiInteractivityStyleDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiInteractivityStyleDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiInteractivityStyleDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiInteractivityStyleDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiInteractivityStyleDescriptor edFiInteractivityStyleDescriptor = (EdFiInteractivityStyleDescriptor) o;
    return Objects.equals(this.id, edFiInteractivityStyleDescriptor.id) &&
        Objects.equals(this.interactivityStyleDescriptorId, edFiInteractivityStyleDescriptor.interactivityStyleDescriptorId) &&
        Objects.equals(this.codeValue, edFiInteractivityStyleDescriptor.codeValue) &&
        Objects.equals(this.description, edFiInteractivityStyleDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiInteractivityStyleDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiInteractivityStyleDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiInteractivityStyleDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiInteractivityStyleDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiInteractivityStyleDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiInteractivityStyleDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, interactivityStyleDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiInteractivityStyleDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    interactivityStyleDescriptorId: ").append(toIndentedString(interactivityStyleDescriptorId)).append("\n");
