...
public class EdFiExitWithdrawTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("exitWithdrawTypeDescriptorId")
  private Integer exitWithdrawTypeDescriptorId = null;
  ...
  public EdFiExitWithdrawTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiExitWithdrawTypeDescriptor exitWithdrawTypeDescriptorId(Integer exitWithdrawTypeDescriptorId) {
    this.exitWithdrawTypeDescriptorId = exitWithdrawTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return exitWithdrawTypeDescriptorId
  **/
  ...
  public Integer getExitWithdrawTypeDescriptorId() {
    return exitWithdrawTypeDescriptorId;
  }

  public void setExitWithdrawTypeDescriptorId(Integer exitWithdrawTypeDescriptorId) {
    this.exitWithdrawTypeDescriptorId = exitWithdrawTypeDescriptorId;
  }

  public EdFiExitWithdrawTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiExitWithdrawTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiExitWithdrawTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiExitWithdrawTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiExitWithdrawTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiExitWithdrawTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiExitWithdrawTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiExitWithdrawTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiExitWithdrawTypeDescriptor edFiExitWithdrawTypeDescriptor = (EdFiExitWithdrawTypeDescriptor) o;
    return Objects.equals(this.id, edFiExitWithdrawTypeDescriptor.id) &&
        Objects.equals(this.exitWithdrawTypeDescriptorId, edFiExitWithdrawTypeDescriptor.exitWithdrawTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiExitWithdrawTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiExitWithdrawTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiExitWithdrawTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiExitWithdrawTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiExitWithdrawTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiExitWithdrawTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiExitWithdrawTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiExitWithdrawTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, exitWithdrawTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiExitWithdrawTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    exitWithdrawTypeDescriptorId: ").append(toIndentedString(exitWithdrawTypeDescriptorId)).append("\n");
