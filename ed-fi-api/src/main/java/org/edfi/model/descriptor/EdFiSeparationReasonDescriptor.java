...
public class EdFiSeparationReasonDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("separationReasonDescriptorId")
  private Integer separationReasonDescriptorId = null;
  ...
  public EdFiSeparationReasonDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiSeparationReasonDescriptor separationReasonDescriptorId(Integer separationReasonDescriptorId) {
    this.separationReasonDescriptorId = separationReasonDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return separationReasonDescriptorId
  **/
  ...
  public Integer getSeparationReasonDescriptorId() {
    return separationReasonDescriptorId;
  }

  public void setSeparationReasonDescriptorId(Integer separationReasonDescriptorId) {
    this.separationReasonDescriptorId = separationReasonDescriptorId;
  }

  public EdFiSeparationReasonDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiSeparationReasonDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiSeparationReasonDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiSeparationReasonDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiSeparationReasonDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiSeparationReasonDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiSeparationReasonDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiSeparationReasonDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiSeparationReasonDescriptor edFiSeparationReasonDescriptor = (EdFiSeparationReasonDescriptor) o;
    return Objects.equals(this.id, edFiSeparationReasonDescriptor.id) &&
        Objects.equals(this.separationReasonDescriptorId, edFiSeparationReasonDescriptor.separationReasonDescriptorId) &&
        Objects.equals(this.codeValue, edFiSeparationReasonDescriptor.codeValue) &&
        Objects.equals(this.description, edFiSeparationReasonDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiSeparationReasonDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiSeparationReasonDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiSeparationReasonDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiSeparationReasonDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiSeparationReasonDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiSeparationReasonDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, separationReasonDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiSeparationReasonDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    separationReasonDescriptorId: ").append(toIndentedString(separationReasonDescriptorId)).append("\n");
