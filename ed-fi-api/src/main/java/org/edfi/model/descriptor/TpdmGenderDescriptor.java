...
public class TpdmGenderDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("genderDescriptorId")
  private Integer genderDescriptorId = null;
  ...
  public TpdmGenderDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmGenderDescriptor genderDescriptorId(Integer genderDescriptorId) {
    this.genderDescriptorId = genderDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return genderDescriptorId
  **/
  ...
  public Integer getGenderDescriptorId() {
    return genderDescriptorId;
  }

  public void setGenderDescriptorId(Integer genderDescriptorId) {
    this.genderDescriptorId = genderDescriptorId;
  }

  public TpdmGenderDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmGenderDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmGenderDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmGenderDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmGenderDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmGenderDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmGenderDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmGenderDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmGenderDescriptor tpdmGenderDescriptor = (TpdmGenderDescriptor) o;
    return Objects.equals(this.id, tpdmGenderDescriptor.id) &&
        Objects.equals(this.genderDescriptorId, tpdmGenderDescriptor.genderDescriptorId) &&
        Objects.equals(this.codeValue, tpdmGenderDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmGenderDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmGenderDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmGenderDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmGenderDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmGenderDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmGenderDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmGenderDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, genderDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmGenderDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    genderDescriptorId: ").append(toIndentedString(genderDescriptorId)).append("\n");
