...
public class EdFiLicenseTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("licenseTypeDescriptorId")
  private Integer licenseTypeDescriptorId = null;
  ...
  public EdFiLicenseTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiLicenseTypeDescriptor licenseTypeDescriptorId(Integer licenseTypeDescriptorId) {
    this.licenseTypeDescriptorId = licenseTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return licenseTypeDescriptorId
  **/
  ...
  public Integer getLicenseTypeDescriptorId() {
    return licenseTypeDescriptorId;
  }

  public void setLicenseTypeDescriptorId(Integer licenseTypeDescriptorId) {
    this.licenseTypeDescriptorId = licenseTypeDescriptorId;
  }

  public EdFiLicenseTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiLicenseTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiLicenseTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiLicenseTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiLicenseTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiLicenseTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiLicenseTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiLicenseTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiLicenseTypeDescriptor edFiLicenseTypeDescriptor = (EdFiLicenseTypeDescriptor) o;
    return Objects.equals(this.id, edFiLicenseTypeDescriptor.id) &&
        Objects.equals(this.licenseTypeDescriptorId, edFiLicenseTypeDescriptor.licenseTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiLicenseTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiLicenseTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiLicenseTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiLicenseTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiLicenseTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiLicenseTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiLicenseTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiLicenseTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, licenseTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiLicenseTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    licenseTypeDescriptorId: ").append(toIndentedString(licenseTypeDescriptorId)).append("\n");
