...
public class EdFiCitizenshipStatusDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("citizenshipStatusDescriptorId")
  private Integer citizenshipStatusDescriptorId = null;
  ...
  public EdFiCitizenshipStatusDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCitizenshipStatusDescriptor citizenshipStatusDescriptorId(Integer citizenshipStatusDescriptorId) {
    this.citizenshipStatusDescriptorId = citizenshipStatusDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return citizenshipStatusDescriptorId
  **/
  ...
  public Integer getCitizenshipStatusDescriptorId() {
    return citizenshipStatusDescriptorId;
  }

  public void setCitizenshipStatusDescriptorId(Integer citizenshipStatusDescriptorId) {
    this.citizenshipStatusDescriptorId = citizenshipStatusDescriptorId;
  }

  public EdFiCitizenshipStatusDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCitizenshipStatusDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCitizenshipStatusDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCitizenshipStatusDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCitizenshipStatusDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCitizenshipStatusDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCitizenshipStatusDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCitizenshipStatusDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCitizenshipStatusDescriptor edFiCitizenshipStatusDescriptor = (EdFiCitizenshipStatusDescriptor) o;
    return Objects.equals(this.id, edFiCitizenshipStatusDescriptor.id) &&
        Objects.equals(this.citizenshipStatusDescriptorId, edFiCitizenshipStatusDescriptor.citizenshipStatusDescriptorId) &&
        Objects.equals(this.codeValue, edFiCitizenshipStatusDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCitizenshipStatusDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCitizenshipStatusDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCitizenshipStatusDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCitizenshipStatusDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCitizenshipStatusDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCitizenshipStatusDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCitizenshipStatusDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, citizenshipStatusDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCitizenshipStatusDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    citizenshipStatusDescriptorId: ").append(toIndentedString(citizenshipStatusDescriptorId)).append("\n");
