...
public class EdFiCredentialFieldDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("credentialFieldDescriptorId")
  private Integer credentialFieldDescriptorId = null;
  ...
  public EdFiCredentialFieldDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCredentialFieldDescriptor credentialFieldDescriptorId(Integer credentialFieldDescriptorId) {
    this.credentialFieldDescriptorId = credentialFieldDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return credentialFieldDescriptorId
  **/
  ...
  public Integer getCredentialFieldDescriptorId() {
    return credentialFieldDescriptorId;
  }

  public void setCredentialFieldDescriptorId(Integer credentialFieldDescriptorId) {
    this.credentialFieldDescriptorId = credentialFieldDescriptorId;
  }

  public EdFiCredentialFieldDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCredentialFieldDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCredentialFieldDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCredentialFieldDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCredentialFieldDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCredentialFieldDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCredentialFieldDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCredentialFieldDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCredentialFieldDescriptor edFiCredentialFieldDescriptor = (EdFiCredentialFieldDescriptor) o;
    return Objects.equals(this.id, edFiCredentialFieldDescriptor.id) &&
        Objects.equals(this.credentialFieldDescriptorId, edFiCredentialFieldDescriptor.credentialFieldDescriptorId) &&
        Objects.equals(this.codeValue, edFiCredentialFieldDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCredentialFieldDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCredentialFieldDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCredentialFieldDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCredentialFieldDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCredentialFieldDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCredentialFieldDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCredentialFieldDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, credentialFieldDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCredentialFieldDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    credentialFieldDescriptorId: ").append(toIndentedString(credentialFieldDescriptorId)).append("\n");
