...
public class EdFiProgramSponsorDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("programSponsorDescriptorId")
  private Integer programSponsorDescriptorId = null;
  ...
  public EdFiProgramSponsorDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiProgramSponsorDescriptor programSponsorDescriptorId(Integer programSponsorDescriptorId) {
    this.programSponsorDescriptorId = programSponsorDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return programSponsorDescriptorId
  **/
  ...
  public Integer getProgramSponsorDescriptorId() {
    return programSponsorDescriptorId;
  }

  public void setProgramSponsorDescriptorId(Integer programSponsorDescriptorId) {
    this.programSponsorDescriptorId = programSponsorDescriptorId;
  }

  public EdFiProgramSponsorDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiProgramSponsorDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiProgramSponsorDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiProgramSponsorDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiProgramSponsorDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiProgramSponsorDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiProgramSponsorDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiProgramSponsorDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiProgramSponsorDescriptor edFiProgramSponsorDescriptor = (EdFiProgramSponsorDescriptor) o;
    return Objects.equals(this.id, edFiProgramSponsorDescriptor.id) &&
        Objects.equals(this.programSponsorDescriptorId, edFiProgramSponsorDescriptor.programSponsorDescriptorId) &&
        Objects.equals(this.codeValue, edFiProgramSponsorDescriptor.codeValue) &&
        Objects.equals(this.description, edFiProgramSponsorDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiProgramSponsorDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiProgramSponsorDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiProgramSponsorDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiProgramSponsorDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiProgramSponsorDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiProgramSponsorDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, programSponsorDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiProgramSponsorDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    programSponsorDescriptorId: ").append(toIndentedString(programSponsorDescriptorId)).append("\n");
