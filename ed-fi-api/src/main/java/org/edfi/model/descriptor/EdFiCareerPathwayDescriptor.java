...
public class EdFiCareerPathwayDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("careerPathwayDescriptorId")
  private Integer careerPathwayDescriptorId = null;
  ...
  public EdFiCareerPathwayDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCareerPathwayDescriptor careerPathwayDescriptorId(Integer careerPathwayDescriptorId) {
    this.careerPathwayDescriptorId = careerPathwayDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return careerPathwayDescriptorId
  **/
  ...
  public Integer getCareerPathwayDescriptorId() {
    return careerPathwayDescriptorId;
  }

  public void setCareerPathwayDescriptorId(Integer careerPathwayDescriptorId) {
    this.careerPathwayDescriptorId = careerPathwayDescriptorId;
  }

  public EdFiCareerPathwayDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCareerPathwayDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCareerPathwayDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCareerPathwayDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCareerPathwayDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCareerPathwayDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCareerPathwayDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCareerPathwayDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCareerPathwayDescriptor edFiCareerPathwayDescriptor = (EdFiCareerPathwayDescriptor) o;
    return Objects.equals(this.id, edFiCareerPathwayDescriptor.id) &&
        Objects.equals(this.careerPathwayDescriptorId, edFiCareerPathwayDescriptor.careerPathwayDescriptorId) &&
        Objects.equals(this.codeValue, edFiCareerPathwayDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCareerPathwayDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCareerPathwayDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCareerPathwayDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCareerPathwayDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCareerPathwayDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCareerPathwayDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCareerPathwayDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, careerPathwayDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCareerPathwayDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    careerPathwayDescriptorId: ").append(toIndentedString(careerPathwayDescriptorId)).append("\n");
