...
public class EdFiAddressTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("addressTypeDescriptorId")
  private Integer addressTypeDescriptorId = null;
  ...
  public EdFiAddressTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiAddressTypeDescriptor addressTypeDescriptorId(Integer addressTypeDescriptorId) {
    this.addressTypeDescriptorId = addressTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return addressTypeDescriptorId
  **/
  ...
  public Integer getAddressTypeDescriptorId() {
    return addressTypeDescriptorId;
  }

  public void setAddressTypeDescriptorId(Integer addressTypeDescriptorId) {
    this.addressTypeDescriptorId = addressTypeDescriptorId;
  }

  public EdFiAddressTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiAddressTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiAddressTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiAddressTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiAddressTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiAddressTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiAddressTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiAddressTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiAddressTypeDescriptor edFiAddressTypeDescriptor = (EdFiAddressTypeDescriptor) o;
    return Objects.equals(this.id, edFiAddressTypeDescriptor.id) &&
        Objects.equals(this.addressTypeDescriptorId, edFiAddressTypeDescriptor.addressTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiAddressTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiAddressTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiAddressTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiAddressTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiAddressTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiAddressTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiAddressTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiAddressTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, addressTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiAddressTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    addressTypeDescriptorId: ").append(toIndentedString(addressTypeDescriptorId)).append("\n");
