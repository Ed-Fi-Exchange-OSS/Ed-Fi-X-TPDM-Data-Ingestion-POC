...
public class EdFiCohortTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("cohortTypeDescriptorId")
  private Integer cohortTypeDescriptorId = null;
  ...
  public EdFiCohortTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCohortTypeDescriptor cohortTypeDescriptorId(Integer cohortTypeDescriptorId) {
    this.cohortTypeDescriptorId = cohortTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return cohortTypeDescriptorId
  **/
  ...
  public Integer getCohortTypeDescriptorId() {
    return cohortTypeDescriptorId;
  }

  public void setCohortTypeDescriptorId(Integer cohortTypeDescriptorId) {
    this.cohortTypeDescriptorId = cohortTypeDescriptorId;
  }

  public EdFiCohortTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCohortTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCohortTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCohortTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCohortTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCohortTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCohortTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCohortTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCohortTypeDescriptor edFiCohortTypeDescriptor = (EdFiCohortTypeDescriptor) o;
    return Objects.equals(this.id, edFiCohortTypeDescriptor.id) &&
        Objects.equals(this.cohortTypeDescriptorId, edFiCohortTypeDescriptor.cohortTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiCohortTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCohortTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCohortTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCohortTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCohortTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCohortTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCohortTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCohortTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, cohortTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCohortTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    cohortTypeDescriptorId: ").append(toIndentedString(cohortTypeDescriptorId)).append("\n");
