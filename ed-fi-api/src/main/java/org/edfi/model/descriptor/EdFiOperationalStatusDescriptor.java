...
public class EdFiOperationalStatusDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("operationalStatusDescriptorId")
  private Integer operationalStatusDescriptorId = null;
  ...
  public EdFiOperationalStatusDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiOperationalStatusDescriptor operationalStatusDescriptorId(Integer operationalStatusDescriptorId) {
   ...
   * @return operationalStatusDescriptorId
  **/
  ...
  public Integer getOperationalStatusDescriptorId() {
    return operationalStatusDescriptorId;
  }

  public void setOperationalStatusDescriptorId(Integer operationalStatusDescriptorId) {
    this.operationalStatusDescriptorId = operationalStatusDescriptorId;
  }

  public EdFiOperationalStatusDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiOperationalStatusDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiOperationalStatusDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiOperationalStatusDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiOperationalStatusDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiOperationalStatusDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiOperationalStatusDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiOperationalStatusDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiOperationalStatusDescriptor edFiOperationalStatusDescriptor = (EdFiOperationalStatusDescriptor) o;
    return Objects.equals(this.id, edFiOperationalStatusDescriptor.id) &&
        Objects.equals(this.operationalStatusDescriptorId, edFiOperationalStatusDescriptor.operationalStatusDescriptorId) &&
        Objects.equals(this.codeValue, edFiOperationalStatusDescriptor.codeValue) &&
        Objects.equals(this.description, edFiOperationalStatusDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiOperationalStatusDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiOperationalStatusDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiOperationalStatusDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiOperationalStatusDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiOperationalStatusDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiOperationalStatusDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, operationalStatusDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiOperationalStatusDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    operationalStatusDescriptorId: ").append(toIndentedString(operationalStatusDescriptorId)).append("\n");
