...
public class EdFiSexDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("sexDescriptorId")
  private Integer sexDescriptorId = null;
  ...
  public EdFiSexDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiSexDescriptor sexDescriptorId(Integer sexDescriptorId) {
    this.sexDescriptorId = sexDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return sexDescriptorId
  **/
  ...
  public Integer getSexDescriptorId() {
    return sexDescriptorId;
  }

  public void setSexDescriptorId(Integer sexDescriptorId) {
    this.sexDescriptorId = sexDescriptorId;
  }

  public EdFiSexDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiSexDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiSexDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiSexDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiSexDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiSexDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiSexDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiSexDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiSexDescriptor edFiSexDescriptor = (EdFiSexDescriptor) o;
    return Objects.equals(this.id, edFiSexDescriptor.id) &&
        Objects.equals(this.sexDescriptorId, edFiSexDescriptor.sexDescriptorId) &&
        Objects.equals(this.codeValue, edFiSexDescriptor.codeValue) &&
        Objects.equals(this.description, edFiSexDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiSexDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiSexDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiSexDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiSexDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiSexDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiSexDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, sexDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiSexDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    sexDescriptorId: ").append(toIndentedString(sexDescriptorId)).append("\n");
