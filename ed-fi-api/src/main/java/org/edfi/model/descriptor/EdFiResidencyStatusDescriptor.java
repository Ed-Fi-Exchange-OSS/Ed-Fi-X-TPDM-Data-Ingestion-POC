...
public class EdFiResidencyStatusDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("residencyStatusDescriptorId")
  private Integer residencyStatusDescriptorId = null;
  ...
  public EdFiResidencyStatusDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiResidencyStatusDescriptor residencyStatusDescriptorId(Integer residencyStatusDescriptorId) {
    this.residencyStatusDescriptorId = residencyStatusDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return residencyStatusDescriptorId
  **/
  ...
  public Integer getResidencyStatusDescriptorId() {
    return residencyStatusDescriptorId;
  }

  public void setResidencyStatusDescriptorId(Integer residencyStatusDescriptorId) {
    this.residencyStatusDescriptorId = residencyStatusDescriptorId;
  }

  public EdFiResidencyStatusDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiResidencyStatusDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiResidencyStatusDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiResidencyStatusDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiResidencyStatusDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiResidencyStatusDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiResidencyStatusDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiResidencyStatusDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiResidencyStatusDescriptor edFiResidencyStatusDescriptor = (EdFiResidencyStatusDescriptor) o;
    return Objects.equals(this.id, edFiResidencyStatusDescriptor.id) &&
        Objects.equals(this.residencyStatusDescriptorId, edFiResidencyStatusDescriptor.residencyStatusDescriptorId) &&
        Objects.equals(this.codeValue, edFiResidencyStatusDescriptor.codeValue) &&
        Objects.equals(this.description, edFiResidencyStatusDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiResidencyStatusDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiResidencyStatusDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiResidencyStatusDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiResidencyStatusDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiResidencyStatusDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiResidencyStatusDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, residencyStatusDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiResidencyStatusDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    residencyStatusDescriptorId: ").append(toIndentedString(residencyStatusDescriptorId)).append("\n");
