...
public class EdFiMonitoredDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("monitoredDescriptorId")
  private Integer monitoredDescriptorId = null;
  ...
  public EdFiMonitoredDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiMonitoredDescriptor monitoredDescriptorId(Integer monitoredDescriptorId) {
    this.monitoredDescriptorId = monitoredDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return monitoredDescriptorId
  **/
  ...
  public Integer getMonitoredDescriptorId() {
    return monitoredDescriptorId;
  }

  public void setMonitoredDescriptorId(Integer monitoredDescriptorId) {
    this.monitoredDescriptorId = monitoredDescriptorId;
  }

  public EdFiMonitoredDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiMonitoredDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiMonitoredDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiMonitoredDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiMonitoredDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiMonitoredDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiMonitoredDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiMonitoredDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiMonitoredDescriptor edFiMonitoredDescriptor = (EdFiMonitoredDescriptor) o;
    return Objects.equals(this.id, edFiMonitoredDescriptor.id) &&
        Objects.equals(this.monitoredDescriptorId, edFiMonitoredDescriptor.monitoredDescriptorId) &&
        Objects.equals(this.codeValue, edFiMonitoredDescriptor.codeValue) &&
        Objects.equals(this.description, edFiMonitoredDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiMonitoredDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiMonitoredDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiMonitoredDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiMonitoredDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiMonitoredDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiMonitoredDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, monitoredDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiMonitoredDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    monitoredDescriptorId: ").append(toIndentedString(monitoredDescriptorId)).append("\n");
