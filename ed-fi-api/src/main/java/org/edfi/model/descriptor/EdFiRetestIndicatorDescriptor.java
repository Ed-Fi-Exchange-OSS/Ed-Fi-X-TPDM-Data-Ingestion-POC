...
public class EdFiRetestIndicatorDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("retestIndicatorDescriptorId")
  private Integer retestIndicatorDescriptorId = null;
  ...
  public EdFiRetestIndicatorDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiRetestIndicatorDescriptor retestIndicatorDescriptorId(Integer retestIndicatorDescriptorId) {
    this.retestIndicatorDescriptorId = retestIndicatorDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return retestIndicatorDescriptorId
  **/
  ...
  public Integer getRetestIndicatorDescriptorId() {
    return retestIndicatorDescriptorId;
  }

  public void setRetestIndicatorDescriptorId(Integer retestIndicatorDescriptorId) {
    this.retestIndicatorDescriptorId = retestIndicatorDescriptorId;
  }

  public EdFiRetestIndicatorDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiRetestIndicatorDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiRetestIndicatorDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiRetestIndicatorDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiRetestIndicatorDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiRetestIndicatorDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiRetestIndicatorDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiRetestIndicatorDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiRetestIndicatorDescriptor edFiRetestIndicatorDescriptor = (EdFiRetestIndicatorDescriptor) o;
    return Objects.equals(this.id, edFiRetestIndicatorDescriptor.id) &&
        Objects.equals(this.retestIndicatorDescriptorId, edFiRetestIndicatorDescriptor.retestIndicatorDescriptorId) &&
        Objects.equals(this.codeValue, edFiRetestIndicatorDescriptor.codeValue) &&
        Objects.equals(this.description, edFiRetestIndicatorDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiRetestIndicatorDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiRetestIndicatorDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiRetestIndicatorDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiRetestIndicatorDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiRetestIndicatorDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiRetestIndicatorDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, retestIndicatorDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiRetestIndicatorDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    retestIndicatorDescriptorId: ").append(toIndentedString(retestIndicatorDescriptorId)).append("\n");
