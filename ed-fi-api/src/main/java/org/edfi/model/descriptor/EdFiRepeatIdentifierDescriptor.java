...
public class EdFiRepeatIdentifierDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("repeatIdentifierDescriptorId")
  private Integer repeatIdentifierDescriptorId = null;
  ...
  public EdFiRepeatIdentifierDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiRepeatIdentifierDescriptor repeatIdentifierDescriptorId(Integer repeatIdentifierDescriptorId) {
    this.repeatIdentifierDescriptorId = repeatIdentifierDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return repeatIdentifierDescriptorId
  **/
  ...
  public Integer getRepeatIdentifierDescriptorId() {
    return repeatIdentifierDescriptorId;
  }

  public void setRepeatIdentifierDescriptorId(Integer repeatIdentifierDescriptorId) {
    this.repeatIdentifierDescriptorId = repeatIdentifierDescriptorId;
  }

  public EdFiRepeatIdentifierDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiRepeatIdentifierDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiRepeatIdentifierDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiRepeatIdentifierDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiRepeatIdentifierDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiRepeatIdentifierDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiRepeatIdentifierDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiRepeatIdentifierDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiRepeatIdentifierDescriptor edFiRepeatIdentifierDescriptor = (EdFiRepeatIdentifierDescriptor) o;
    return Objects.equals(this.id, edFiRepeatIdentifierDescriptor.id) &&
        Objects.equals(this.repeatIdentifierDescriptorId, edFiRepeatIdentifierDescriptor.repeatIdentifierDescriptorId) &&
        Objects.equals(this.codeValue, edFiRepeatIdentifierDescriptor.codeValue) &&
        Objects.equals(this.description, edFiRepeatIdentifierDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiRepeatIdentifierDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiRepeatIdentifierDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiRepeatIdentifierDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiRepeatIdentifierDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiRepeatIdentifierDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiRepeatIdentifierDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, repeatIdentifierDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiRepeatIdentifierDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    repeatIdentifierDescriptorId: ").append(toIndentedString(repeatIdentifierDescriptorId)).append("\n");
