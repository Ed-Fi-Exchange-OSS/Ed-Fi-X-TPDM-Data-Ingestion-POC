...
public class EdFiAssessmentCategoryDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("assessmentCategoryDescriptorId")
  private Integer assessmentCategoryDescriptorId = null;
  ...
  public EdFiAssessmentCategoryDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiAssessmentCategoryDescriptor assessmentCategoryDescriptorId(Integer assessmentCategoryDescriptorId) {
    this.assessmentCategoryDescriptorId = assessmentCategoryDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return assessmentCategoryDescriptorId
  **/
  ...
  public Integer getAssessmentCategoryDescriptorId() {
    return assessmentCategoryDescriptorId;
  }

  public void setAssessmentCategoryDescriptorId(Integer assessmentCategoryDescriptorId) {
    this.assessmentCategoryDescriptorId = assessmentCategoryDescriptorId;
  }

  public EdFiAssessmentCategoryDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiAssessmentCategoryDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiAssessmentCategoryDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiAssessmentCategoryDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiAssessmentCategoryDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiAssessmentCategoryDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiAssessmentCategoryDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiAssessmentCategoryDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiAssessmentCategoryDescriptor edFiAssessmentCategoryDescriptor = (EdFiAssessmentCategoryDescriptor) o;
    return Objects.equals(this.id, edFiAssessmentCategoryDescriptor.id) &&
        Objects.equals(this.assessmentCategoryDescriptorId, edFiAssessmentCategoryDescriptor.assessmentCategoryDescriptorId) &&
        Objects.equals(this.codeValue, edFiAssessmentCategoryDescriptor.codeValue) &&
        Objects.equals(this.description, edFiAssessmentCategoryDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiAssessmentCategoryDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiAssessmentCategoryDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiAssessmentCategoryDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiAssessmentCategoryDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiAssessmentCategoryDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiAssessmentCategoryDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, assessmentCategoryDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiAssessmentCategoryDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    assessmentCategoryDescriptorId: ").append(toIndentedString(assessmentCategoryDescriptorId)).append("\n");
