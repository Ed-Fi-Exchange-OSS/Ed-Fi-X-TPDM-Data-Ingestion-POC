...
public class EdFiAssessmentPeriodDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("assessmentPeriodDescriptorId")
  private Integer assessmentPeriodDescriptorId = null;
  ...
  public EdFiAssessmentPeriodDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiAssessmentPeriodDescriptor assessmentPeriodDescriptorId(Integer assessmentPeriodDescriptorId) {
    this.assessmentPeriodDescriptorId = assessmentPeriodDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return assessmentPeriodDescriptorId
  **/
  ...
  public Integer getAssessmentPeriodDescriptorId() {
    return assessmentPeriodDescriptorId;
  }

  public void setAssessmentPeriodDescriptorId(Integer assessmentPeriodDescriptorId) {
    this.assessmentPeriodDescriptorId = assessmentPeriodDescriptorId;
  }

  public EdFiAssessmentPeriodDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiAssessmentPeriodDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiAssessmentPeriodDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiAssessmentPeriodDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiAssessmentPeriodDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiAssessmentPeriodDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiAssessmentPeriodDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiAssessmentPeriodDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiAssessmentPeriodDescriptor edFiAssessmentPeriodDescriptor = (EdFiAssessmentPeriodDescriptor) o;
    return Objects.equals(this.id, edFiAssessmentPeriodDescriptor.id) &&
        Objects.equals(this.assessmentPeriodDescriptorId, edFiAssessmentPeriodDescriptor.assessmentPeriodDescriptorId) &&
        Objects.equals(this.codeValue, edFiAssessmentPeriodDescriptor.codeValue) &&
        Objects.equals(this.description, edFiAssessmentPeriodDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiAssessmentPeriodDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiAssessmentPeriodDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiAssessmentPeriodDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiAssessmentPeriodDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiAssessmentPeriodDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiAssessmentPeriodDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, assessmentPeriodDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiAssessmentPeriodDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    assessmentPeriodDescriptorId: ").append(toIndentedString(assessmentPeriodDescriptorId)).append("\n");
