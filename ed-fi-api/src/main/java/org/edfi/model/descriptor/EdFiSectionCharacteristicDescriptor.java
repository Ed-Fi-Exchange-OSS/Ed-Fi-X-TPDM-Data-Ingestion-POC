...
public class EdFiSectionCharacteristicDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("sectionCharacteristicDescriptorId")
  private Integer sectionCharacteristicDescriptorId = null;
  ...
  public EdFiSectionCharacteristicDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiSectionCharacteristicDescriptor sectionCharacteristicDescriptorId(Integer sectionCharacteristicDescriptorId) {
    this.sectionCharacteristicDescriptorId = sectionCharacteristicDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return sectionCharacteristicDescriptorId
  **/
  ...
  public Integer getSectionCharacteristicDescriptorId() {
    return sectionCharacteristicDescriptorId;
  }

  public void setSectionCharacteristicDescriptorId(Integer sectionCharacteristicDescriptorId) {
    this.sectionCharacteristicDescriptorId = sectionCharacteristicDescriptorId;
  }

  public EdFiSectionCharacteristicDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiSectionCharacteristicDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiSectionCharacteristicDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiSectionCharacteristicDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiSectionCharacteristicDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiSectionCharacteristicDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiSectionCharacteristicDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiSectionCharacteristicDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiSectionCharacteristicDescriptor edFiSectionCharacteristicDescriptor = (EdFiSectionCharacteristicDescriptor) o;
    return Objects.equals(this.id, edFiSectionCharacteristicDescriptor.id) &&
        Objects.equals(this.sectionCharacteristicDescriptorId, edFiSectionCharacteristicDescriptor.sectionCharacteristicDescriptorId) &&
        Objects.equals(this.codeValue, edFiSectionCharacteristicDescriptor.codeValue) &&
        Objects.equals(this.description, edFiSectionCharacteristicDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiSectionCharacteristicDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiSectionCharacteristicDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiSectionCharacteristicDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiSectionCharacteristicDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiSectionCharacteristicDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiSectionCharacteristicDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, sectionCharacteristicDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }
  ...
  public String toString() {
    ...
    sb.append("    sectionCharacteristicDescriptorId: ").append(toIndentedString(sectionCharacteristicDescriptorId)).append("\n");
