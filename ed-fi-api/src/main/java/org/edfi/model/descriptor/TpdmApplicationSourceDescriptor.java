...
/**
 * TpdmApplicationSourceDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmApplicationSourceDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("applicationSourceDescriptorId")
  private Integer applicationSourceDescriptorId = null;
  ...
  public TpdmApplicationSourceDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmApplicationSourceDescriptor applicationSourceDescriptorId(Integer applicationSourceDescriptorId) {
    this.applicationSourceDescriptorId = applicationSourceDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return applicationSourceDescriptorId
  **/
  ...
  public Integer getApplicationSourceDescriptorId() {
    return applicationSourceDescriptorId;
  }

  public void setApplicationSourceDescriptorId(Integer applicationSourceDescriptorId) {
    this.applicationSourceDescriptorId = applicationSourceDescriptorId;
  }

  public TpdmApplicationSourceDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmApplicationSourceDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmApplicationSourceDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmApplicationSourceDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmApplicationSourceDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmApplicationSourceDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmApplicationSourceDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmApplicationSourceDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmApplicationSourceDescriptor tpdmApplicationSourceDescriptor = (TpdmApplicationSourceDescriptor) o;
    return Objects.equals(this.id, tpdmApplicationSourceDescriptor.id) &&
        Objects.equals(this.applicationSourceDescriptorId, tpdmApplicationSourceDescriptor.applicationSourceDescriptorId) &&
        Objects.equals(this.codeValue, tpdmApplicationSourceDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmApplicationSourceDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmApplicationSourceDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmApplicationSourceDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmApplicationSourceDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmApplicationSourceDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmApplicationSourceDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmApplicationSourceDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, applicationSourceDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmApplicationSourceDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    applicationSourceDescriptorId: ").append(toIndentedString(applicationSourceDescriptorId)).append("\n");
