...
public class EdFiCompetencyLevelDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("competencyLevelDescriptorId")
  private Integer competencyLevelDescriptorId = null;
  ...
  public EdFiCompetencyLevelDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCompetencyLevelDescriptor competencyLevelDescriptorId(Integer competencyLevelDescriptorId) {
    this.competencyLevelDescriptorId = competencyLevelDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return competencyLevelDescriptorId
  **/
  ...
  public Integer getCompetencyLevelDescriptorId() {
    return competencyLevelDescriptorId;
  }

  public void setCompetencyLevelDescriptorId(Integer competencyLevelDescriptorId) {
    this.competencyLevelDescriptorId = competencyLevelDescriptorId;
  }

  public EdFiCompetencyLevelDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCompetencyLevelDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCompetencyLevelDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCompetencyLevelDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCompetencyLevelDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCompetencyLevelDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCompetencyLevelDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCompetencyLevelDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCompetencyLevelDescriptor edFiCompetencyLevelDescriptor = (EdFiCompetencyLevelDescriptor) o;
    return Objects.equals(this.id, edFiCompetencyLevelDescriptor.id) &&
        Objects.equals(this.competencyLevelDescriptorId, edFiCompetencyLevelDescriptor.competencyLevelDescriptorId) &&
        Objects.equals(this.codeValue, edFiCompetencyLevelDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCompetencyLevelDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCompetencyLevelDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCompetencyLevelDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCompetencyLevelDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCompetencyLevelDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCompetencyLevelDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCompetencyLevelDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, competencyLevelDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCompetencyLevelDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    competencyLevelDescriptorId: ").append(toIndentedString(competencyLevelDescriptorId)).append("\n");
