...
public class EdFiContentClassDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("contentClassDescriptorId")
  private Integer contentClassDescriptorId = null;
  ...
  public EdFiContentClassDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiContentClassDescriptor contentClassDescriptorId(Integer contentClassDescriptorId) {
    this.contentClassDescriptorId = contentClassDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return contentClassDescriptorId
  **/
  ...
  public Integer getContentClassDescriptorId() {
    return contentClassDescriptorId;
  }

  public void setContentClassDescriptorId(Integer contentClassDescriptorId) {
    this.contentClassDescriptorId = contentClassDescriptorId;
  }

  public EdFiContentClassDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiContentClassDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiContentClassDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiContentClassDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiContentClassDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiContentClassDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiContentClassDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiContentClassDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiContentClassDescriptor edFiContentClassDescriptor = (EdFiContentClassDescriptor) o;
    return Objects.equals(this.id, edFiContentClassDescriptor.id) &&
        Objects.equals(this.contentClassDescriptorId, edFiContentClassDescriptor.contentClassDescriptorId) &&
        Objects.equals(this.codeValue, edFiContentClassDescriptor.codeValue) &&
        Objects.equals(this.description, edFiContentClassDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiContentClassDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiContentClassDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiContentClassDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiContentClassDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiContentClassDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiContentClassDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, contentClassDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiContentClassDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    contentClassDescriptorId: ").append(toIndentedString(contentClassDescriptorId)).append("\n");
