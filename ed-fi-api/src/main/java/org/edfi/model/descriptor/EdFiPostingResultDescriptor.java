...
public class EdFiPostingResultDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("postingResultDescriptorId")
  private Integer postingResultDescriptorId = null;
  ...
  public EdFiPostingResultDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiPostingResultDescriptor postingResultDescriptorId(Integer postingResultDescriptorId) {
    this.postingResultDescriptorId = postingResultDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return postingResultDescriptorId
  **/
  ...
  public Integer getPostingResultDescriptorId() {
    return postingResultDescriptorId;
  }

  public void setPostingResultDescriptorId(Integer postingResultDescriptorId) {
    this.postingResultDescriptorId = postingResultDescriptorId;
  }

  public EdFiPostingResultDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiPostingResultDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiPostingResultDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiPostingResultDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiPostingResultDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiPostingResultDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiPostingResultDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiPostingResultDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiPostingResultDescriptor edFiPostingResultDescriptor = (EdFiPostingResultDescriptor) o;
    return Objects.equals(this.id, edFiPostingResultDescriptor.id) &&
        Objects.equals(this.postingResultDescriptorId, edFiPostingResultDescriptor.postingResultDescriptorId) &&
        Objects.equals(this.codeValue, edFiPostingResultDescriptor.codeValue) &&
        Objects.equals(this.description, edFiPostingResultDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiPostingResultDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiPostingResultDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiPostingResultDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiPostingResultDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiPostingResultDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiPostingResultDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, postingResultDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiPostingResultDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    postingResultDescriptorId: ").append(toIndentedString(postingResultDescriptorId)).append("\n");
