...
public class EdFiCostRateDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("costRateDescriptorId")
  private Integer costRateDescriptorId = null;
  ...
  public EdFiCostRateDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCostRateDescriptor costRateDescriptorId(Integer costRateDescriptorId) {
    this.costRateDescriptorId = costRateDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return costRateDescriptorId
  **/
  ...
  public Integer getCostRateDescriptorId() {
    return costRateDescriptorId;
  }

  public void setCostRateDescriptorId(Integer costRateDescriptorId) {
    this.costRateDescriptorId = costRateDescriptorId;
  }

  public EdFiCostRateDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCostRateDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCostRateDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCostRateDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCostRateDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCostRateDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCostRateDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCostRateDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCostRateDescriptor edFiCostRateDescriptor = (EdFiCostRateDescriptor) o;
    return Objects.equals(this.id, edFiCostRateDescriptor.id) &&
        Objects.equals(this.costRateDescriptorId, edFiCostRateDescriptor.costRateDescriptorId) &&
        Objects.equals(this.codeValue, edFiCostRateDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCostRateDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCostRateDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCostRateDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCostRateDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCostRateDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCostRateDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCostRateDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, costRateDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCostRateDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    costRateDescriptorId: ").append(toIndentedString(costRateDescriptorId)).append("\n");
