...
/**
 * EdFiOldEthnicityDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class EdFiOldEthnicityDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("oldEthnicityDescriptorId")
  private Integer oldEthnicityDescriptorId = null;
  ...
  public EdFiOldEthnicityDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiOldEthnicityDescriptor oldEthnicityDescriptorId(Integer oldEthnicityDescriptorId) {
    this.oldEthnicityDescriptorId = oldEthnicityDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return oldEthnicityDescriptorId
  **/
  ...
  public Integer getOldEthnicityDescriptorId() {
    return oldEthnicityDescriptorId;
  }

  public void setOldEthnicityDescriptorId(Integer oldEthnicityDescriptorId) {
    this.oldEthnicityDescriptorId = oldEthnicityDescriptorId;
  }

  public EdFiOldEthnicityDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiOldEthnicityDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiOldEthnicityDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiOldEthnicityDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiOldEthnicityDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiOldEthnicityDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiOldEthnicityDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiOldEthnicityDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiOldEthnicityDescriptor edFiOldEthnicityDescriptor = (EdFiOldEthnicityDescriptor) o;
    return Objects.equals(this.id, edFiOldEthnicityDescriptor.id) &&
        Objects.equals(this.oldEthnicityDescriptorId, edFiOldEthnicityDescriptor.oldEthnicityDescriptorId) &&
        Objects.equals(this.codeValue, edFiOldEthnicityDescriptor.codeValue) &&
        Objects.equals(this.description, edFiOldEthnicityDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiOldEthnicityDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiOldEthnicityDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiOldEthnicityDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiOldEthnicityDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiOldEthnicityDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiOldEthnicityDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, oldEthnicityDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiOldEthnicityDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    oldEthnicityDescriptorId: ").append(toIndentedString(oldEthnicityDescriptorId)).append("\n");
