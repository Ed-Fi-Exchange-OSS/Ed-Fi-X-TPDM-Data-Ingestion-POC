...
public class EdFiEducationPlanDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("educationPlanDescriptorId")
  private Integer educationPlanDescriptorId = null;
  ...
  public EdFiEducationPlanDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiEducationPlanDescriptor educationPlanDescriptorId(Integer educationPlanDescriptorId) {
    this.educationPlanDescriptorId = educationPlanDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return educationPlanDescriptorId
  **/
  ...
  public Integer getEducationPlanDescriptorId() {
    return educationPlanDescriptorId;
  }

  public void setEducationPlanDescriptorId(Integer educationPlanDescriptorId) {
    this.educationPlanDescriptorId = educationPlanDescriptorId;
  }

  public EdFiEducationPlanDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiEducationPlanDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiEducationPlanDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiEducationPlanDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiEducationPlanDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiEducationPlanDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiEducationPlanDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiEducationPlanDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiEducationPlanDescriptor edFiEducationPlanDescriptor = (EdFiEducationPlanDescriptor) o;
    return Objects.equals(this.id, edFiEducationPlanDescriptor.id) &&
        Objects.equals(this.educationPlanDescriptorId, edFiEducationPlanDescriptor.educationPlanDescriptorId) &&
        Objects.equals(this.codeValue, edFiEducationPlanDescriptor.codeValue) &&
        Objects.equals(this.description, edFiEducationPlanDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiEducationPlanDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiEducationPlanDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiEducationPlanDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiEducationPlanDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiEducationPlanDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiEducationPlanDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, educationPlanDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiEducationPlanDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    educationPlanDescriptorId: ").append(toIndentedString(educationPlanDescriptorId)).append("\n");
