...
public class EdFiContactTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("contactTypeDescriptorId")
  private Integer contactTypeDescriptorId = null;
  ...
  public EdFiContactTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiContactTypeDescriptor contactTypeDescriptorId(Integer contactTypeDescriptorId) {
    this.contactTypeDescriptorId = contactTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return contactTypeDescriptorId
  **/
  ...
  public Integer getContactTypeDescriptorId() {
    return contactTypeDescriptorId;
  }

  public void setContactTypeDescriptorId(Integer contactTypeDescriptorId) {
    this.contactTypeDescriptorId = contactTypeDescriptorId;
  }

  public EdFiContactTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiContactTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiContactTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiContactTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiContactTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiContactTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiContactTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiContactTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiContactTypeDescriptor edFiContactTypeDescriptor = (EdFiContactTypeDescriptor) o;
    return Objects.equals(this.id, edFiContactTypeDescriptor.id) &&
        Objects.equals(this.contactTypeDescriptorId, edFiContactTypeDescriptor.contactTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiContactTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiContactTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiContactTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiContactTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiContactTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiContactTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiContactTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiContactTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, contactTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiContactTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    contactTypeDescriptorId: ").append(toIndentedString(contactTypeDescriptorId)).append("\n");
