...
public class EdFiCalendarEventDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("calendarEventDescriptorId")
  private Integer calendarEventDescriptorId = null;
  ...
  public EdFiCalendarEventDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCalendarEventDescriptor calendarEventDescriptorId(Integer calendarEventDescriptorId) {
    this.calendarEventDescriptorId = calendarEventDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return calendarEventDescriptorId
  **/
  ...
  public Integer getCalendarEventDescriptorId() {
    return calendarEventDescriptorId;
  }

  public void setCalendarEventDescriptorId(Integer calendarEventDescriptorId) {
    this.calendarEventDescriptorId = calendarEventDescriptorId;
  }

  public EdFiCalendarEventDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCalendarEventDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCalendarEventDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCalendarEventDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCalendarEventDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCalendarEventDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCalendarEventDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCalendarEventDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCalendarEventDescriptor edFiCalendarEventDescriptor = (EdFiCalendarEventDescriptor) o;
    return Objects.equals(this.id, edFiCalendarEventDescriptor.id) &&
        Objects.equals(this.calendarEventDescriptorId, edFiCalendarEventDescriptor.calendarEventDescriptorId) &&
        Objects.equals(this.codeValue, edFiCalendarEventDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCalendarEventDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCalendarEventDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCalendarEventDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCalendarEventDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCalendarEventDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCalendarEventDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCalendarEventDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, calendarEventDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCalendarEventDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    calendarEventDescriptorId: ").append(toIndentedString(calendarEventDescriptorId)).append("\n");
