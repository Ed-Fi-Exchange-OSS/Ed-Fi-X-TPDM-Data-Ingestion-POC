...
public class TpdmAidTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("aidTypeDescriptorId")
  private Integer aidTypeDescriptorId = null;
  ...
  public TpdmAidTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmAidTypeDescriptor aidTypeDescriptorId(Integer aidTypeDescriptorId) {
    this.aidTypeDescriptorId = aidTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return aidTypeDescriptorId
  **/
  ...
  public Integer getAidTypeDescriptorId() {
    return aidTypeDescriptorId;
  }

  public void setAidTypeDescriptorId(Integer aidTypeDescriptorId) {
    this.aidTypeDescriptorId = aidTypeDescriptorId;
  }

  public TpdmAidTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmAidTypeDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmAidTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmAidTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmAidTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmAidTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmAidTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmAidTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmAidTypeDescriptor tpdmAidTypeDescriptor = (TpdmAidTypeDescriptor) o;
    return Objects.equals(this.id, tpdmAidTypeDescriptor.id) &&
        Objects.equals(this.aidTypeDescriptorId, tpdmAidTypeDescriptor.aidTypeDescriptorId) &&
        Objects.equals(this.codeValue, tpdmAidTypeDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmAidTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmAidTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmAidTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmAidTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmAidTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmAidTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmAidTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, aidTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmAidTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    aidTypeDescriptorId: ").append(toIndentedString(aidTypeDescriptorId)).append("\n");
