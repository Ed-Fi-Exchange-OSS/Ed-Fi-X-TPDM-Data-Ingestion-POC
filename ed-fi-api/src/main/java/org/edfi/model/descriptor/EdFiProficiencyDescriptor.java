...
public class EdFiProficiencyDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("proficiencyDescriptorId")
  private Integer proficiencyDescriptorId = null;
  ...
  public EdFiProficiencyDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiProficiencyDescriptor proficiencyDescriptorId(Integer proficiencyDescriptorId) {
    this.proficiencyDescriptorId = proficiencyDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return proficiencyDescriptorId
  **/
  ...
  public Integer getProficiencyDescriptorId() {
    return proficiencyDescriptorId;
  }

  public void setProficiencyDescriptorId(Integer proficiencyDescriptorId) {
    this.proficiencyDescriptorId = proficiencyDescriptorId;
  }

  public EdFiProficiencyDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiProficiencyDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiProficiencyDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiProficiencyDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiProficiencyDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiProficiencyDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiProficiencyDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiProficiencyDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiProficiencyDescriptor edFiProficiencyDescriptor = (EdFiProficiencyDescriptor) o;
    return Objects.equals(this.id, edFiProficiencyDescriptor.id) &&
        Objects.equals(this.proficiencyDescriptorId, edFiProficiencyDescriptor.proficiencyDescriptorId) &&
        Objects.equals(this.codeValue, edFiProficiencyDescriptor.codeValue) &&
        Objects.equals(this.description, edFiProficiencyDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiProficiencyDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiProficiencyDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiProficiencyDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiProficiencyDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiProficiencyDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiProficiencyDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, proficiencyDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiProficiencyDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    proficiencyDescriptorId: ").append(toIndentedString(proficiencyDescriptorId)).append("\n");
