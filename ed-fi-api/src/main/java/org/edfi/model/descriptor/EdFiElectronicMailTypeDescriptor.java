...
public class EdFiElectronicMailTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("electronicMailTypeDescriptorId")
  private Integer electronicMailTypeDescriptorId = null;
  ...
  public EdFiElectronicMailTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiElectronicMailTypeDescriptor electronicMailTypeDescriptorId(Integer electronicMailTypeDescriptorId) {
    this.electronicMailTypeDescriptorId = electronicMailTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return electronicMailTypeDescriptorId
  **/
  ...
  public Integer getElectronicMailTypeDescriptorId() {
    return electronicMailTypeDescriptorId;
  }

  public void setElectronicMailTypeDescriptorId(Integer electronicMailTypeDescriptorId) {
    this.electronicMailTypeDescriptorId = electronicMailTypeDescriptorId;
  }

  public EdFiElectronicMailTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiElectronicMailTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiElectronicMailTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiElectronicMailTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiElectronicMailTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiElectronicMailTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiElectronicMailTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiElectronicMailTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiElectronicMailTypeDescriptor edFiElectronicMailTypeDescriptor = (EdFiElectronicMailTypeDescriptor) o;
    return Objects.equals(this.id, edFiElectronicMailTypeDescriptor.id) &&
        Objects.equals(this.electronicMailTypeDescriptorId, edFiElectronicMailTypeDescriptor.electronicMailTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiElectronicMailTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiElectronicMailTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiElectronicMailTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiElectronicMailTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiElectronicMailTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiElectronicMailTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiElectronicMailTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiElectronicMailTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, electronicMailTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiElectronicMailTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    electronicMailTypeDescriptorId: ").append(toIndentedString(electronicMailTypeDescriptorId)).append("\n");
