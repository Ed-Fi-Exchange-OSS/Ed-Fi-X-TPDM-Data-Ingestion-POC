...
/**
 * TpdmLevelTypeDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmLevelTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("levelTypeDescriptorId")
  private Integer levelTypeDescriptorId = null;
  ...
  public TpdmLevelTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmLevelTypeDescriptor levelTypeDescriptorId(Integer levelTypeDescriptorId) {
    this.levelTypeDescriptorId = levelTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return levelTypeDescriptorId
  **/
  ...
  public Integer getLevelTypeDescriptorId() {
    return levelTypeDescriptorId;
  }

  public void setLevelTypeDescriptorId(Integer levelTypeDescriptorId) {
    this.levelTypeDescriptorId = levelTypeDescriptorId;
  }

  public TpdmLevelTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmLevelTypeDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmLevelTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmLevelTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmLevelTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmLevelTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmLevelTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmLevelTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmLevelTypeDescriptor tpdmLevelTypeDescriptor = (TpdmLevelTypeDescriptor) o;
    return Objects.equals(this.id, tpdmLevelTypeDescriptor.id) &&
        Objects.equals(this.levelTypeDescriptorId, tpdmLevelTypeDescriptor.levelTypeDescriptorId) &&
        Objects.equals(this.codeValue, tpdmLevelTypeDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmLevelTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmLevelTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmLevelTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmLevelTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmLevelTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmLevelTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmLevelTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, levelTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmLevelTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    levelTypeDescriptorId: ").append(toIndentedString(levelTypeDescriptorId)).append("\n");
