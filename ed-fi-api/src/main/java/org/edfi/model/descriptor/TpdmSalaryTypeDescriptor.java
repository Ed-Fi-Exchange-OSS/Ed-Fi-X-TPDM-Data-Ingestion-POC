...
/**
 * TpdmSalaryTypeDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmSalaryTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("salaryTypeDescriptorId")
  private Integer salaryTypeDescriptorId = null;
  ...
  public TpdmSalaryTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmSalaryTypeDescriptor salaryTypeDescriptorId(Integer salaryTypeDescriptorId) {
    this.salaryTypeDescriptorId = salaryTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return salaryTypeDescriptorId
  **/
  ...
  public Integer getSalaryTypeDescriptorId() {
    return salaryTypeDescriptorId;
  }

  public void setSalaryTypeDescriptorId(Integer salaryTypeDescriptorId) {
    this.salaryTypeDescriptorId = salaryTypeDescriptorId;
  }

  public TpdmSalaryTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmSalaryTypeDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmSalaryTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmSalaryTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmSalaryTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmSalaryTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmSalaryTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmSalaryTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmSalaryTypeDescriptor tpdmSalaryTypeDescriptor = (TpdmSalaryTypeDescriptor) o;
    return Objects.equals(this.id, tpdmSalaryTypeDescriptor.id) &&
        Objects.equals(this.salaryTypeDescriptorId, tpdmSalaryTypeDescriptor.salaryTypeDescriptorId) &&
        Objects.equals(this.codeValue, tpdmSalaryTypeDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmSalaryTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmSalaryTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmSalaryTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmSalaryTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmSalaryTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmSalaryTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmSalaryTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, salaryTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmSalaryTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    salaryTypeDescriptorId: ").append(toIndentedString(salaryTypeDescriptorId)).append("\n");
