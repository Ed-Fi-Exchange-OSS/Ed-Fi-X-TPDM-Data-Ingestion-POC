...
public class EdFiReporterDescriptionDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("reporterDescriptionDescriptorId")
  private Integer reporterDescriptionDescriptorId = null;
  ...
  public EdFiReporterDescriptionDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiReporterDescriptionDescriptor reporterDescriptionDescriptorId(Integer reporterDescriptionDescriptorId) {
    this.reporterDescriptionDescriptorId = reporterDescriptionDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return reporterDescriptionDescriptorId
  **/
  ...
  public Integer getReporterDescriptionDescriptorId() {
    return reporterDescriptionDescriptorId;
  }

  public void setReporterDescriptionDescriptorId(Integer reporterDescriptionDescriptorId) {
    this.reporterDescriptionDescriptorId = reporterDescriptionDescriptorId;
  }

  public EdFiReporterDescriptionDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiReporterDescriptionDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiReporterDescriptionDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiReporterDescriptionDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiReporterDescriptionDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiReporterDescriptionDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiReporterDescriptionDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiReporterDescriptionDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiReporterDescriptionDescriptor edFiReporterDescriptionDescriptor = (EdFiReporterDescriptionDescriptor) o;
    return Objects.equals(this.id, edFiReporterDescriptionDescriptor.id) &&
        Objects.equals(this.reporterDescriptionDescriptorId, edFiReporterDescriptionDescriptor.reporterDescriptionDescriptorId) &&
        Objects.equals(this.codeValue, edFiReporterDescriptionDescriptor.codeValue) &&
        Objects.equals(this.description, edFiReporterDescriptionDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiReporterDescriptionDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiReporterDescriptionDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiReporterDescriptionDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiReporterDescriptionDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiReporterDescriptionDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiReporterDescriptionDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, reporterDescriptionDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiReporterDescriptionDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    reporterDescriptionDescriptorId: ").append(toIndentedString(reporterDescriptionDescriptorId)).append("\n");
