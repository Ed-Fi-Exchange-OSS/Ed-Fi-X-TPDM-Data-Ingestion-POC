...
public class EdFiDisciplineDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("disciplineDescriptorId")
  private Integer disciplineDescriptorId = null;
  ...
  public EdFiDisciplineDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiDisciplineDescriptor disciplineDescriptorId(Integer disciplineDescriptorId) {
    this.disciplineDescriptorId = disciplineDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return disciplineDescriptorId
  **/
  ...
  public Integer getDisciplineDescriptorId() {
    return disciplineDescriptorId;
  }

  public void setDisciplineDescriptorId(Integer disciplineDescriptorId) {
    this.disciplineDescriptorId = disciplineDescriptorId;
  }

  public EdFiDisciplineDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiDisciplineDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiDisciplineDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiDisciplineDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiDisciplineDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiDisciplineDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiDisciplineDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiDisciplineDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiDisciplineDescriptor edFiDisciplineDescriptor = (EdFiDisciplineDescriptor) o;
    return Objects.equals(this.id, edFiDisciplineDescriptor.id) &&
        Objects.equals(this.disciplineDescriptorId, edFiDisciplineDescriptor.disciplineDescriptorId) &&
        Objects.equals(this.codeValue, edFiDisciplineDescriptor.codeValue) &&
        Objects.equals(this.description, edFiDisciplineDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiDisciplineDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiDisciplineDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiDisciplineDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiDisciplineDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiDisciplineDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiDisciplineDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, disciplineDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiDisciplineDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    disciplineDescriptorId: ").append(toIndentedString(disciplineDescriptorId)).append("\n");
