...
/**
 * TpdmSurveyLevelDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmSurveyLevelDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("surveyLevelDescriptorId")
  private Integer surveyLevelDescriptorId = null;
  ...
  public TpdmSurveyLevelDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmSurveyLevelDescriptor surveyLevelDescriptorId(Integer surveyLevelDescriptorId) {
    this.surveyLevelDescriptorId = surveyLevelDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return surveyLevelDescriptorId
  **/
  ...
  public Integer getSurveyLevelDescriptorId() {
    return surveyLevelDescriptorId;
  }

  public void setSurveyLevelDescriptorId(Integer surveyLevelDescriptorId) {
    this.surveyLevelDescriptorId = surveyLevelDescriptorId;
  }

  public TpdmSurveyLevelDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmSurveyLevelDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmSurveyLevelDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmSurveyLevelDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmSurveyLevelDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmSurveyLevelDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmSurveyLevelDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmSurveyLevelDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmSurveyLevelDescriptor tpdmSurveyLevelDescriptor = (TpdmSurveyLevelDescriptor) o;
    return Objects.equals(this.id, tpdmSurveyLevelDescriptor.id) &&
        Objects.equals(this.surveyLevelDescriptorId, tpdmSurveyLevelDescriptor.surveyLevelDescriptorId) &&
        Objects.equals(this.codeValue, tpdmSurveyLevelDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmSurveyLevelDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmSurveyLevelDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmSurveyLevelDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmSurveyLevelDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmSurveyLevelDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmSurveyLevelDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmSurveyLevelDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, surveyLevelDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmSurveyLevelDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    surveyLevelDescriptorId: ").append(toIndentedString(surveyLevelDescriptorId)).append("\n");
