...
public class EdFiProgramTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("programTypeDescriptorId")
  private Integer programTypeDescriptorId = null;
  ...
  public EdFiProgramTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiProgramTypeDescriptor programTypeDescriptorId(Integer programTypeDescriptorId) {
    this.programTypeDescriptorId = programTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return programTypeDescriptorId
  **/
  ...
  public Integer getProgramTypeDescriptorId() {
    return programTypeDescriptorId;
  }

  public void setProgramTypeDescriptorId(Integer programTypeDescriptorId) {
    this.programTypeDescriptorId = programTypeDescriptorId;
  }

  public EdFiProgramTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiProgramTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiProgramTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiProgramTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiProgramTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiProgramTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiProgramTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiProgramTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiProgramTypeDescriptor edFiProgramTypeDescriptor = (EdFiProgramTypeDescriptor) o;
    return Objects.equals(this.id, edFiProgramTypeDescriptor.id) &&
        Objects.equals(this.programTypeDescriptorId, edFiProgramTypeDescriptor.programTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiProgramTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiProgramTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiProgramTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiProgramTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiProgramTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiProgramTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiProgramTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiProgramTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, programTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiProgramTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    programTypeDescriptorId: ").append(toIndentedString(programTypeDescriptorId)).append("\n");
