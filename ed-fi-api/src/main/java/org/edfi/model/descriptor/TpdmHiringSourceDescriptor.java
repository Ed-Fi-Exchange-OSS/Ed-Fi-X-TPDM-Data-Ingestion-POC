...
/**
 * TpdmHiringSourceDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmHiringSourceDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("hiringSourceDescriptorId")
  private Integer hiringSourceDescriptorId = null;
  ...
  public TpdmHiringSourceDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmHiringSourceDescriptor hiringSourceDescriptorId(Integer hiringSourceDescriptorId) {
    this.hiringSourceDescriptorId = hiringSourceDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return hiringSourceDescriptorId
  **/
  ...
  public Integer getHiringSourceDescriptorId() {
    return hiringSourceDescriptorId;
  }

  public void setHiringSourceDescriptorId(Integer hiringSourceDescriptorId) {
    this.hiringSourceDescriptorId = hiringSourceDescriptorId;
  }

  public TpdmHiringSourceDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmHiringSourceDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmHiringSourceDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmHiringSourceDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmHiringSourceDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmHiringSourceDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmHiringSourceDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmHiringSourceDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmHiringSourceDescriptor tpdmHiringSourceDescriptor = (TpdmHiringSourceDescriptor) o;
    return Objects.equals(this.id, tpdmHiringSourceDescriptor.id) &&
        Objects.equals(this.hiringSourceDescriptorId, tpdmHiringSourceDescriptor.hiringSourceDescriptorId) &&
        Objects.equals(this.codeValue, tpdmHiringSourceDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmHiringSourceDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmHiringSourceDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmHiringSourceDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmHiringSourceDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmHiringSourceDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmHiringSourceDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmHiringSourceDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, hiringSourceDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmHiringSourceDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    hiringSourceDescriptorId: ").append(toIndentedString(hiringSourceDescriptorId)).append("\n");
