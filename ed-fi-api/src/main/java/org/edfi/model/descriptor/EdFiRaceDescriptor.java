...
public class EdFiRaceDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("raceDescriptorId")
  private Integer raceDescriptorId = null;
  ...
  public EdFiRaceDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiRaceDescriptor raceDescriptorId(Integer raceDescriptorId) {
    this.raceDescriptorId = raceDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return raceDescriptorId
  **/
  ...
  public Integer getRaceDescriptorId() {
    return raceDescriptorId;
  }

  public void setRaceDescriptorId(Integer raceDescriptorId) {
    this.raceDescriptorId = raceDescriptorId;
  }

  public EdFiRaceDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiRaceDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiRaceDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiRaceDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiRaceDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiRaceDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiRaceDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiRaceDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiRaceDescriptor edFiRaceDescriptor = (EdFiRaceDescriptor) o;
    return Objects.equals(this.id, edFiRaceDescriptor.id) &&
        Objects.equals(this.raceDescriptorId, edFiRaceDescriptor.raceDescriptorId) &&
        Objects.equals(this.codeValue, edFiRaceDescriptor.codeValue) &&
        Objects.equals(this.description, edFiRaceDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiRaceDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiRaceDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiRaceDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiRaceDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiRaceDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiRaceDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, raceDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiRaceDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    raceDescriptorId: ").append(toIndentedString(raceDescriptorId)).append("\n");
