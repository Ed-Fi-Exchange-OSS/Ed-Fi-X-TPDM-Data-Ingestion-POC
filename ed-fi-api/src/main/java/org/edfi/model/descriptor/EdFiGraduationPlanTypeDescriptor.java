...
public class EdFiGraduationPlanTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("graduationPlanTypeDescriptorId")
  private Integer graduationPlanTypeDescriptorId = null;
  ...
  public EdFiGraduationPlanTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiGraduationPlanTypeDescriptor graduationPlanTypeDescriptorId(Integer graduationPlanTypeDescriptorId) {
    this.graduationPlanTypeDescriptorId = graduationPlanTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return graduationPlanTypeDescriptorId
  **/
  ...
  public Integer getGraduationPlanTypeDescriptorId() {
    return graduationPlanTypeDescriptorId;
  }

  public void setGraduationPlanTypeDescriptorId(Integer graduationPlanTypeDescriptorId) {
    this.graduationPlanTypeDescriptorId = graduationPlanTypeDescriptorId;
  }

  public EdFiGraduationPlanTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiGraduationPlanTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiGraduationPlanTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiGraduationPlanTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiGraduationPlanTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiGraduationPlanTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiGraduationPlanTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiGraduationPlanTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiGraduationPlanTypeDescriptor edFiGraduationPlanTypeDescriptor = (EdFiGraduationPlanTypeDescriptor) o;
    return Objects.equals(this.id, edFiGraduationPlanTypeDescriptor.id) &&
        Objects.equals(this.graduationPlanTypeDescriptorId, edFiGraduationPlanTypeDescriptor.graduationPlanTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiGraduationPlanTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiGraduationPlanTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiGraduationPlanTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiGraduationPlanTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiGraduationPlanTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiGraduationPlanTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiGraduationPlanTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiGraduationPlanTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, graduationPlanTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiGraduationPlanTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    graduationPlanTypeDescriptorId: ").append(toIndentedString(graduationPlanTypeDescriptorId)).append("\n");
