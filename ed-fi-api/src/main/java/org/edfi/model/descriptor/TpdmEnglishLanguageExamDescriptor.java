...
public class TpdmEnglishLanguageExamDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("englishLanguageExamDescriptorId")
  private Integer englishLanguageExamDescriptorId = null;
  ...
  public TpdmEnglishLanguageExamDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmEnglishLanguageExamDescriptor englishLanguageExamDescriptorId(Integer englishLanguageExamDescriptorId) {
    this.englishLanguageExamDescriptorId = englishLanguageExamDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return englishLanguageExamDescriptorId
  **/
  ...
  public Integer getEnglishLanguageExamDescriptorId() {
    return englishLanguageExamDescriptorId;
  }

  public void setEnglishLanguageExamDescriptorId(Integer englishLanguageExamDescriptorId) {
    this.englishLanguageExamDescriptorId = englishLanguageExamDescriptorId;
  }

  public TpdmEnglishLanguageExamDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmEnglishLanguageExamDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmEnglishLanguageExamDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmEnglishLanguageExamDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmEnglishLanguageExamDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmEnglishLanguageExamDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmEnglishLanguageExamDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmEnglishLanguageExamDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmEnglishLanguageExamDescriptor tpdmEnglishLanguageExamDescriptor = (TpdmEnglishLanguageExamDescriptor) o;
    return Objects.equals(this.id, tpdmEnglishLanguageExamDescriptor.id) &&
        Objects.equals(this.englishLanguageExamDescriptorId, tpdmEnglishLanguageExamDescriptor.englishLanguageExamDescriptorId) &&
        Objects.equals(this.codeValue, tpdmEnglishLanguageExamDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmEnglishLanguageExamDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmEnglishLanguageExamDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmEnglishLanguageExamDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmEnglishLanguageExamDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmEnglishLanguageExamDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmEnglishLanguageExamDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmEnglishLanguageExamDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, englishLanguageExamDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmEnglishLanguageExamDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    englishLanguageExamDescriptorId: ").append(toIndentedString(englishLanguageExamDescriptorId)).append("\n");
