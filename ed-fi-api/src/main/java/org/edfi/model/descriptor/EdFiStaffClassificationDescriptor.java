...
public class EdFiStaffClassificationDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("staffClassificationDescriptorId")
  private Integer staffClassificationDescriptorId = null;
  ...
  public EdFiStaffClassificationDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiStaffClassificationDescriptor staffClassificationDescriptorId(Integer staffClassificationDescriptorId) {
    this.staffClassificationDescriptorId = staffClassificationDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return staffClassificationDescriptorId
  **/
  ...
  public Integer getStaffClassificationDescriptorId() {
    return staffClassificationDescriptorId;
  }

  public void setStaffClassificationDescriptorId(Integer staffClassificationDescriptorId) {
    this.staffClassificationDescriptorId = staffClassificationDescriptorId;
  }

  public EdFiStaffClassificationDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiStaffClassificationDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiStaffClassificationDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiStaffClassificationDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiStaffClassificationDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiStaffClassificationDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiStaffClassificationDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiStaffClassificationDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiStaffClassificationDescriptor edFiStaffClassificationDescriptor = (EdFiStaffClassificationDescriptor) o;
    return Objects.equals(this.id, edFiStaffClassificationDescriptor.id) &&
        Objects.equals(this.staffClassificationDescriptorId, edFiStaffClassificationDescriptor.staffClassificationDescriptorId) &&
        Objects.equals(this.codeValue, edFiStaffClassificationDescriptor.codeValue) &&
        Objects.equals(this.description, edFiStaffClassificationDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiStaffClassificationDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiStaffClassificationDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiStaffClassificationDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiStaffClassificationDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiStaffClassificationDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiStaffClassificationDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, staffClassificationDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiStaffClassificationDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    staffClassificationDescriptorId: ").append(toIndentedString(staffClassificationDescriptorId)).append("\n");
