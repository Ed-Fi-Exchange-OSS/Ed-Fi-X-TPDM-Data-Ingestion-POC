...
public class EdFiPopulationServedDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("populationServedDescriptorId")
  private Integer populationServedDescriptorId = null;
  ...
  public EdFiPopulationServedDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiPopulationServedDescriptor populationServedDescriptorId(Integer populationServedDescriptorId) {
    this.populationServedDescriptorId = populationServedDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return populationServedDescriptorId
  **/
  ...
  public Integer getPopulationServedDescriptorId() {
    return populationServedDescriptorId;
  }

  public void setPopulationServedDescriptorId(Integer populationServedDescriptorId) {
    this.populationServedDescriptorId = populationServedDescriptorId;
  }

  public EdFiPopulationServedDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiPopulationServedDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiPopulationServedDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiPopulationServedDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiPopulationServedDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiPopulationServedDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiPopulationServedDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiPopulationServedDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiPopulationServedDescriptor edFiPopulationServedDescriptor = (EdFiPopulationServedDescriptor) o;
    return Objects.equals(this.id, edFiPopulationServedDescriptor.id) &&
        Objects.equals(this.populationServedDescriptorId, edFiPopulationServedDescriptor.populationServedDescriptorId) &&
        Objects.equals(this.codeValue, edFiPopulationServedDescriptor.codeValue) &&
        Objects.equals(this.description, edFiPopulationServedDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiPopulationServedDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiPopulationServedDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiPopulationServedDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiPopulationServedDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiPopulationServedDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiPopulationServedDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, populationServedDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiPopulationServedDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    populationServedDescriptorId: ").append(toIndentedString(populationServedDescriptorId)).append("\n");
