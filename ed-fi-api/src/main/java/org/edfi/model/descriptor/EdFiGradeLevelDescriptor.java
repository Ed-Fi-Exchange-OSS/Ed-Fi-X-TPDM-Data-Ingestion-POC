...
public class EdFiGradeLevelDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("gradeLevelDescriptorId")
  private Integer gradeLevelDescriptorId = null;
  ...
  public EdFiGradeLevelDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiGradeLevelDescriptor gradeLevelDescriptorId(Integer gradeLevelDescriptorId) {
    this.gradeLevelDescriptorId = gradeLevelDescriptorId;
    return this;
  }
  ...
  **/
  ...
  public Integer getGradeLevelDescriptorId() {
    return gradeLevelDescriptorId;
  }

  public void setGradeLevelDescriptorId(Integer gradeLevelDescriptorId) {
    this.gradeLevelDescriptorId = gradeLevelDescriptorId;
  }

  public EdFiGradeLevelDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiGradeLevelDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiGradeLevelDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiGradeLevelDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiGradeLevelDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiGradeLevelDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiGradeLevelDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiGradeLevelDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiGradeLevelDescriptor edFiGradeLevelDescriptor = (EdFiGradeLevelDescriptor) o;
    return Objects.equals(this.id, edFiGradeLevelDescriptor.id) &&
        Objects.equals(this.gradeLevelDescriptorId, edFiGradeLevelDescriptor.gradeLevelDescriptorId) &&
        Objects.equals(this.codeValue, edFiGradeLevelDescriptor.codeValue) &&
        Objects.equals(this.description, edFiGradeLevelDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiGradeLevelDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiGradeLevelDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiGradeLevelDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiGradeLevelDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiGradeLevelDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiGradeLevelDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, gradeLevelDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiGradeLevelDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    gradeLevelDescriptorId: ").append(toIndentedString(gradeLevelDescriptorId)).append("\n");
