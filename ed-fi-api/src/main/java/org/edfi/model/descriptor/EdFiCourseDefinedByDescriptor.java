...
public class EdFiCourseDefinedByDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("courseDefinedByDescriptorId")
  private Integer courseDefinedByDescriptorId = null;
  ...
  public EdFiCourseDefinedByDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCourseDefinedByDescriptor courseDefinedByDescriptorId(Integer courseDefinedByDescriptorId) {
    this.courseDefinedByDescriptorId = courseDefinedByDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return courseDefinedByDescriptorId
  **/
  ...
  public Integer getCourseDefinedByDescriptorId() {
    return courseDefinedByDescriptorId;
  }

  public void setCourseDefinedByDescriptorId(Integer courseDefinedByDescriptorId) {
    this.courseDefinedByDescriptorId = courseDefinedByDescriptorId;
  }

  public EdFiCourseDefinedByDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCourseDefinedByDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCourseDefinedByDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCourseDefinedByDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCourseDefinedByDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCourseDefinedByDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCourseDefinedByDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCourseDefinedByDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCourseDefinedByDescriptor edFiCourseDefinedByDescriptor = (EdFiCourseDefinedByDescriptor) o;
    return Objects.equals(this.id, edFiCourseDefinedByDescriptor.id) &&
        Objects.equals(this.courseDefinedByDescriptorId, edFiCourseDefinedByDescriptor.courseDefinedByDescriptorId) &&
        Objects.equals(this.codeValue, edFiCourseDefinedByDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCourseDefinedByDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCourseDefinedByDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCourseDefinedByDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCourseDefinedByDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCourseDefinedByDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCourseDefinedByDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCourseDefinedByDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, courseDefinedByDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCourseDefinedByDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    courseDefinedByDescriptorId: ").append(toIndentedString(courseDefinedByDescriptorId)).append("\n");
