...
public class EdFiPerformanceLevelDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("performanceLevelDescriptorId")
  private Integer performanceLevelDescriptorId = null;
  ...
  public EdFiPerformanceLevelDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiPerformanceLevelDescriptor performanceLevelDescriptorId(Integer performanceLevelDescriptorId) {
    this.performanceLevelDescriptorId = performanceLevelDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return performanceLevelDescriptorId
  **/
  ...
  public Integer getPerformanceLevelDescriptorId() {
    return performanceLevelDescriptorId;
  }

  public void setPerformanceLevelDescriptorId(Integer performanceLevelDescriptorId) {
    this.performanceLevelDescriptorId = performanceLevelDescriptorId;
  }

  public EdFiPerformanceLevelDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiPerformanceLevelDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiPerformanceLevelDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiPerformanceLevelDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiPerformanceLevelDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiPerformanceLevelDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiPerformanceLevelDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiPerformanceLevelDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiPerformanceLevelDescriptor edFiPerformanceLevelDescriptor = (EdFiPerformanceLevelDescriptor) o;
    return Objects.equals(this.id, edFiPerformanceLevelDescriptor.id) &&
        Objects.equals(this.performanceLevelDescriptorId, edFiPerformanceLevelDescriptor.performanceLevelDescriptorId) &&
        Objects.equals(this.codeValue, edFiPerformanceLevelDescriptor.codeValue) &&
        Objects.equals(this.description, edFiPerformanceLevelDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiPerformanceLevelDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiPerformanceLevelDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiPerformanceLevelDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiPerformanceLevelDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiPerformanceLevelDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiPerformanceLevelDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, performanceLevelDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiPerformanceLevelDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    performanceLevelDescriptorId: ").append(toIndentedString(performanceLevelDescriptorId)).append("\n");
