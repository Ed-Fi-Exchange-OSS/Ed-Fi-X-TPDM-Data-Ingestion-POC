...
public class EdFiServiceDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("serviceDescriptorId")
  private Integer serviceDescriptorId = null;
  ...
  public EdFiServiceDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiServiceDescriptor serviceDescriptorId(Integer serviceDescriptorId) {
  ...
  **/
  ...
  public Integer getServiceDescriptorId() {
    return serviceDescriptorId;
  }

  public void setServiceDescriptorId(Integer serviceDescriptorId) {
    this.serviceDescriptorId = serviceDescriptorId;
  }

  public EdFiServiceDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiServiceDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiServiceDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiServiceDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiServiceDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiServiceDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiServiceDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiServiceDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiServiceDescriptor edFiServiceDescriptor = (EdFiServiceDescriptor) o;
    return Objects.equals(this.id, edFiServiceDescriptor.id) &&
        Objects.equals(this.serviceDescriptorId, edFiServiceDescriptor.serviceDescriptorId) &&
        Objects.equals(this.codeValue, edFiServiceDescriptor.codeValue) &&
        Objects.equals(this.description, edFiServiceDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiServiceDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiServiceDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiServiceDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiServiceDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiServiceDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiServiceDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, serviceDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiServiceDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    serviceDescriptorId: ").append(toIndentedString(serviceDescriptorId)).append("\n");
