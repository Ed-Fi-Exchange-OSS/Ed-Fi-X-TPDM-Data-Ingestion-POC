...
public class EdFiWeaponDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("weaponDescriptorId")
  private Integer weaponDescriptorId = null;
  ...
  public EdFiWeaponDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiWeaponDescriptor weaponDescriptorId(Integer weaponDescriptorId) {
    this.weaponDescriptorId = weaponDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return weaponDescriptorId
  **/
  ...
  public Integer getWeaponDescriptorId() {
    return weaponDescriptorId;
  }

  public void setWeaponDescriptorId(Integer weaponDescriptorId) {
    this.weaponDescriptorId = weaponDescriptorId;
  }

  public EdFiWeaponDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiWeaponDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiWeaponDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiWeaponDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiWeaponDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiWeaponDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiWeaponDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiWeaponDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiWeaponDescriptor edFiWeaponDescriptor = (EdFiWeaponDescriptor) o;
    return Objects.equals(this.id, edFiWeaponDescriptor.id) &&
        Objects.equals(this.weaponDescriptorId, edFiWeaponDescriptor.weaponDescriptorId) &&
        Objects.equals(this.codeValue, edFiWeaponDescriptor.codeValue) &&
        Objects.equals(this.description, edFiWeaponDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiWeaponDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiWeaponDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiWeaponDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiWeaponDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiWeaponDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiWeaponDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, weaponDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiWeaponDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    weaponDescriptorId: ").append(toIndentedString(weaponDescriptorId)).append("\n");
