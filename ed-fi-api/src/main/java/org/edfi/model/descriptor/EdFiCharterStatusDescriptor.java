...
public class EdFiCharterStatusDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("charterStatusDescriptorId")
  private Integer charterStatusDescriptorId = null;
  ...
  public EdFiCharterStatusDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCharterStatusDescriptor charterStatusDescriptorId(Integer charterStatusDescriptorId) {
    this.charterStatusDescriptorId = charterStatusDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return charterStatusDescriptorId
  **/
  ...
  public Integer getCharterStatusDescriptorId() {
    return charterStatusDescriptorId;
  }

  public void setCharterStatusDescriptorId(Integer charterStatusDescriptorId) {
    this.charterStatusDescriptorId = charterStatusDescriptorId;
  }

  public EdFiCharterStatusDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCharterStatusDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCharterStatusDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCharterStatusDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCharterStatusDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCharterStatusDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCharterStatusDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCharterStatusDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCharterStatusDescriptor edFiCharterStatusDescriptor = (EdFiCharterStatusDescriptor) o;
    return Objects.equals(this.id, edFiCharterStatusDescriptor.id) &&
        Objects.equals(this.charterStatusDescriptorId, edFiCharterStatusDescriptor.charterStatusDescriptorId) &&
        Objects.equals(this.codeValue, edFiCharterStatusDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCharterStatusDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCharterStatusDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCharterStatusDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCharterStatusDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCharterStatusDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCharterStatusDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCharterStatusDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, charterStatusDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCharterStatusDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    charterStatusDescriptorId: ").append(toIndentedString(charterStatusDescriptorId)).append("\n");
