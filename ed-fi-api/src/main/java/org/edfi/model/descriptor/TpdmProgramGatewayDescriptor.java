...
/**
 * TpdmProgramGatewayDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmProgramGatewayDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("programGatewayDescriptorId")
  private Integer programGatewayDescriptorId = null;
  ...
  public TpdmProgramGatewayDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmProgramGatewayDescriptor programGatewayDescriptorId(Integer programGatewayDescriptorId) {
    this.programGatewayDescriptorId = programGatewayDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return programGatewayDescriptorId
  **/
  ...
  public Integer getProgramGatewayDescriptorId() {
    return programGatewayDescriptorId;
  }

  public void setProgramGatewayDescriptorId(Integer programGatewayDescriptorId) {
    this.programGatewayDescriptorId = programGatewayDescriptorId;
  }

  public TpdmProgramGatewayDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmProgramGatewayDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmProgramGatewayDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmProgramGatewayDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmProgramGatewayDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmProgramGatewayDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmProgramGatewayDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmProgramGatewayDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmProgramGatewayDescriptor tpdmProgramGatewayDescriptor = (TpdmProgramGatewayDescriptor) o;
    return Objects.equals(this.id, tpdmProgramGatewayDescriptor.id) &&
        Objects.equals(this.programGatewayDescriptorId, tpdmProgramGatewayDescriptor.programGatewayDescriptorId) &&
        Objects.equals(this.codeValue, tpdmProgramGatewayDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmProgramGatewayDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmProgramGatewayDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmProgramGatewayDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmProgramGatewayDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmProgramGatewayDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmProgramGatewayDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmProgramGatewayDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, programGatewayDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmProgramGatewayDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    programGatewayDescriptorId: ").append(toIndentedString(programGatewayDescriptorId)).append("\n");
