...
public class EdFiProgressDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("progressDescriptorId")
  private Integer progressDescriptorId = null;
  ...
  public EdFiProgressDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiProgressDescriptor progressDescriptorId(Integer progressDescriptorId) {
    this.progressDescriptorId = progressDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return progressDescriptorId
  **/
  ...
  public Integer getProgressDescriptorId() {
    return progressDescriptorId;
  }

  public void setProgressDescriptorId(Integer progressDescriptorId) {
    this.progressDescriptorId = progressDescriptorId;
  }

  public EdFiProgressDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiProgressDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiProgressDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiProgressDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiProgressDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiProgressDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiProgressDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiProgressDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiProgressDescriptor edFiProgressDescriptor = (EdFiProgressDescriptor) o;
    return Objects.equals(this.id, edFiProgressDescriptor.id) &&
        Objects.equals(this.progressDescriptorId, edFiProgressDescriptor.progressDescriptorId) &&
        Objects.equals(this.codeValue, edFiProgressDescriptor.codeValue) &&
        Objects.equals(this.description, edFiProgressDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiProgressDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiProgressDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiProgressDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiProgressDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiProgressDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiProgressDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, progressDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiProgressDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    progressDescriptorId: ").append(toIndentedString(progressDescriptorId)).append("\n");
