...
public class EdFiEntryTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("entryTypeDescriptorId")
  private Integer entryTypeDescriptorId = null;
  ...
  public EdFiEntryTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiEntryTypeDescriptor entryTypeDescriptorId(Integer entryTypeDescriptorId) {
    this.entryTypeDescriptorId = entryTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return entryTypeDescriptorId
  **/
  ...
  public Integer getEntryTypeDescriptorId() {
    return entryTypeDescriptorId;
  }

  public void setEntryTypeDescriptorId(Integer entryTypeDescriptorId) {
    this.entryTypeDescriptorId = entryTypeDescriptorId;
  }

  public EdFiEntryTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiEntryTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiEntryTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiEntryTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiEntryTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiEntryTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiEntryTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiEntryTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiEntryTypeDescriptor edFiEntryTypeDescriptor = (EdFiEntryTypeDescriptor) o;
    return Objects.equals(this.id, edFiEntryTypeDescriptor.id) &&
        Objects.equals(this.entryTypeDescriptorId, edFiEntryTypeDescriptor.entryTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiEntryTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiEntryTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiEntryTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiEntryTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiEntryTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiEntryTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiEntryTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiEntryTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, entryTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiEntryTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    entryTypeDescriptorId: ").append(toIndentedString(entryTypeDescriptorId)).append("\n");
