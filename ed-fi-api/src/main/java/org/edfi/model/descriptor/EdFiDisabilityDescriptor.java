...
public class EdFiDisabilityDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("disabilityDescriptorId")
  private Integer disabilityDescriptorId = null;
  ...
  public EdFiDisabilityDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiDisabilityDescriptor disabilityDescriptorId(Integer disabilityDescriptorId) {
    this.disabilityDescriptorId = disabilityDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return disabilityDescriptorId
  **/
  ...
  public Integer getDisabilityDescriptorId() {
    return disabilityDescriptorId;
  }

  public void setDisabilityDescriptorId(Integer disabilityDescriptorId) {
    this.disabilityDescriptorId = disabilityDescriptorId;
  }

  public EdFiDisabilityDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiDisabilityDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiDisabilityDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiDisabilityDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiDisabilityDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiDisabilityDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiDisabilityDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiDisabilityDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiDisabilityDescriptor edFiDisabilityDescriptor = (EdFiDisabilityDescriptor) o;
    return Objects.equals(this.id, edFiDisabilityDescriptor.id) &&
        Objects.equals(this.disabilityDescriptorId, edFiDisabilityDescriptor.disabilityDescriptorId) &&
        Objects.equals(this.codeValue, edFiDisabilityDescriptor.codeValue) &&
        Objects.equals(this.description, edFiDisabilityDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiDisabilityDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiDisabilityDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiDisabilityDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiDisabilityDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiDisabilityDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiDisabilityDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, disabilityDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiDisabilityDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    disabilityDescriptorId: ").append(toIndentedString(disabilityDescriptorId)).append("\n");
