...
/**
 * TpdmPreviousCareerDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmPreviousCareerDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("previousCareerDescriptorId")
  private Integer previousCareerDescriptorId = null;
  ...
  public TpdmPreviousCareerDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmPreviousCareerDescriptor previousCareerDescriptorId(Integer previousCareerDescriptorId) {
    this.previousCareerDescriptorId = previousCareerDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return previousCareerDescriptorId
  **/
  ...
  public Integer getPreviousCareerDescriptorId() {
    return previousCareerDescriptorId;
  }

  public void setPreviousCareerDescriptorId(Integer previousCareerDescriptorId) {
    this.previousCareerDescriptorId = previousCareerDescriptorId;
  }

  public TpdmPreviousCareerDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmPreviousCareerDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmPreviousCareerDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmPreviousCareerDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmPreviousCareerDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmPreviousCareerDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmPreviousCareerDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmPreviousCareerDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmPreviousCareerDescriptor tpdmPreviousCareerDescriptor = (TpdmPreviousCareerDescriptor) o;
    return Objects.equals(this.id, tpdmPreviousCareerDescriptor.id) &&
        Objects.equals(this.previousCareerDescriptorId, tpdmPreviousCareerDescriptor.previousCareerDescriptorId) &&
        Objects.equals(this.codeValue, tpdmPreviousCareerDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmPreviousCareerDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmPreviousCareerDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmPreviousCareerDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmPreviousCareerDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmPreviousCareerDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmPreviousCareerDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmPreviousCareerDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, previousCareerDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmPreviousCareerDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    previousCareerDescriptorId: ").append(toIndentedString(previousCareerDescriptorId)).append("\n");
