...
public class EdFiResponseIndicatorDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("responseIndicatorDescriptorId")
  private Integer responseIndicatorDescriptorId = null;
  ...
  public EdFiResponseIndicatorDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiResponseIndicatorDescriptor responseIndicatorDescriptorId(Integer responseIndicatorDescriptorId) {
    this.responseIndicatorDescriptorId = responseIndicatorDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return responseIndicatorDescriptorId
  **/
  ...
  public Integer getResponseIndicatorDescriptorId() {
    return responseIndicatorDescriptorId;
  }

  public void setResponseIndicatorDescriptorId(Integer responseIndicatorDescriptorId) {
    this.responseIndicatorDescriptorId = responseIndicatorDescriptorId;
  }

  public EdFiResponseIndicatorDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiResponseIndicatorDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiResponseIndicatorDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiResponseIndicatorDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiResponseIndicatorDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiResponseIndicatorDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiResponseIndicatorDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiResponseIndicatorDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiResponseIndicatorDescriptor edFiResponseIndicatorDescriptor = (EdFiResponseIndicatorDescriptor) o;
    return Objects.equals(this.id, edFiResponseIndicatorDescriptor.id) &&
        Objects.equals(this.responseIndicatorDescriptorId, edFiResponseIndicatorDescriptor.responseIndicatorDescriptorId) &&
        Objects.equals(this.codeValue, edFiResponseIndicatorDescriptor.codeValue) &&
        Objects.equals(this.description, edFiResponseIndicatorDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiResponseIndicatorDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiResponseIndicatorDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiResponseIndicatorDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiResponseIndicatorDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiResponseIndicatorDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiResponseIndicatorDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, responseIndicatorDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiResponseIndicatorDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    responseIndicatorDescriptorId: ").append(toIndentedString(responseIndicatorDescriptorId)).append("\n");
