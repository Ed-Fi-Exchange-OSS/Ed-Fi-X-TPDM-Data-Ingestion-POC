...
/**
 * TpdmFederalLocaleCodeDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmFederalLocaleCodeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("federalLocaleCodeDescriptorId")
  private Integer federalLocaleCodeDescriptorId = null;
  ...
  public TpdmFederalLocaleCodeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmFederalLocaleCodeDescriptor federalLocaleCodeDescriptorId(Integer federalLocaleCodeDescriptorId) {
    this.federalLocaleCodeDescriptorId = federalLocaleCodeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return federalLocaleCodeDescriptorId
  **/
  ...
  public Integer getFederalLocaleCodeDescriptorId() {
    return federalLocaleCodeDescriptorId;
  }

  public void setFederalLocaleCodeDescriptorId(Integer federalLocaleCodeDescriptorId) {
    this.federalLocaleCodeDescriptorId = federalLocaleCodeDescriptorId;
  }

  public TpdmFederalLocaleCodeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmFederalLocaleCodeDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmFederalLocaleCodeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmFederalLocaleCodeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmFederalLocaleCodeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmFederalLocaleCodeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmFederalLocaleCodeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmFederalLocaleCodeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmFederalLocaleCodeDescriptor tpdmFederalLocaleCodeDescriptor = (TpdmFederalLocaleCodeDescriptor) o;
    return Objects.equals(this.id, tpdmFederalLocaleCodeDescriptor.id) &&
        Objects.equals(this.federalLocaleCodeDescriptorId, tpdmFederalLocaleCodeDescriptor.federalLocaleCodeDescriptorId) &&
        Objects.equals(this.codeValue, tpdmFederalLocaleCodeDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmFederalLocaleCodeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmFederalLocaleCodeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmFederalLocaleCodeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmFederalLocaleCodeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmFederalLocaleCodeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmFederalLocaleCodeDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmFederalLocaleCodeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, federalLocaleCodeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmFederalLocaleCodeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    federalLocaleCodeDescriptorId: ").append(toIndentedString(federalLocaleCodeDescriptorId)).append("\n");
