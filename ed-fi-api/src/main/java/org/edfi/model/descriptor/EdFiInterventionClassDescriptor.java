...
public class EdFiInterventionClassDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("interventionClassDescriptorId")
  private Integer interventionClassDescriptorId = null;
  ...
  public EdFiInterventionClassDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiInterventionClassDescriptor interventionClassDescriptorId(Integer interventionClassDescriptorId) {
    this.interventionClassDescriptorId = interventionClassDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return interventionClassDescriptorId
  **/
  ...
  public Integer getInterventionClassDescriptorId() {
    return interventionClassDescriptorId;
  }

  public void setInterventionClassDescriptorId(Integer interventionClassDescriptorId) {
    this.interventionClassDescriptorId = interventionClassDescriptorId;
  }

  public EdFiInterventionClassDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiInterventionClassDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiInterventionClassDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiInterventionClassDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiInterventionClassDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiInterventionClassDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiInterventionClassDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiInterventionClassDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiInterventionClassDescriptor edFiInterventionClassDescriptor = (EdFiInterventionClassDescriptor) o;
    return Objects.equals(this.id, edFiInterventionClassDescriptor.id) &&
        Objects.equals(this.interventionClassDescriptorId, edFiInterventionClassDescriptor.interventionClassDescriptorId) &&
        Objects.equals(this.codeValue, edFiInterventionClassDescriptor.codeValue) &&
        Objects.equals(this.description, edFiInterventionClassDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiInterventionClassDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiInterventionClassDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiInterventionClassDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiInterventionClassDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiInterventionClassDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiInterventionClassDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, interventionClassDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiInterventionClassDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    interventionClassDescriptorId: ").append(toIndentedString(interventionClassDescriptorId)).append("\n");
