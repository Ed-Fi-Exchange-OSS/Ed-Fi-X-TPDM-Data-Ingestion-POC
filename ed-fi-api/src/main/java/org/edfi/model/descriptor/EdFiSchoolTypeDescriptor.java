...
public class EdFiSchoolTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("schoolTypeDescriptorId")
  private Integer schoolTypeDescriptorId = null;
  ...
  public EdFiSchoolTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiSchoolTypeDescriptor schoolTypeDescriptorId(Integer schoolTypeDescriptorId) {
    this.schoolTypeDescriptorId = schoolTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return schoolTypeDescriptorId
  **/
  ...
  public Integer getSchoolTypeDescriptorId() {
    return schoolTypeDescriptorId;
  }

  public void setSchoolTypeDescriptorId(Integer schoolTypeDescriptorId) {
    this.schoolTypeDescriptorId = schoolTypeDescriptorId;
  }

  public EdFiSchoolTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiSchoolTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiSchoolTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiSchoolTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiSchoolTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiSchoolTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiSchoolTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiSchoolTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiSchoolTypeDescriptor edFiSchoolTypeDescriptor = (EdFiSchoolTypeDescriptor) o;
    return Objects.equals(this.id, edFiSchoolTypeDescriptor.id) &&
        Objects.equals(this.schoolTypeDescriptorId, edFiSchoolTypeDescriptor.schoolTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiSchoolTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiSchoolTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiSchoolTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiSchoolTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiSchoolTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiSchoolTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiSchoolTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiSchoolTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, schoolTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiSchoolTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    schoolTypeDescriptorId: ").append(toIndentedString(schoolTypeDescriptorId)).append("\n");
