...
public class EdFiAccommodationDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("accommodationDescriptorId")
  private Integer accommodationDescriptorId = null;
  ...
  public EdFiAccommodationDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiAccommodationDescriptor accommodationDescriptorId(Integer accommodationDescriptorId) {
    this.accommodationDescriptorId = accommodationDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return accommodationDescriptorId
  **/
  ...
  public Integer getAccommodationDescriptorId() {
    return accommodationDescriptorId;
  }

  public void setAccommodationDescriptorId(Integer accommodationDescriptorId) {
    this.accommodationDescriptorId = accommodationDescriptorId;
  }

  public EdFiAccommodationDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiAccommodationDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiAccommodationDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiAccommodationDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiAccommodationDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiAccommodationDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiAccommodationDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiAccommodationDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiAccommodationDescriptor edFiAccommodationDescriptor = (EdFiAccommodationDescriptor) o;
    return Objects.equals(this.id, edFiAccommodationDescriptor.id) &&
        Objects.equals(this.accommodationDescriptorId, edFiAccommodationDescriptor.accommodationDescriptorId) &&
        Objects.equals(this.codeValue, edFiAccommodationDescriptor.codeValue) &&
        Objects.equals(this.description, edFiAccommodationDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiAccommodationDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiAccommodationDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiAccommodationDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiAccommodationDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiAccommodationDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiAccommodationDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, accommodationDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiAccommodationDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    accommodationDescriptorId: ").append(toIndentedString(accommodationDescriptorId)).append("\n");
