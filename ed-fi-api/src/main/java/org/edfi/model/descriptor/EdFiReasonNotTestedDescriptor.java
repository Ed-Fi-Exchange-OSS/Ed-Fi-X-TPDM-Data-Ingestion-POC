...
public class EdFiReasonNotTestedDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("reasonNotTestedDescriptorId")
  private Integer reasonNotTestedDescriptorId = null;
  ...
  public EdFiReasonNotTestedDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiReasonNotTestedDescriptor reasonNotTestedDescriptorId(Integer reasonNotTestedDescriptorId) {
    this.reasonNotTestedDescriptorId = reasonNotTestedDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return reasonNotTestedDescriptorId
  **/
  ...
  public Integer getReasonNotTestedDescriptorId() {
    return reasonNotTestedDescriptorId;
  }

  public void setReasonNotTestedDescriptorId(Integer reasonNotTestedDescriptorId) {
    this.reasonNotTestedDescriptorId = reasonNotTestedDescriptorId;
  }

  public EdFiReasonNotTestedDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiReasonNotTestedDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiReasonNotTestedDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiReasonNotTestedDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiReasonNotTestedDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiReasonNotTestedDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiReasonNotTestedDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiReasonNotTestedDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiReasonNotTestedDescriptor edFiReasonNotTestedDescriptor = (EdFiReasonNotTestedDescriptor) o;
    return Objects.equals(this.id, edFiReasonNotTestedDescriptor.id) &&
        Objects.equals(this.reasonNotTestedDescriptorId, edFiReasonNotTestedDescriptor.reasonNotTestedDescriptorId) &&
        Objects.equals(this.codeValue, edFiReasonNotTestedDescriptor.codeValue) &&
        Objects.equals(this.description, edFiReasonNotTestedDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiReasonNotTestedDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiReasonNotTestedDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiReasonNotTestedDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiReasonNotTestedDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiReasonNotTestedDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiReasonNotTestedDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, reasonNotTestedDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiReasonNotTestedDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    reasonNotTestedDescriptorId: ").append(toIndentedString(reasonNotTestedDescriptorId)).append("\n");
