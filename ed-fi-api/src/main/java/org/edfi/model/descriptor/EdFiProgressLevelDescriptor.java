...
public class EdFiProgressLevelDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("progressLevelDescriptorId")
  private Integer progressLevelDescriptorId = null;
  ...
  public EdFiProgressLevelDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiProgressLevelDescriptor progressLevelDescriptorId(Integer progressLevelDescriptorId) {
    this.progressLevelDescriptorId = progressLevelDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return progressLevelDescriptorId
  **/
  ...
  public Integer getProgressLevelDescriptorId() {
    return progressLevelDescriptorId;
  }

  public void setProgressLevelDescriptorId(Integer progressLevelDescriptorId) {
    this.progressLevelDescriptorId = progressLevelDescriptorId;
  }

  public EdFiProgressLevelDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiProgressLevelDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiProgressLevelDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiProgressLevelDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiProgressLevelDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiProgressLevelDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiProgressLevelDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiProgressLevelDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiProgressLevelDescriptor edFiProgressLevelDescriptor = (EdFiProgressLevelDescriptor) o;
    return Objects.equals(this.id, edFiProgressLevelDescriptor.id) &&
        Objects.equals(this.progressLevelDescriptorId, edFiProgressLevelDescriptor.progressLevelDescriptorId) &&
        Objects.equals(this.codeValue, edFiProgressLevelDescriptor.codeValue) &&
        Objects.equals(this.description, edFiProgressLevelDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiProgressLevelDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiProgressLevelDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiProgressLevelDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiProgressLevelDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiProgressLevelDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiProgressLevelDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, progressLevelDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiProgressLevelDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    progressLevelDescriptorId: ").append(toIndentedString(progressLevelDescriptorId)).append("\n");
