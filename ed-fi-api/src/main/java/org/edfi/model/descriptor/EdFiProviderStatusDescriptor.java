...
public class EdFiProviderStatusDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("providerStatusDescriptorId")
  private Integer providerStatusDescriptorId = null;
  ...
  public EdFiProviderStatusDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiProviderStatusDescriptor providerStatusDescriptorId(Integer providerStatusDescriptorId) {
    this.providerStatusDescriptorId = providerStatusDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return providerStatusDescriptorId
  **/
  ...
  public Integer getProviderStatusDescriptorId() {
    return providerStatusDescriptorId;
  }

  public void setProviderStatusDescriptorId(Integer providerStatusDescriptorId) {
    this.providerStatusDescriptorId = providerStatusDescriptorId;
  }

  public EdFiProviderStatusDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiProviderStatusDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiProviderStatusDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiProviderStatusDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiProviderStatusDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiProviderStatusDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiProviderStatusDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiProviderStatusDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiProviderStatusDescriptor edFiProviderStatusDescriptor = (EdFiProviderStatusDescriptor) o;
    return Objects.equals(this.id, edFiProviderStatusDescriptor.id) &&
        Objects.equals(this.providerStatusDescriptorId, edFiProviderStatusDescriptor.providerStatusDescriptorId) &&
        Objects.equals(this.codeValue, edFiProviderStatusDescriptor.codeValue) &&
        Objects.equals(this.description, edFiProviderStatusDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiProviderStatusDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiProviderStatusDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiProviderStatusDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiProviderStatusDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiProviderStatusDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiProviderStatusDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, providerStatusDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiProviderStatusDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    providerStatusDescriptorId: ").append(toIndentedString(providerStatusDescriptorId)).append("\n");
