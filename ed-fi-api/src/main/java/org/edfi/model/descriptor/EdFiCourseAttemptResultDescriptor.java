...
public class EdFiCourseAttemptResultDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("courseAttemptResultDescriptorId")
  private Integer courseAttemptResultDescriptorId = null;
  ...
  public EdFiCourseAttemptResultDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCourseAttemptResultDescriptor courseAttemptResultDescriptorId(Integer courseAttemptResultDescriptorId) {
    this.courseAttemptResultDescriptorId = courseAttemptResultDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return courseAttemptResultDescriptorId
  **/
  ...
  public Integer getCourseAttemptResultDescriptorId() {
    return courseAttemptResultDescriptorId;
  }

  public void setCourseAttemptResultDescriptorId(Integer courseAttemptResultDescriptorId) {
    this.courseAttemptResultDescriptorId = courseAttemptResultDescriptorId;
  }

  public EdFiCourseAttemptResultDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCourseAttemptResultDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCourseAttemptResultDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCourseAttemptResultDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCourseAttemptResultDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCourseAttemptResultDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCourseAttemptResultDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCourseAttemptResultDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCourseAttemptResultDescriptor edFiCourseAttemptResultDescriptor = (EdFiCourseAttemptResultDescriptor) o;
    return Objects.equals(this.id, edFiCourseAttemptResultDescriptor.id) &&
        Objects.equals(this.courseAttemptResultDescriptorId, edFiCourseAttemptResultDescriptor.courseAttemptResultDescriptorId) &&
        Objects.equals(this.codeValue, edFiCourseAttemptResultDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCourseAttemptResultDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCourseAttemptResultDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCourseAttemptResultDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCourseAttemptResultDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCourseAttemptResultDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCourseAttemptResultDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCourseAttemptResultDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, courseAttemptResultDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCourseAttemptResultDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    courseAttemptResultDescriptorId: ").append(toIndentedString(courseAttemptResultDescriptorId)).append("\n");
