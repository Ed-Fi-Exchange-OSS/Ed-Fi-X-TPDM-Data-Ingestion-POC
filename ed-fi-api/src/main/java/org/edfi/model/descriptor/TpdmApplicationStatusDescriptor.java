...
/**
 * TpdmApplicationStatusDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmApplicationStatusDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("applicationStatusDescriptorId")
  private Integer applicationStatusDescriptorId = null;
  ...
  public TpdmApplicationStatusDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmApplicationStatusDescriptor applicationStatusDescriptorId(Integer applicationStatusDescriptorId) {
    this.applicationStatusDescriptorId = applicationStatusDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return applicationStatusDescriptorId
  **/
  ...
  public Integer getApplicationStatusDescriptorId() {
    return applicationStatusDescriptorId;
  }

  public void setApplicationStatusDescriptorId(Integer applicationStatusDescriptorId) {
    this.applicationStatusDescriptorId = applicationStatusDescriptorId;
  }

  public TpdmApplicationStatusDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmApplicationStatusDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmApplicationStatusDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmApplicationStatusDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmApplicationStatusDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmApplicationStatusDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmApplicationStatusDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmApplicationStatusDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmApplicationStatusDescriptor tpdmApplicationStatusDescriptor = (TpdmApplicationStatusDescriptor) o;
    return Objects.equals(this.id, tpdmApplicationStatusDescriptor.id) &&
        Objects.equals(this.applicationStatusDescriptorId, tpdmApplicationStatusDescriptor.applicationStatusDescriptorId) &&
        Objects.equals(this.codeValue, tpdmApplicationStatusDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmApplicationStatusDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmApplicationStatusDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmApplicationStatusDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmApplicationStatusDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmApplicationStatusDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmApplicationStatusDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmApplicationStatusDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, applicationStatusDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmApplicationStatusDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    applicationStatusDescriptorId: ").append(toIndentedString(applicationStatusDescriptorId)).append("\n");
