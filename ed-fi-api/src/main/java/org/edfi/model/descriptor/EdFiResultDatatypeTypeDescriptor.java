...
public class EdFiResultDatatypeTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("resultDatatypeTypeDescriptorId")
  private Integer resultDatatypeTypeDescriptorId = null;
  ...
  public EdFiResultDatatypeTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiResultDatatypeTypeDescriptor resultDatatypeTypeDescriptorId(Integer resultDatatypeTypeDescriptorId) {
    this.resultDatatypeTypeDescriptorId = resultDatatypeTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return resultDatatypeTypeDescriptorId
  **/
  ...
  public Integer getResultDatatypeTypeDescriptorId() {
    return resultDatatypeTypeDescriptorId;
  }

  public void setResultDatatypeTypeDescriptorId(Integer resultDatatypeTypeDescriptorId) {
    this.resultDatatypeTypeDescriptorId = resultDatatypeTypeDescriptorId;
  }

  public EdFiResultDatatypeTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiResultDatatypeTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiResultDatatypeTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiResultDatatypeTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiResultDatatypeTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiResultDatatypeTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiResultDatatypeTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiResultDatatypeTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiResultDatatypeTypeDescriptor edFiResultDatatypeTypeDescriptor = (EdFiResultDatatypeTypeDescriptor) o;
    return Objects.equals(this.id, edFiResultDatatypeTypeDescriptor.id) &&
        Objects.equals(this.resultDatatypeTypeDescriptorId, edFiResultDatatypeTypeDescriptor.resultDatatypeTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiResultDatatypeTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiResultDatatypeTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiResultDatatypeTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiResultDatatypeTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiResultDatatypeTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiResultDatatypeTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiResultDatatypeTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiResultDatatypeTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, resultDatatypeTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiResultDatatypeTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    resultDatatypeTypeDescriptorId: ").append(toIndentedString(resultDatatypeTypeDescriptorId)).append("\n");
