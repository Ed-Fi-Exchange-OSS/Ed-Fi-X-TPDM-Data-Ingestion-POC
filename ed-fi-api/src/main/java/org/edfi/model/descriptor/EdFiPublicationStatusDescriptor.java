...
public class EdFiPublicationStatusDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("publicationStatusDescriptorId")
  private Integer publicationStatusDescriptorId = null;
  ...
  public EdFiPublicationStatusDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiPublicationStatusDescriptor publicationStatusDescriptorId(Integer publicationStatusDescriptorId) {
    this.publicationStatusDescriptorId = publicationStatusDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return publicationStatusDescriptorId
  **/
  ...
  public Integer getPublicationStatusDescriptorId() {
    return publicationStatusDescriptorId;
  }

  public void setPublicationStatusDescriptorId(Integer publicationStatusDescriptorId) {
    this.publicationStatusDescriptorId = publicationStatusDescriptorId;
  }

  public EdFiPublicationStatusDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiPublicationStatusDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiPublicationStatusDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiPublicationStatusDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiPublicationStatusDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiPublicationStatusDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiPublicationStatusDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiPublicationStatusDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiPublicationStatusDescriptor edFiPublicationStatusDescriptor = (EdFiPublicationStatusDescriptor) o;
    return Objects.equals(this.id, edFiPublicationStatusDescriptor.id) &&
        Objects.equals(this.publicationStatusDescriptorId, edFiPublicationStatusDescriptor.publicationStatusDescriptorId) &&
        Objects.equals(this.codeValue, edFiPublicationStatusDescriptor.codeValue) &&
        Objects.equals(this.description, edFiPublicationStatusDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiPublicationStatusDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiPublicationStatusDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiPublicationStatusDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiPublicationStatusDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiPublicationStatusDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiPublicationStatusDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, publicationStatusDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiPublicationStatusDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    publicationStatusDescriptorId: ").append(toIndentedString(publicationStatusDescriptorId)).append("\n");
