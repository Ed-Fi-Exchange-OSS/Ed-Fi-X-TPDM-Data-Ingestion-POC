...
public class EdFiCourseRepeatCodeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("courseRepeatCodeDescriptorId")
  private Integer courseRepeatCodeDescriptorId = null;
  ...
  public EdFiCourseRepeatCodeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCourseRepeatCodeDescriptor courseRepeatCodeDescriptorId(Integer courseRepeatCodeDescriptorId) {
    this.courseRepeatCodeDescriptorId = courseRepeatCodeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return courseRepeatCodeDescriptorId
  **/
  ...
  public Integer getCourseRepeatCodeDescriptorId() {
    return courseRepeatCodeDescriptorId;
  }

  public void setCourseRepeatCodeDescriptorId(Integer courseRepeatCodeDescriptorId) {
    this.courseRepeatCodeDescriptorId = courseRepeatCodeDescriptorId;
  }

  public EdFiCourseRepeatCodeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCourseRepeatCodeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCourseRepeatCodeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCourseRepeatCodeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCourseRepeatCodeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCourseRepeatCodeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCourseRepeatCodeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCourseRepeatCodeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCourseRepeatCodeDescriptor edFiCourseRepeatCodeDescriptor = (EdFiCourseRepeatCodeDescriptor) o;
    return Objects.equals(this.id, edFiCourseRepeatCodeDescriptor.id) &&
        Objects.equals(this.courseRepeatCodeDescriptorId, edFiCourseRepeatCodeDescriptor.courseRepeatCodeDescriptorId) &&
        Objects.equals(this.codeValue, edFiCourseRepeatCodeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCourseRepeatCodeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCourseRepeatCodeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCourseRepeatCodeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCourseRepeatCodeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCourseRepeatCodeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCourseRepeatCodeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCourseRepeatCodeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, courseRepeatCodeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCourseRepeatCodeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    courseRepeatCodeDescriptorId: ").append(toIndentedString(courseRepeatCodeDescriptorId)).append("\n");
