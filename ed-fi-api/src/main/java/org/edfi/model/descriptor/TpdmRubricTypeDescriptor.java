...
/**
 * TpdmRubricTypeDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmRubricTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("rubricTypeDescriptorId")
  private Integer rubricTypeDescriptorId = null;
  ...
  public TpdmRubricTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmRubricTypeDescriptor rubricTypeDescriptorId(Integer rubricTypeDescriptorId) {
    this.rubricTypeDescriptorId = rubricTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return rubricTypeDescriptorId
  **/
  ...
  public Integer getRubricTypeDescriptorId() {
    return rubricTypeDescriptorId;
  }

  public void setRubricTypeDescriptorId(Integer rubricTypeDescriptorId) {
    this.rubricTypeDescriptorId = rubricTypeDescriptorId;
  }

  public TpdmRubricTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmRubricTypeDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmRubricTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmRubricTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmRubricTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmRubricTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmRubricTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmRubricTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmRubricTypeDescriptor tpdmRubricTypeDescriptor = (TpdmRubricTypeDescriptor) o;
    return Objects.equals(this.id, tpdmRubricTypeDescriptor.id) &&
        Objects.equals(this.rubricTypeDescriptorId, tpdmRubricTypeDescriptor.rubricTypeDescriptorId) &&
        Objects.equals(this.codeValue, tpdmRubricTypeDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmRubricTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmRubricTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmRubricTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmRubricTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmRubricTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmRubricTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmRubricTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, rubricTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmRubricTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    rubricTypeDescriptorId: ").append(toIndentedString(rubricTypeDescriptorId)).append("\n");
