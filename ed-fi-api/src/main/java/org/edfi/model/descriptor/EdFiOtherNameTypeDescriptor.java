...
public class EdFiOtherNameTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("otherNameTypeDescriptorId")
  private Integer otherNameTypeDescriptorId = null;
  ...
  public EdFiOtherNameTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiOtherNameTypeDescriptor otherNameTypeDescriptorId(Integer otherNameTypeDescriptorId) {
    this.otherNameTypeDescriptorId = otherNameTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return otherNameTypeDescriptorId
  **/
  ...
  public Integer getOtherNameTypeDescriptorId() {
    return otherNameTypeDescriptorId;
  }

  public void setOtherNameTypeDescriptorId(Integer otherNameTypeDescriptorId) {
    this.otherNameTypeDescriptorId = otherNameTypeDescriptorId;
  }

  public EdFiOtherNameTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiOtherNameTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiOtherNameTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiOtherNameTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiOtherNameTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiOtherNameTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiOtherNameTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiOtherNameTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiOtherNameTypeDescriptor edFiOtherNameTypeDescriptor = (EdFiOtherNameTypeDescriptor) o;
    return Objects.equals(this.id, edFiOtherNameTypeDescriptor.id) &&
        Objects.equals(this.otherNameTypeDescriptorId, edFiOtherNameTypeDescriptor.otherNameTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiOtherNameTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiOtherNameTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiOtherNameTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiOtherNameTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiOtherNameTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiOtherNameTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiOtherNameTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiOtherNameTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, otherNameTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiOtherNameTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    otherNameTypeDescriptorId: ").append(toIndentedString(otherNameTypeDescriptorId)).append("\n");
