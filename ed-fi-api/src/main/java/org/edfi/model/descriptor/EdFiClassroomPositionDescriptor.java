...
public class EdFiClassroomPositionDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("classroomPositionDescriptorId")
  private Integer classroomPositionDescriptorId = null;
  ...
  public EdFiClassroomPositionDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiClassroomPositionDescriptor classroomPositionDescriptorId(Integer classroomPositionDescriptorId) {
    this.classroomPositionDescriptorId = classroomPositionDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return classroomPositionDescriptorId
  **/
  ...
  public Integer getClassroomPositionDescriptorId() {
    return classroomPositionDescriptorId;
  }

  public void setClassroomPositionDescriptorId(Integer classroomPositionDescriptorId) {
    this.classroomPositionDescriptorId = classroomPositionDescriptorId;
  }

  public EdFiClassroomPositionDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiClassroomPositionDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiClassroomPositionDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiClassroomPositionDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiClassroomPositionDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiClassroomPositionDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiClassroomPositionDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiClassroomPositionDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiClassroomPositionDescriptor edFiClassroomPositionDescriptor = (EdFiClassroomPositionDescriptor) o;
    return Objects.equals(this.id, edFiClassroomPositionDescriptor.id) &&
        Objects.equals(this.classroomPositionDescriptorId, edFiClassroomPositionDescriptor.classroomPositionDescriptorId) &&
        Objects.equals(this.codeValue, edFiClassroomPositionDescriptor.codeValue) &&
        Objects.equals(this.description, edFiClassroomPositionDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiClassroomPositionDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiClassroomPositionDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiClassroomPositionDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiClassroomPositionDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiClassroomPositionDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiClassroomPositionDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, classroomPositionDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiClassroomPositionDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    classroomPositionDescriptorId: ").append(toIndentedString(classroomPositionDescriptorId)).append("\n");
