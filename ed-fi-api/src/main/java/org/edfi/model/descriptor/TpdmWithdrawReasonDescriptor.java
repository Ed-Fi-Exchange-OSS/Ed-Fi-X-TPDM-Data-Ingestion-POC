...
/**
 * TpdmWithdrawReasonDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmWithdrawReasonDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("withdrawReasonDescriptorId")
  private Integer withdrawReasonDescriptorId = null;
  ...
  public TpdmWithdrawReasonDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmWithdrawReasonDescriptor withdrawReasonDescriptorId(Integer withdrawReasonDescriptorId) {
    this.withdrawReasonDescriptorId = withdrawReasonDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return withdrawReasonDescriptorId
  **/
  ...
  public Integer getWithdrawReasonDescriptorId() {
    return withdrawReasonDescriptorId;
  }

  public void setWithdrawReasonDescriptorId(Integer withdrawReasonDescriptorId) {
    this.withdrawReasonDescriptorId = withdrawReasonDescriptorId;
  }

  public TpdmWithdrawReasonDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmWithdrawReasonDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmWithdrawReasonDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmWithdrawReasonDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmWithdrawReasonDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmWithdrawReasonDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmWithdrawReasonDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmWithdrawReasonDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmWithdrawReasonDescriptor tpdmWithdrawReasonDescriptor = (TpdmWithdrawReasonDescriptor) o;
    return Objects.equals(this.id, tpdmWithdrawReasonDescriptor.id) &&
        Objects.equals(this.withdrawReasonDescriptorId, tpdmWithdrawReasonDescriptor.withdrawReasonDescriptorId) &&
        Objects.equals(this.codeValue, tpdmWithdrawReasonDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmWithdrawReasonDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmWithdrawReasonDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmWithdrawReasonDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmWithdrawReasonDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmWithdrawReasonDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmWithdrawReasonDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmWithdrawReasonDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, withdrawReasonDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmWithdrawReasonDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    withdrawReasonDescriptorId: ").append(toIndentedString(withdrawReasonDescriptorId)).append("\n");
