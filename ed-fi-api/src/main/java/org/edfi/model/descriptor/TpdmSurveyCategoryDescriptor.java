...
/**
 * TpdmSurveyCategoryDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmSurveyCategoryDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("surveyCategoryDescriptorId")
  private Integer surveyCategoryDescriptorId = null;
  ...
  public TpdmSurveyCategoryDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmSurveyCategoryDescriptor surveyCategoryDescriptorId(Integer surveyCategoryDescriptorId) {
    this.surveyCategoryDescriptorId = surveyCategoryDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return surveyCategoryDescriptorId
  **/
  ...
  public Integer getSurveyCategoryDescriptorId() {
    return surveyCategoryDescriptorId;
  }

  public void setSurveyCategoryDescriptorId(Integer surveyCategoryDescriptorId) {
    this.surveyCategoryDescriptorId = surveyCategoryDescriptorId;
  }

  public TpdmSurveyCategoryDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmSurveyCategoryDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmSurveyCategoryDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmSurveyCategoryDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmSurveyCategoryDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmSurveyCategoryDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmSurveyCategoryDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmSurveyCategoryDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmSurveyCategoryDescriptor tpdmSurveyCategoryDescriptor = (TpdmSurveyCategoryDescriptor) o;
    return Objects.equals(this.id, tpdmSurveyCategoryDescriptor.id) &&
        Objects.equals(this.surveyCategoryDescriptorId, tpdmSurveyCategoryDescriptor.surveyCategoryDescriptorId) &&
        Objects.equals(this.codeValue, tpdmSurveyCategoryDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmSurveyCategoryDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmSurveyCategoryDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmSurveyCategoryDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmSurveyCategoryDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmSurveyCategoryDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmSurveyCategoryDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmSurveyCategoryDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, surveyCategoryDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmSurveyCategoryDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    surveyCategoryDescriptorId: ").append(toIndentedString(surveyCategoryDescriptorId)).append("\n");
