...
public class EdFiProgramAssignmentDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("programAssignmentDescriptorId")
  private Integer programAssignmentDescriptorId = null;
  ...
  public EdFiProgramAssignmentDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiProgramAssignmentDescriptor programAssignmentDescriptorId(Integer programAssignmentDescriptorId) {
    this.programAssignmentDescriptorId = programAssignmentDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return programAssignmentDescriptorId
  **/
  ...
  public Integer getProgramAssignmentDescriptorId() {
    return programAssignmentDescriptorId;
  }

  public void setProgramAssignmentDescriptorId(Integer programAssignmentDescriptorId) {
    this.programAssignmentDescriptorId = programAssignmentDescriptorId;
  }

  public EdFiProgramAssignmentDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiProgramAssignmentDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiProgramAssignmentDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiProgramAssignmentDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiProgramAssignmentDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiProgramAssignmentDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiProgramAssignmentDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiProgramAssignmentDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiProgramAssignmentDescriptor edFiProgramAssignmentDescriptor = (EdFiProgramAssignmentDescriptor) o;
    return Objects.equals(this.id, edFiProgramAssignmentDescriptor.id) &&
        Objects.equals(this.programAssignmentDescriptorId, edFiProgramAssignmentDescriptor.programAssignmentDescriptorId) &&
        Objects.equals(this.codeValue, edFiProgramAssignmentDescriptor.codeValue) &&
        Objects.equals(this.description, edFiProgramAssignmentDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiProgramAssignmentDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiProgramAssignmentDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiProgramAssignmentDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiProgramAssignmentDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiProgramAssignmentDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiProgramAssignmentDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, programAssignmentDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiProgramAssignmentDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    programAssignmentDescriptorId: ").append(toIndentedString(programAssignmentDescriptorId)).append("\n");
