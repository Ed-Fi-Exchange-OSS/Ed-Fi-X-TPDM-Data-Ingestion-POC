...
public class EdFiDeliveryMethodDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("deliveryMethodDescriptorId")
  private Integer deliveryMethodDescriptorId = null;
  ...
  public EdFiDeliveryMethodDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiDeliveryMethodDescriptor deliveryMethodDescriptorId(Integer deliveryMethodDescriptorId) {
    this.deliveryMethodDescriptorId = deliveryMethodDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return deliveryMethodDescriptorId
  **/
  ...
  public Integer getDeliveryMethodDescriptorId() {
    return deliveryMethodDescriptorId;
  }

  public void setDeliveryMethodDescriptorId(Integer deliveryMethodDescriptorId) {
    this.deliveryMethodDescriptorId = deliveryMethodDescriptorId;
  }

  public EdFiDeliveryMethodDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiDeliveryMethodDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiDeliveryMethodDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiDeliveryMethodDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiDeliveryMethodDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiDeliveryMethodDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiDeliveryMethodDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiDeliveryMethodDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiDeliveryMethodDescriptor edFiDeliveryMethodDescriptor = (EdFiDeliveryMethodDescriptor) o;
    return Objects.equals(this.id, edFiDeliveryMethodDescriptor.id) &&
        Objects.equals(this.deliveryMethodDescriptorId, edFiDeliveryMethodDescriptor.deliveryMethodDescriptorId) &&
        Objects.equals(this.codeValue, edFiDeliveryMethodDescriptor.codeValue) &&
        Objects.equals(this.description, edFiDeliveryMethodDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiDeliveryMethodDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiDeliveryMethodDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiDeliveryMethodDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiDeliveryMethodDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiDeliveryMethodDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiDeliveryMethodDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, deliveryMethodDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiDeliveryMethodDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    deliveryMethodDescriptorId: ").append(toIndentedString(deliveryMethodDescriptorId)).append("\n");
