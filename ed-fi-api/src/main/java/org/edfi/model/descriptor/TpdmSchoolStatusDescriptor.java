...
/**
 * TpdmSchoolStatusDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmSchoolStatusDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("schoolStatusDescriptorId")
  private Integer schoolStatusDescriptorId = null;
  ...
  public TpdmSchoolStatusDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmSchoolStatusDescriptor schoolStatusDescriptorId(Integer schoolStatusDescriptorId) {
    this.schoolStatusDescriptorId = schoolStatusDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return schoolStatusDescriptorId
  **/
  ...
  public Integer getSchoolStatusDescriptorId() {
    return schoolStatusDescriptorId;
  }

  public void setSchoolStatusDescriptorId(Integer schoolStatusDescriptorId) {
    this.schoolStatusDescriptorId = schoolStatusDescriptorId;
  }

  public TpdmSchoolStatusDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmSchoolStatusDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmSchoolStatusDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmSchoolStatusDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmSchoolStatusDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmSchoolStatusDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmSchoolStatusDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmSchoolStatusDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmSchoolStatusDescriptor tpdmSchoolStatusDescriptor = (TpdmSchoolStatusDescriptor) o;
    return Objects.equals(this.id, tpdmSchoolStatusDescriptor.id) &&
        Objects.equals(this.schoolStatusDescriptorId, tpdmSchoolStatusDescriptor.schoolStatusDescriptorId) &&
        Objects.equals(this.codeValue, tpdmSchoolStatusDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmSchoolStatusDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmSchoolStatusDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmSchoolStatusDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmSchoolStatusDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmSchoolStatusDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmSchoolStatusDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmSchoolStatusDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, schoolStatusDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmSchoolStatusDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    schoolStatusDescriptorId: ").append(toIndentedString(schoolStatusDescriptorId)).append("\n");
