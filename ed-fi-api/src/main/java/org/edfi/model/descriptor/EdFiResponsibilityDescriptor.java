...
public class EdFiResponsibilityDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("responsibilityDescriptorId")
  private Integer responsibilityDescriptorId = null;
  ...
  public EdFiResponsibilityDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiResponsibilityDescriptor responsibilityDescriptorId(Integer responsibilityDescriptorId) {
    this.responsibilityDescriptorId = responsibilityDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return responsibilityDescriptorId
  **/
  ...
  public Integer getResponsibilityDescriptorId() {
    return responsibilityDescriptorId;
  }

  public void setResponsibilityDescriptorId(Integer responsibilityDescriptorId) {
    this.responsibilityDescriptorId = responsibilityDescriptorId;
  }

  public EdFiResponsibilityDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiResponsibilityDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiResponsibilityDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiResponsibilityDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiResponsibilityDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiResponsibilityDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiResponsibilityDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiResponsibilityDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiResponsibilityDescriptor edFiResponsibilityDescriptor = (EdFiResponsibilityDescriptor) o;
    return Objects.equals(this.id, edFiResponsibilityDescriptor.id) &&
        Objects.equals(this.responsibilityDescriptorId, edFiResponsibilityDescriptor.responsibilityDescriptorId) &&
        Objects.equals(this.codeValue, edFiResponsibilityDescriptor.codeValue) &&
        Objects.equals(this.description, edFiResponsibilityDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiResponsibilityDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiResponsibilityDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiResponsibilityDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiResponsibilityDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiResponsibilityDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiResponsibilityDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, responsibilityDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiResponsibilityDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    responsibilityDescriptorId: ").append(toIndentedString(responsibilityDescriptorId)).append("\n");
