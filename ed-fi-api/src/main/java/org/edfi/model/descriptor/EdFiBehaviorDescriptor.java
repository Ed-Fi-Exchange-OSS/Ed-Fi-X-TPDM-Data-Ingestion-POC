...
public class EdFiBehaviorDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("behaviorDescriptorId")
  private Integer behaviorDescriptorId = null;
  ...
  public EdFiBehaviorDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiBehaviorDescriptor behaviorDescriptorId(Integer behaviorDescriptorId) {
    this.behaviorDescriptorId = behaviorDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return behaviorDescriptorId
  **/
  ...
  public Integer getBehaviorDescriptorId() {
    return behaviorDescriptorId;
  }

  public void setBehaviorDescriptorId(Integer behaviorDescriptorId) {
    this.behaviorDescriptorId = behaviorDescriptorId;
  }

  public EdFiBehaviorDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiBehaviorDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiBehaviorDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiBehaviorDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiBehaviorDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiBehaviorDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiBehaviorDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiBehaviorDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiBehaviorDescriptor edFiBehaviorDescriptor = (EdFiBehaviorDescriptor) o;
    return Objects.equals(this.id, edFiBehaviorDescriptor.id) &&
        Objects.equals(this.behaviorDescriptorId, edFiBehaviorDescriptor.behaviorDescriptorId) &&
        Objects.equals(this.codeValue, edFiBehaviorDescriptor.codeValue) &&
        Objects.equals(this.description, edFiBehaviorDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiBehaviorDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiBehaviorDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiBehaviorDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiBehaviorDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiBehaviorDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiBehaviorDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, behaviorDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiBehaviorDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    behaviorDescriptorId: ").append(toIndentedString(behaviorDescriptorId)).append("\n");
