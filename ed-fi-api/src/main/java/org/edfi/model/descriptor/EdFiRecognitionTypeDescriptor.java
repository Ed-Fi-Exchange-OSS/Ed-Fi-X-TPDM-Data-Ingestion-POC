...
public class EdFiRecognitionTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("recognitionTypeDescriptorId")
  private Integer recognitionTypeDescriptorId = null;
  ...
  public EdFiRecognitionTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiRecognitionTypeDescriptor recognitionTypeDescriptorId(Integer recognitionTypeDescriptorId) {
    this.recognitionTypeDescriptorId = recognitionTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return recognitionTypeDescriptorId
  **/
  ...
  public Integer getRecognitionTypeDescriptorId() {
    return recognitionTypeDescriptorId;
  }

  public void setRecognitionTypeDescriptorId(Integer recognitionTypeDescriptorId) {
    this.recognitionTypeDescriptorId = recognitionTypeDescriptorId;
  }

  public EdFiRecognitionTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiRecognitionTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiRecognitionTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiRecognitionTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiRecognitionTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiRecognitionTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiRecognitionTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiRecognitionTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiRecognitionTypeDescriptor edFiRecognitionTypeDescriptor = (EdFiRecognitionTypeDescriptor) o;
    return Objects.equals(this.id, edFiRecognitionTypeDescriptor.id) &&
        Objects.equals(this.recognitionTypeDescriptorId, edFiRecognitionTypeDescriptor.recognitionTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiRecognitionTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiRecognitionTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiRecognitionTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiRecognitionTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiRecognitionTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiRecognitionTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiRecognitionTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiRecognitionTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, recognitionTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiRecognitionTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    recognitionTypeDescriptorId: ").append(toIndentedString(recognitionTypeDescriptorId)).append("\n");
