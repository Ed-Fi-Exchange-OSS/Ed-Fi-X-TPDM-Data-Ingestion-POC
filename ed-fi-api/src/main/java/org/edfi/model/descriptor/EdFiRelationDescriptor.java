...
public class EdFiRelationDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("relationDescriptorId")
  private Integer relationDescriptorId = null;
  ...
  public EdFiRelationDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiRelationDescriptor relationDescriptorId(Integer relationDescriptorId) {
  ...
  **/
  ...
  public Integer getRelationDescriptorId() {
    return relationDescriptorId;
  }

  public void setRelationDescriptorId(Integer relationDescriptorId) {
    this.relationDescriptorId = relationDescriptorId;
  }

  public EdFiRelationDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiRelationDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiRelationDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiRelationDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiRelationDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiRelationDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiRelationDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiRelationDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiRelationDescriptor edFiRelationDescriptor = (EdFiRelationDescriptor) o;
    return Objects.equals(this.id, edFiRelationDescriptor.id) &&
        Objects.equals(this.relationDescriptorId, edFiRelationDescriptor.relationDescriptorId) &&
        Objects.equals(this.codeValue, edFiRelationDescriptor.codeValue) &&
        Objects.equals(this.description, edFiRelationDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiRelationDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiRelationDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiRelationDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiRelationDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiRelationDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiRelationDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, relationDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }
  ...
  public String toString() {
    ...
    sb.append("    relationDescriptorId: ").append(toIndentedString(relationDescriptorId)).append("\n");
