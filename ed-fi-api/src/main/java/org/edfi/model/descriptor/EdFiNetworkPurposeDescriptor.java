...
public class EdFiNetworkPurposeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("networkPurposeDescriptorId")
  private Integer networkPurposeDescriptorId = null;
  ...
  public EdFiNetworkPurposeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiNetworkPurposeDescriptor networkPurposeDescriptorId(Integer networkPurposeDescriptorId) {
    this.networkPurposeDescriptorId = networkPurposeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return networkPurposeDescriptorId
  **/
  ...
  public Integer getNetworkPurposeDescriptorId() {
    return networkPurposeDescriptorId;
  }

  public void setNetworkPurposeDescriptorId(Integer networkPurposeDescriptorId) {
    this.networkPurposeDescriptorId = networkPurposeDescriptorId;
  }

  public EdFiNetworkPurposeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiNetworkPurposeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiNetworkPurposeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiNetworkPurposeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiNetworkPurposeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiNetworkPurposeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiNetworkPurposeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiNetworkPurposeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiNetworkPurposeDescriptor edFiNetworkPurposeDescriptor = (EdFiNetworkPurposeDescriptor) o;
    return Objects.equals(this.id, edFiNetworkPurposeDescriptor.id) &&
        Objects.equals(this.networkPurposeDescriptorId, edFiNetworkPurposeDescriptor.networkPurposeDescriptorId) &&
        Objects.equals(this.codeValue, edFiNetworkPurposeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiNetworkPurposeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiNetworkPurposeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiNetworkPurposeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiNetworkPurposeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiNetworkPurposeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiNetworkPurposeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiNetworkPurposeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, networkPurposeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiNetworkPurposeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    networkPurposeDescriptorId: ").append(toIndentedString(networkPurposeDescriptorId)).append("\n");
