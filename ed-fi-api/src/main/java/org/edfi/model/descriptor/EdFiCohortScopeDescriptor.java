...
public class EdFiCohortScopeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("cohortScopeDescriptorId")
  private Integer cohortScopeDescriptorId = null;
  ...
  public EdFiCohortScopeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCohortScopeDescriptor cohortScopeDescriptorId(Integer cohortScopeDescriptorId) {
    this.cohortScopeDescriptorId = cohortScopeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return cohortScopeDescriptorId
  **/
  ...
  public Integer getCohortScopeDescriptorId() {
    return cohortScopeDescriptorId;
  }

  public void setCohortScopeDescriptorId(Integer cohortScopeDescriptorId) {
    this.cohortScopeDescriptorId = cohortScopeDescriptorId;
  }

  public EdFiCohortScopeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCohortScopeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCohortScopeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCohortScopeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCohortScopeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCohortScopeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCohortScopeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCohortScopeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCohortScopeDescriptor edFiCohortScopeDescriptor = (EdFiCohortScopeDescriptor) o;
    return Objects.equals(this.id, edFiCohortScopeDescriptor.id) &&
        Objects.equals(this.cohortScopeDescriptorId, edFiCohortScopeDescriptor.cohortScopeDescriptorId) &&
        Objects.equals(this.codeValue, edFiCohortScopeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCohortScopeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCohortScopeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCohortScopeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCohortScopeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCohortScopeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCohortScopeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCohortScopeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, cohortScopeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCohortScopeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    cohortScopeDescriptorId: ").append(toIndentedString(cohortScopeDescriptorId)).append("\n");
