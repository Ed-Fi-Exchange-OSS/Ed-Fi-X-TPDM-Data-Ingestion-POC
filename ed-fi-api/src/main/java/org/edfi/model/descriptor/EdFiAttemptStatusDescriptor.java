...
public class EdFiAttemptStatusDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("attemptStatusDescriptorId")
  private Integer attemptStatusDescriptorId = null;
  ...
  public EdFiAttemptStatusDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiAttemptStatusDescriptor attemptStatusDescriptorId(Integer attemptStatusDescriptorId) {
    this.attemptStatusDescriptorId = attemptStatusDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return attemptStatusDescriptorId
  **/
  ...
  public Integer getAttemptStatusDescriptorId() {
    return attemptStatusDescriptorId;
  }

  public void setAttemptStatusDescriptorId(Integer attemptStatusDescriptorId) {
    this.attemptStatusDescriptorId = attemptStatusDescriptorId;
  }

  public EdFiAttemptStatusDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiAttemptStatusDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiAttemptStatusDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiAttemptStatusDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiAttemptStatusDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiAttemptStatusDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiAttemptStatusDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiAttemptStatusDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiAttemptStatusDescriptor edFiAttemptStatusDescriptor = (EdFiAttemptStatusDescriptor) o;
    return Objects.equals(this.id, edFiAttemptStatusDescriptor.id) &&
        Objects.equals(this.attemptStatusDescriptorId, edFiAttemptStatusDescriptor.attemptStatusDescriptorId) &&
        Objects.equals(this.codeValue, edFiAttemptStatusDescriptor.codeValue) &&
        Objects.equals(this.description, edFiAttemptStatusDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiAttemptStatusDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiAttemptStatusDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiAttemptStatusDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiAttemptStatusDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiAttemptStatusDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiAttemptStatusDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, attemptStatusDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiAttemptStatusDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    attemptStatusDescriptorId: ").append(toIndentedString(attemptStatusDescriptorId)).append("\n");
