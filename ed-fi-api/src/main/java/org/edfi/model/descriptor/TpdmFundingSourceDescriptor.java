...
/**
 * TpdmFundingSourceDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmFundingSourceDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("fundingSourceDescriptorId")
  private Integer fundingSourceDescriptorId = null;
  ...
  public TpdmFundingSourceDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmFundingSourceDescriptor fundingSourceDescriptorId(Integer fundingSourceDescriptorId) {
    this.fundingSourceDescriptorId = fundingSourceDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return fundingSourceDescriptorId
  **/
  ...
  public Integer getFundingSourceDescriptorId() {
    return fundingSourceDescriptorId;
  }

  public void setFundingSourceDescriptorId(Integer fundingSourceDescriptorId) {
    this.fundingSourceDescriptorId = fundingSourceDescriptorId;
  }

  public TpdmFundingSourceDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmFundingSourceDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmFundingSourceDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmFundingSourceDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmFundingSourceDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmFundingSourceDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmFundingSourceDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmFundingSourceDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmFundingSourceDescriptor tpdmFundingSourceDescriptor = (TpdmFundingSourceDescriptor) o;
    return Objects.equals(this.id, tpdmFundingSourceDescriptor.id) &&
        Objects.equals(this.fundingSourceDescriptorId, tpdmFundingSourceDescriptor.fundingSourceDescriptorId) &&
        Objects.equals(this.codeValue, tpdmFundingSourceDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmFundingSourceDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmFundingSourceDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmFundingSourceDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmFundingSourceDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmFundingSourceDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmFundingSourceDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmFundingSourceDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, fundingSourceDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmFundingSourceDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    fundingSourceDescriptorId: ").append(toIndentedString(fundingSourceDescriptorId)).append("\n");
