...
public class EdFiTermDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("termDescriptorId")
  private Integer termDescriptorId = null;
  ...
  public EdFiTermDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiTermDescriptor termDescriptorId(Integer termDescriptorId) {
    this.termDescriptorId = termDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return termDescriptorId
  **/
  ...
  public Integer getTermDescriptorId() {
    return termDescriptorId;
  }

  public void setTermDescriptorId(Integer termDescriptorId) {
    this.termDescriptorId = termDescriptorId;
  }

  public EdFiTermDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiTermDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiTermDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiTermDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiTermDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiTermDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiTermDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiTermDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiTermDescriptor edFiTermDescriptor = (EdFiTermDescriptor) o;
    return Objects.equals(this.id, edFiTermDescriptor.id) &&
        Objects.equals(this.termDescriptorId, edFiTermDescriptor.termDescriptorId) &&
        Objects.equals(this.codeValue, edFiTermDescriptor.codeValue) &&
        Objects.equals(this.description, edFiTermDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiTermDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiTermDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiTermDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiTermDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiTermDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiTermDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, termDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiTermDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    termDescriptorId: ").append(toIndentedString(termDescriptorId)).append("\n");
