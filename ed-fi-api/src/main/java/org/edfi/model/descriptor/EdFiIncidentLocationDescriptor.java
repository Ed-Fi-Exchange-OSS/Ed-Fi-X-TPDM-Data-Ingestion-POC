...
public class EdFiIncidentLocationDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("incidentLocationDescriptorId")
  private Integer incidentLocationDescriptorId = null;
  ...
  public EdFiIncidentLocationDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiIncidentLocationDescriptor incidentLocationDescriptorId(Integer incidentLocationDescriptorId) {
    this.incidentLocationDescriptorId = incidentLocationDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return incidentLocationDescriptorId
  **/
  ...
  public Integer getIncidentLocationDescriptorId() {
    return incidentLocationDescriptorId;
  }

  public void setIncidentLocationDescriptorId(Integer incidentLocationDescriptorId) {
    this.incidentLocationDescriptorId = incidentLocationDescriptorId;
  }

  public EdFiIncidentLocationDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiIncidentLocationDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiIncidentLocationDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiIncidentLocationDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiIncidentLocationDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiIncidentLocationDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiIncidentLocationDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiIncidentLocationDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiIncidentLocationDescriptor edFiIncidentLocationDescriptor = (EdFiIncidentLocationDescriptor) o;
    return Objects.equals(this.id, edFiIncidentLocationDescriptor.id) &&
        Objects.equals(this.incidentLocationDescriptorId, edFiIncidentLocationDescriptor.incidentLocationDescriptorId) &&
        Objects.equals(this.codeValue, edFiIncidentLocationDescriptor.codeValue) &&
        Objects.equals(this.description, edFiIncidentLocationDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiIncidentLocationDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiIncidentLocationDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiIncidentLocationDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiIncidentLocationDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiIncidentLocationDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiIncidentLocationDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, incidentLocationDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiIncidentLocationDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    incidentLocationDescriptorId: ").append(toIndentedString(incidentLocationDescriptorId)).append("\n");
