...
public class EdFiSchoolCategoryDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("schoolCategoryDescriptorId")
  private Integer schoolCategoryDescriptorId = null;
  ...
  public EdFiSchoolCategoryDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiSchoolCategoryDescriptor schoolCategoryDescriptorId(Integer schoolCategoryDescriptorId) {
    this.schoolCategoryDescriptorId = schoolCategoryDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return schoolCategoryDescriptorId
  **/
  ...
  public Integer getSchoolCategoryDescriptorId() {
    return schoolCategoryDescriptorId;
  }

  public void setSchoolCategoryDescriptorId(Integer schoolCategoryDescriptorId) {
    this.schoolCategoryDescriptorId = schoolCategoryDescriptorId;
  }

  public EdFiSchoolCategoryDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiSchoolCategoryDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiSchoolCategoryDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiSchoolCategoryDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiSchoolCategoryDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiSchoolCategoryDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiSchoolCategoryDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiSchoolCategoryDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiSchoolCategoryDescriptor edFiSchoolCategoryDescriptor = (EdFiSchoolCategoryDescriptor) o;
    return Objects.equals(this.id, edFiSchoolCategoryDescriptor.id) &&
        Objects.equals(this.schoolCategoryDescriptorId, edFiSchoolCategoryDescriptor.schoolCategoryDescriptorId) &&
        Objects.equals(this.codeValue, edFiSchoolCategoryDescriptor.codeValue) &&
        Objects.equals(this.description, edFiSchoolCategoryDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiSchoolCategoryDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiSchoolCategoryDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiSchoolCategoryDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiSchoolCategoryDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiSchoolCategoryDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiSchoolCategoryDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, schoolCategoryDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiSchoolCategoryDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    schoolCategoryDescriptorId: ").append(toIndentedString(schoolCategoryDescriptorId)).append("\n");
