...
public class EdFiVisaDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("visaDescriptorId")
  private Integer visaDescriptorId = null;
  ...
  public EdFiVisaDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiVisaDescriptor visaDescriptorId(Integer visaDescriptorId) {
    this.visaDescriptorId = visaDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return visaDescriptorId
  **/
  ...
  public Integer getVisaDescriptorId() {
    return visaDescriptorId;
  }

  public void setVisaDescriptorId(Integer visaDescriptorId) {
    this.visaDescriptorId = visaDescriptorId;
  }

  public EdFiVisaDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiVisaDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiVisaDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiVisaDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiVisaDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiVisaDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiVisaDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiVisaDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiVisaDescriptor edFiVisaDescriptor = (EdFiVisaDescriptor) o;
    return Objects.equals(this.id, edFiVisaDescriptor.id) &&
        Objects.equals(this.visaDescriptorId, edFiVisaDescriptor.visaDescriptorId) &&
        Objects.equals(this.codeValue, edFiVisaDescriptor.codeValue) &&
        Objects.equals(this.description, edFiVisaDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiVisaDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiVisaDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiVisaDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiVisaDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiVisaDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiVisaDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, visaDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiVisaDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    visaDescriptorId: ").append(toIndentedString(visaDescriptorId)).append("\n");
