...
/**
 * TpdmFieldworkTypeDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmFieldworkTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("fieldworkTypeDescriptorId")
  private Integer fieldworkTypeDescriptorId = null;
  ...
  public TpdmFieldworkTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmFieldworkTypeDescriptor fieldworkTypeDescriptorId(Integer fieldworkTypeDescriptorId) {
    this.fieldworkTypeDescriptorId = fieldworkTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return fieldworkTypeDescriptorId
  **/
  ...
  public Integer getFieldworkTypeDescriptorId() {
    return fieldworkTypeDescriptorId;
  }

  public void setFieldworkTypeDescriptorId(Integer fieldworkTypeDescriptorId) {
    this.fieldworkTypeDescriptorId = fieldworkTypeDescriptorId;
  }

  public TpdmFieldworkTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmFieldworkTypeDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmFieldworkTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmFieldworkTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmFieldworkTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmFieldworkTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmFieldworkTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmFieldworkTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmFieldworkTypeDescriptor tpdmFieldworkTypeDescriptor = (TpdmFieldworkTypeDescriptor) o;
    return Objects.equals(this.id, tpdmFieldworkTypeDescriptor.id) &&
        Objects.equals(this.fieldworkTypeDescriptorId, tpdmFieldworkTypeDescriptor.fieldworkTypeDescriptorId) &&
        Objects.equals(this.codeValue, tpdmFieldworkTypeDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmFieldworkTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmFieldworkTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmFieldworkTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmFieldworkTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmFieldworkTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmFieldworkTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmFieldworkTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, fieldworkTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmFieldworkTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    fieldworkTypeDescriptorId: ").append(toIndentedString(fieldworkTypeDescriptorId)).append("\n");
