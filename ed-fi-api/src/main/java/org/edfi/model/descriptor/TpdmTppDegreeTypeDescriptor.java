...
/**
 * TpdmTppDegreeTypeDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmTppDegreeTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("tppDegreeTypeDescriptorId")
  private Integer tppDegreeTypeDescriptorId = null;
  ...
  public TpdmTppDegreeTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmTppDegreeTypeDescriptor tppDegreeTypeDescriptorId(Integer tppDegreeTypeDescriptorId) {
    this.tppDegreeTypeDescriptorId = tppDegreeTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return tppDegreeTypeDescriptorId
  **/
  ...
  public Integer getTppDegreeTypeDescriptorId() {
    return tppDegreeTypeDescriptorId;
  }

  public void setTppDegreeTypeDescriptorId(Integer tppDegreeTypeDescriptorId) {
    this.tppDegreeTypeDescriptorId = tppDegreeTypeDescriptorId;
  }

  public TpdmTppDegreeTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmTppDegreeTypeDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmTppDegreeTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmTppDegreeTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmTppDegreeTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmTppDegreeTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmTppDegreeTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmTppDegreeTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmTppDegreeTypeDescriptor tpdmTppDegreeTypeDescriptor = (TpdmTppDegreeTypeDescriptor) o;
    return Objects.equals(this.id, tpdmTppDegreeTypeDescriptor.id) &&
        Objects.equals(this.tppDegreeTypeDescriptorId, tpdmTppDegreeTypeDescriptor.tppDegreeTypeDescriptorId) &&
        Objects.equals(this.codeValue, tpdmTppDegreeTypeDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmTppDegreeTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmTppDegreeTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmTppDegreeTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmTppDegreeTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmTppDegreeTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmTppDegreeTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmTppDegreeTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tppDegreeTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmTppDegreeTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    tppDegreeTypeDescriptorId: ").append(toIndentedString(tppDegreeTypeDescriptorId)).append("\n");
