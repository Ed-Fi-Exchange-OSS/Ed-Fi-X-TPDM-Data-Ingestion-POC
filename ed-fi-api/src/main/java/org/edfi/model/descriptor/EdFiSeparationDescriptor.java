...
public class EdFiSeparationDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("separationDescriptorId")
  private Integer separationDescriptorId = null;
  ...
  public EdFiSeparationDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiSeparationDescriptor separationDescriptorId(Integer separationDescriptorId) {
    this.separationDescriptorId = separationDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return separationDescriptorId
  **/
  ...
  public Integer getSeparationDescriptorId() {
    return separationDescriptorId;
  }

  public void setSeparationDescriptorId(Integer separationDescriptorId) {
    this.separationDescriptorId = separationDescriptorId;
  }

  public EdFiSeparationDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiSeparationDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiSeparationDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiSeparationDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiSeparationDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiSeparationDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiSeparationDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiSeparationDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiSeparationDescriptor edFiSeparationDescriptor = (EdFiSeparationDescriptor) o;
    return Objects.equals(this.id, edFiSeparationDescriptor.id) &&
        Objects.equals(this.separationDescriptorId, edFiSeparationDescriptor.separationDescriptorId) &&
        Objects.equals(this.codeValue, edFiSeparationDescriptor.codeValue) &&
        Objects.equals(this.description, edFiSeparationDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiSeparationDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiSeparationDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiSeparationDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiSeparationDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiSeparationDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiSeparationDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, separationDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiSeparationDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    separationDescriptorId: ").append(toIndentedString(separationDescriptorId)).append("\n");
