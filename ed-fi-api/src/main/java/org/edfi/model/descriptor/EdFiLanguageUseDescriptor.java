...
public class EdFiLanguageUseDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("languageUseDescriptorId")
  private Integer languageUseDescriptorId = null;
  ...
  public EdFiLanguageUseDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiLanguageUseDescriptor languageUseDescriptorId(Integer languageUseDescriptorId) {
    this.languageUseDescriptorId = languageUseDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return languageUseDescriptorId
  **/
  ...
  public Integer getLanguageUseDescriptorId() {
    return languageUseDescriptorId;
  }

  public void setLanguageUseDescriptorId(Integer languageUseDescriptorId) {
    this.languageUseDescriptorId = languageUseDescriptorId;
  }

  public EdFiLanguageUseDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiLanguageUseDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiLanguageUseDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiLanguageUseDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiLanguageUseDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiLanguageUseDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiLanguageUseDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiLanguageUseDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiLanguageUseDescriptor edFiLanguageUseDescriptor = (EdFiLanguageUseDescriptor) o;
    return Objects.equals(this.id, edFiLanguageUseDescriptor.id) &&
        Objects.equals(this.languageUseDescriptorId, edFiLanguageUseDescriptor.languageUseDescriptorId) &&
        Objects.equals(this.codeValue, edFiLanguageUseDescriptor.codeValue) &&
        Objects.equals(this.description, edFiLanguageUseDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiLanguageUseDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiLanguageUseDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiLanguageUseDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiLanguageUseDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiLanguageUseDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiLanguageUseDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, languageUseDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiLanguageUseDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    languageUseDescriptorId: ").append(toIndentedString(languageUseDescriptorId)).append("\n");
