...
public class EdFiDiagnosisDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("diagnosisDescriptorId")
  private Integer diagnosisDescriptorId = null;
  ...
  public EdFiDiagnosisDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiDiagnosisDescriptor diagnosisDescriptorId(Integer diagnosisDescriptorId) {
    this.diagnosisDescriptorId = diagnosisDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return diagnosisDescriptorId
  **/
  ...
  public Integer getDiagnosisDescriptorId() {
    return diagnosisDescriptorId;
  }

  public void setDiagnosisDescriptorId(Integer diagnosisDescriptorId) {
    this.diagnosisDescriptorId = diagnosisDescriptorId;
  }

  public EdFiDiagnosisDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiDiagnosisDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiDiagnosisDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiDiagnosisDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiDiagnosisDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiDiagnosisDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiDiagnosisDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiDiagnosisDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiDiagnosisDescriptor edFiDiagnosisDescriptor = (EdFiDiagnosisDescriptor) o;
    return Objects.equals(this.id, edFiDiagnosisDescriptor.id) &&
        Objects.equals(this.diagnosisDescriptorId, edFiDiagnosisDescriptor.diagnosisDescriptorId) &&
        Objects.equals(this.codeValue, edFiDiagnosisDescriptor.codeValue) &&
        Objects.equals(this.description, edFiDiagnosisDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiDiagnosisDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiDiagnosisDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiDiagnosisDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiDiagnosisDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiDiagnosisDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiDiagnosisDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, diagnosisDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiDiagnosisDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    diagnosisDescriptorId: ").append(toIndentedString(diagnosisDescriptorId)).append("\n");
