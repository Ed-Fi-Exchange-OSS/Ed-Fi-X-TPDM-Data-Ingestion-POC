...
public class EdFiCalendarTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("calendarTypeDescriptorId")
  private Integer calendarTypeDescriptorId = null;
  ...
  public EdFiCalendarTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCalendarTypeDescriptor calendarTypeDescriptorId(Integer calendarTypeDescriptorId) {
    this.calendarTypeDescriptorId = calendarTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return calendarTypeDescriptorId
  **/
  ...
  public Integer getCalendarTypeDescriptorId() {
    return calendarTypeDescriptorId;
  }

  public void setCalendarTypeDescriptorId(Integer calendarTypeDescriptorId) {
    this.calendarTypeDescriptorId = calendarTypeDescriptorId;
  }

  public EdFiCalendarTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCalendarTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCalendarTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCalendarTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCalendarTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCalendarTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCalendarTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCalendarTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCalendarTypeDescriptor edFiCalendarTypeDescriptor = (EdFiCalendarTypeDescriptor) o;
    return Objects.equals(this.id, edFiCalendarTypeDescriptor.id) &&
        Objects.equals(this.calendarTypeDescriptorId, edFiCalendarTypeDescriptor.calendarTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiCalendarTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCalendarTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCalendarTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCalendarTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCalendarTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCalendarTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCalendarTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCalendarTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, calendarTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCalendarTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    calendarTypeDescriptorId: ").append(toIndentedString(calendarTypeDescriptorId)).append("\n");
