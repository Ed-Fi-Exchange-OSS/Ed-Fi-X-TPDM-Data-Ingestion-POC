...
/**
 * TpdmProspectTypeDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmProspectTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("prospectTypeDescriptorId")
  private Integer prospectTypeDescriptorId = null;
  ...
  public TpdmProspectTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmProspectTypeDescriptor prospectTypeDescriptorId(Integer prospectTypeDescriptorId) {
    this.prospectTypeDescriptorId = prospectTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return prospectTypeDescriptorId
  **/
  ...
  public Integer getProspectTypeDescriptorId() {
    return prospectTypeDescriptorId;
  }

  public void setProspectTypeDescriptorId(Integer prospectTypeDescriptorId) {
    this.prospectTypeDescriptorId = prospectTypeDescriptorId;
  }

  public TpdmProspectTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmProspectTypeDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmProspectTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmProspectTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmProspectTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmProspectTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmProspectTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmProspectTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmProspectTypeDescriptor tpdmProspectTypeDescriptor = (TpdmProspectTypeDescriptor) o;
    return Objects.equals(this.id, tpdmProspectTypeDescriptor.id) &&
        Objects.equals(this.prospectTypeDescriptorId, tpdmProspectTypeDescriptor.prospectTypeDescriptorId) &&
        Objects.equals(this.codeValue, tpdmProspectTypeDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmProspectTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmProspectTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmProspectTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmProspectTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmProspectTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmProspectTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmProspectTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, prospectTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmProspectTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    prospectTypeDescriptorId: ").append(toIndentedString(prospectTypeDescriptorId)).append("\n");
