...
public class EdFiCohortYearTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("cohortYearTypeDescriptorId")
  private Integer cohortYearTypeDescriptorId = null;
  ...
  public EdFiCohortYearTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCohortYearTypeDescriptor cohortYearTypeDescriptorId(Integer cohortYearTypeDescriptorId) {
    this.cohortYearTypeDescriptorId = cohortYearTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return cohortYearTypeDescriptorId
  **/
  ...
  public Integer getCohortYearTypeDescriptorId() {
    return cohortYearTypeDescriptorId;
  }

  public void setCohortYearTypeDescriptorId(Integer cohortYearTypeDescriptorId) {
    this.cohortYearTypeDescriptorId = cohortYearTypeDescriptorId;
  }

  public EdFiCohortYearTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCohortYearTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCohortYearTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCohortYearTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCohortYearTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCohortYearTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCohortYearTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCohortYearTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCohortYearTypeDescriptor edFiCohortYearTypeDescriptor = (EdFiCohortYearTypeDescriptor) o;
    return Objects.equals(this.id, edFiCohortYearTypeDescriptor.id) &&
        Objects.equals(this.cohortYearTypeDescriptorId, edFiCohortYearTypeDescriptor.cohortYearTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiCohortYearTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCohortYearTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCohortYearTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCohortYearTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCohortYearTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCohortYearTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCohortYearTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCohortYearTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, cohortYearTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCohortYearTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    cohortYearTypeDescriptorId: ").append(toIndentedString(cohortYearTypeDescriptorId)).append("\n");
