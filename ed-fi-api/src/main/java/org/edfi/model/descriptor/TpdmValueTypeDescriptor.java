...
/**
 * TpdmValueTypeDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmValueTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("valueTypeDescriptorId")
  private Integer valueTypeDescriptorId = null;
  ...
  public TpdmValueTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmValueTypeDescriptor valueTypeDescriptorId(Integer valueTypeDescriptorId) {
    this.valueTypeDescriptorId = valueTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return valueTypeDescriptorId
  **/
  ...
  public Integer getValueTypeDescriptorId() {
    return valueTypeDescriptorId;
  }

  public void setValueTypeDescriptorId(Integer valueTypeDescriptorId) {
    this.valueTypeDescriptorId = valueTypeDescriptorId;
  }

  public TpdmValueTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmValueTypeDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmValueTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmValueTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmValueTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmValueTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmValueTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmValueTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmValueTypeDescriptor tpdmValueTypeDescriptor = (TpdmValueTypeDescriptor) o;
    return Objects.equals(this.id, tpdmValueTypeDescriptor.id) &&
        Objects.equals(this.valueTypeDescriptorId, tpdmValueTypeDescriptor.valueTypeDescriptorId) &&
        Objects.equals(this.codeValue, tpdmValueTypeDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmValueTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmValueTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmValueTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmValueTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmValueTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmValueTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmValueTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, valueTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmValueTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    valueTypeDescriptorId: ").append(toIndentedString(valueTypeDescriptorId)).append("\n");
