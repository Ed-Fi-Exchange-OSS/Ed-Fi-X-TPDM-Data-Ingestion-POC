...
public class TpdmThemeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("themeDescriptorId")
  private Integer themeDescriptorId = null;
  ...
  public TpdmThemeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmThemeDescriptor themeDescriptorId(Integer themeDescriptorId) {
  ...
  **/
  ...
  public Integer getThemeDescriptorId() {
    return themeDescriptorId;
  }

  public void setThemeDescriptorId(Integer themeDescriptorId) {
    this.themeDescriptorId = themeDescriptorId;
  }

  public TpdmThemeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmThemeDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmThemeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmThemeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmThemeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmThemeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmThemeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmThemeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmThemeDescriptor tpdmThemeDescriptor = (TpdmThemeDescriptor) o;
    return Objects.equals(this.id, tpdmThemeDescriptor.id) &&
        Objects.equals(this.themeDescriptorId, tpdmThemeDescriptor.themeDescriptorId) &&
        Objects.equals(this.codeValue, tpdmThemeDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmThemeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmThemeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmThemeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmThemeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmThemeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmThemeDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmThemeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, themeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmThemeDescriptor {\n");
