...
public class EdFiCreditTypeDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("creditTypeDescriptorId")
  private Integer creditTypeDescriptorId = null;
  ...
  public EdFiCreditTypeDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiCreditTypeDescriptor creditTypeDescriptorId(Integer creditTypeDescriptorId) {
    this.creditTypeDescriptorId = creditTypeDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return creditTypeDescriptorId
  **/
  ...
  public Integer getCreditTypeDescriptorId() {
    return creditTypeDescriptorId;
  }

  public void setCreditTypeDescriptorId(Integer creditTypeDescriptorId) {
    this.creditTypeDescriptorId = creditTypeDescriptorId;
  }

  public EdFiCreditTypeDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiCreditTypeDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiCreditTypeDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiCreditTypeDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiCreditTypeDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiCreditTypeDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiCreditTypeDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiCreditTypeDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiCreditTypeDescriptor edFiCreditTypeDescriptor = (EdFiCreditTypeDescriptor) o;
    return Objects.equals(this.id, edFiCreditTypeDescriptor.id) &&
        Objects.equals(this.creditTypeDescriptorId, edFiCreditTypeDescriptor.creditTypeDescriptorId) &&
        Objects.equals(this.codeValue, edFiCreditTypeDescriptor.codeValue) &&
        Objects.equals(this.description, edFiCreditTypeDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiCreditTypeDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiCreditTypeDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiCreditTypeDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiCreditTypeDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiCreditTypeDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiCreditTypeDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, creditTypeDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiCreditTypeDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    creditTypeDescriptorId: ").append(toIndentedString(creditTypeDescriptorId)).append("\n");
