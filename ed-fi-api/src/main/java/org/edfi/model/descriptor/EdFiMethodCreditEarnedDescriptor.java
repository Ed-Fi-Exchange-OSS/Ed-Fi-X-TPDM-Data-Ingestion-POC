...
public class EdFiMethodCreditEarnedDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("methodCreditEarnedDescriptorId")
  private Integer methodCreditEarnedDescriptorId = null;
  ...
  public EdFiMethodCreditEarnedDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiMethodCreditEarnedDescriptor methodCreditEarnedDescriptorId(Integer methodCreditEarnedDescriptorId) {
    this.methodCreditEarnedDescriptorId = methodCreditEarnedDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return methodCreditEarnedDescriptorId
  **/
  ...
  public Integer getMethodCreditEarnedDescriptorId() {
    return methodCreditEarnedDescriptorId;
  }

  public void setMethodCreditEarnedDescriptorId(Integer methodCreditEarnedDescriptorId) {
    this.methodCreditEarnedDescriptorId = methodCreditEarnedDescriptorId;
  }

  public EdFiMethodCreditEarnedDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiMethodCreditEarnedDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiMethodCreditEarnedDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiMethodCreditEarnedDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiMethodCreditEarnedDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiMethodCreditEarnedDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiMethodCreditEarnedDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiMethodCreditEarnedDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiMethodCreditEarnedDescriptor edFiMethodCreditEarnedDescriptor = (EdFiMethodCreditEarnedDescriptor) o;
    return Objects.equals(this.id, edFiMethodCreditEarnedDescriptor.id) &&
        Objects.equals(this.methodCreditEarnedDescriptorId, edFiMethodCreditEarnedDescriptor.methodCreditEarnedDescriptorId) &&
        Objects.equals(this.codeValue, edFiMethodCreditEarnedDescriptor.codeValue) &&
        Objects.equals(this.description, edFiMethodCreditEarnedDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiMethodCreditEarnedDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiMethodCreditEarnedDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiMethodCreditEarnedDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiMethodCreditEarnedDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiMethodCreditEarnedDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiMethodCreditEarnedDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, methodCreditEarnedDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiMethodCreditEarnedDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    methodCreditEarnedDescriptorId: ").append(toIndentedString(methodCreditEarnedDescriptorId)).append("\n");
