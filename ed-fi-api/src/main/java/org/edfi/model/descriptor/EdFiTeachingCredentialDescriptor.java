...
public class EdFiTeachingCredentialDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("teachingCredentialDescriptorId")
  private Integer teachingCredentialDescriptorId = null;
  ...
  public EdFiTeachingCredentialDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiTeachingCredentialDescriptor teachingCredentialDescriptorId(Integer teachingCredentialDescriptorId) {
    this.teachingCredentialDescriptorId = teachingCredentialDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return teachingCredentialDescriptorId
  **/
  ...
  public Integer getTeachingCredentialDescriptorId() {
    return teachingCredentialDescriptorId;
  }

  public void setTeachingCredentialDescriptorId(Integer teachingCredentialDescriptorId) {
    this.teachingCredentialDescriptorId = teachingCredentialDescriptorId;
  }

  public EdFiTeachingCredentialDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiTeachingCredentialDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiTeachingCredentialDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiTeachingCredentialDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiTeachingCredentialDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiTeachingCredentialDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiTeachingCredentialDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiTeachingCredentialDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiTeachingCredentialDescriptor edFiTeachingCredentialDescriptor = (EdFiTeachingCredentialDescriptor) o;
    return Objects.equals(this.id, edFiTeachingCredentialDescriptor.id) &&
        Objects.equals(this.teachingCredentialDescriptorId, edFiTeachingCredentialDescriptor.teachingCredentialDescriptorId) &&
        Objects.equals(this.codeValue, edFiTeachingCredentialDescriptor.codeValue) &&
        Objects.equals(this.description, edFiTeachingCredentialDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiTeachingCredentialDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiTeachingCredentialDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiTeachingCredentialDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiTeachingCredentialDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiTeachingCredentialDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiTeachingCredentialDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, teachingCredentialDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiTeachingCredentialDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    teachingCredentialDescriptorId: ").append(toIndentedString(teachingCredentialDescriptorId)).append("\n");
