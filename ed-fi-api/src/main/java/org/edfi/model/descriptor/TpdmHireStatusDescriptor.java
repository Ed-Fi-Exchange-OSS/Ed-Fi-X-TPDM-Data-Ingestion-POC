...
/**
 * TpdmHireStatusDescriptor
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:43.982-07:00")
public class TpdmHireStatusDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("hireStatusDescriptorId")
  private Integer hireStatusDescriptorId = null;
  ...
  public TpdmHireStatusDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmHireStatusDescriptor hireStatusDescriptorId(Integer hireStatusDescriptorId) {
    this.hireStatusDescriptorId = hireStatusDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return hireStatusDescriptorId
  **/
  ...
  public Integer getHireStatusDescriptorId() {
    return hireStatusDescriptorId;
  }

  public void setHireStatusDescriptorId(Integer hireStatusDescriptorId) {
    this.hireStatusDescriptorId = hireStatusDescriptorId;
  }

  public TpdmHireStatusDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public TpdmHireStatusDescriptor description(String description) {
  ...
  **/
  ...
  public TpdmHireStatusDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public TpdmHireStatusDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public TpdmHireStatusDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public TpdmHireStatusDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public TpdmHireStatusDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public TpdmHireStatusDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmHireStatusDescriptor tpdmHireStatusDescriptor = (TpdmHireStatusDescriptor) o;
    return Objects.equals(this.id, tpdmHireStatusDescriptor.id) &&
        Objects.equals(this.hireStatusDescriptorId, tpdmHireStatusDescriptor.hireStatusDescriptorId) &&
        Objects.equals(this.codeValue, tpdmHireStatusDescriptor.codeValue) &&
        Objects.equals(this.description, tpdmHireStatusDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, tpdmHireStatusDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, tpdmHireStatusDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, tpdmHireStatusDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, tpdmHireStatusDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, tpdmHireStatusDescriptor.shortDescription) &&
        Objects.equals(this.etag, tpdmHireStatusDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, hireStatusDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmHireStatusDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    hireStatusDescriptorId: ").append(toIndentedString(hireStatusDescriptorId)).append("\n");
