...
public class EdFiEmploymentStatusDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("employmentStatusDescriptorId")
  private Integer employmentStatusDescriptorId = null;
  ...
  public EdFiEmploymentStatusDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiEmploymentStatusDescriptor employmentStatusDescriptorId(Integer employmentStatusDescriptorId) {
    this.employmentStatusDescriptorId = employmentStatusDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return employmentStatusDescriptorId
  **/
  ...
  public Integer getEmploymentStatusDescriptorId() {
    return employmentStatusDescriptorId;
  }

  public void setEmploymentStatusDescriptorId(Integer employmentStatusDescriptorId) {
    this.employmentStatusDescriptorId = employmentStatusDescriptorId;
  }

  public EdFiEmploymentStatusDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiEmploymentStatusDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiEmploymentStatusDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiEmploymentStatusDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiEmploymentStatusDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiEmploymentStatusDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiEmploymentStatusDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiEmploymentStatusDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiEmploymentStatusDescriptor edFiEmploymentStatusDescriptor = (EdFiEmploymentStatusDescriptor) o;
    return Objects.equals(this.id, edFiEmploymentStatusDescriptor.id) &&
        Objects.equals(this.employmentStatusDescriptorId, edFiEmploymentStatusDescriptor.employmentStatusDescriptorId) &&
        Objects.equals(this.codeValue, edFiEmploymentStatusDescriptor.codeValue) &&
        Objects.equals(this.description, edFiEmploymentStatusDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiEmploymentStatusDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiEmploymentStatusDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiEmploymentStatusDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiEmploymentStatusDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiEmploymentStatusDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiEmploymentStatusDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, employmentStatusDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiEmploymentStatusDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    employmentStatusDescriptorId: ").append(toIndentedString(employmentStatusDescriptorId)).append("\n");
