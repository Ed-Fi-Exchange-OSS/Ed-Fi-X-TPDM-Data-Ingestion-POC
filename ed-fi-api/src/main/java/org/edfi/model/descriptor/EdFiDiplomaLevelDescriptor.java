...
public class EdFiDiplomaLevelDescriptor   {
  @SerializedName("id")
  private String id = null;

  @SerializedName("diplomaLevelDescriptorId")
  private Integer diplomaLevelDescriptorId = null;
  ...
  public EdFiDiplomaLevelDescriptor id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EdFiDiplomaLevelDescriptor diplomaLevelDescriptorId(Integer diplomaLevelDescriptorId) {
    this.diplomaLevelDescriptorId = diplomaLevelDescriptorId;
    return this;
  }

   /**
   * A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
   * @return diplomaLevelDescriptorId
  **/
  ...
  public Integer getDiplomaLevelDescriptorId() {
    return diplomaLevelDescriptorId;
  }

  public void setDiplomaLevelDescriptorId(Integer diplomaLevelDescriptorId) {
    this.diplomaLevelDescriptorId = diplomaLevelDescriptorId;
  }

  public EdFiDiplomaLevelDescriptor codeValue(String codeValue) {
  ...
  **/
  ...
  public EdFiDiplomaLevelDescriptor description(String description) {
  ...
  **/
  ...
  public EdFiDiplomaLevelDescriptor effectiveBeginDate(LocalDate effectiveBeginDate) {
  ...
  **/
  ...
  public EdFiDiplomaLevelDescriptor effectiveEndDate(LocalDate effectiveEndDate) {
  ...
  **/
  ...
  public EdFiDiplomaLevelDescriptor namespace(String namespace) {
  ...
  **/
  ...
  public EdFiDiplomaLevelDescriptor priorDescriptorId(Integer priorDescriptorId) {
  ...
  **/
  ...
  public EdFiDiplomaLevelDescriptor shortDescription(String shortDescription) {
  ...
  **/
  ...
  public EdFiDiplomaLevelDescriptor etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiDiplomaLevelDescriptor edFiDiplomaLevelDescriptor = (EdFiDiplomaLevelDescriptor) o;
    return Objects.equals(this.id, edFiDiplomaLevelDescriptor.id) &&
        Objects.equals(this.diplomaLevelDescriptorId, edFiDiplomaLevelDescriptor.diplomaLevelDescriptorId) &&
        Objects.equals(this.codeValue, edFiDiplomaLevelDescriptor.codeValue) &&
        Objects.equals(this.description, edFiDiplomaLevelDescriptor.description) &&
        Objects.equals(this.effectiveBeginDate, edFiDiplomaLevelDescriptor.effectiveBeginDate) &&
        Objects.equals(this.effectiveEndDate, edFiDiplomaLevelDescriptor.effectiveEndDate) &&
        Objects.equals(this.namespace, edFiDiplomaLevelDescriptor.namespace) &&
        Objects.equals(this.priorDescriptorId, edFiDiplomaLevelDescriptor.priorDescriptorId) &&
        Objects.equals(this.shortDescription, edFiDiplomaLevelDescriptor.shortDescription) &&
        Objects.equals(this.etag, edFiDiplomaLevelDescriptor.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, diplomaLevelDescriptorId, codeValue, description, effectiveBeginDate, effectiveEndDate, namespace, priorDescriptorId, shortDescription, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdFiDiplomaLevelDescriptor {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    diplomaLevelDescriptorId: ").append(toIndentedString(diplomaLevelDescriptorId)).append("\n");
