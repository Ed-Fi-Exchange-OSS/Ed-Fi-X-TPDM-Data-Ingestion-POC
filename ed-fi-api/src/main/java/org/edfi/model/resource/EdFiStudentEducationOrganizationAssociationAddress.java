...
import org.edfi.model.resource.EdFiStudentEducationOrganizationAssociationAddressPeriod;
...
public class EdFiStudentEducationOrganizationAssociationAddress   {
  ...
  private List<EdFiStudentEducationOrganizationAssociationAddressPeriod> periods = new ArrayList<EdFiStudentEducationOrganizationAssociationAddressPeriod>();

  public EdFiStudentEducationOrganizationAssociationAddress addressTypeDescriptor(String addressTypeDescriptor) {
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress localeDescriptor(String localeDescriptor) {
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress stateAbbreviationDescriptor(String stateAbbreviationDescriptor) {
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress apartmentRoomSuiteNumber(String apartmentRoomSuiteNumber) {
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress buildingSiteNumber(String buildingSiteNumber) {
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress city(String city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress congressionalDistrict(String congressionalDistrict) {
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress countyFIPSCode(String countyFIPSCode) {
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress doNotPublishIndicator(Boolean doNotPublishIndicator) {
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress latitude(String latitude) {
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress longitude(String longitude) {
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress nameOfCounty(String nameOfCounty) {
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress postalCode(String postalCode) {
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress streetNumberName(String streetNumberName) {
  ...
  **/
  ...
  public EdFiStudentEducationOrganizationAssociationAddress periods(List<EdFiStudentEducationOrganizationAssociationAddressPeriod> periods) {
    this.periods = periods;
    return this;
  }

  public EdFiStudentEducationOrganizationAssociationAddress addPeriodsItem(EdFiStudentEducationOrganizationAssociationAddressPeriod periodsItem) {
   ...
   * @return periods
  **/
  @ApiModelProperty(example = "null", value = "An unordered collection of studentEducationOrganizationAssociationAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.")
  public List<EdFiStudentEducationOrganizationAssociationAddressPeriod> getPeriods() {
    return periods;
  }

  public void setPeriods(List<EdFiStudentEducationOrganizationAssociationAddressPeriod> periods) {
    this.periods = periods;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiStudentEducationOrganizationAssociationAddress edFiStudentEducationOrganizationAssociationAddress = (EdFiStudentEducationOrganizationAssociationAddress) o;
    return Objects.equals(this.addressTypeDescriptor, edFiStudentEducationOrganizationAssociationAddress.addressTypeDescriptor) &&
        Objects.equals(this.localeDescriptor, edFiStudentEducationOrganizationAssociationAddress.localeDescriptor) &&
        Objects.equals(this.stateAbbreviationDescriptor, edFiStudentEducationOrganizationAssociationAddress.stateAbbreviationDescriptor) &&
        Objects.equals(this.apartmentRoomSuiteNumber, edFiStudentEducationOrganizationAssociationAddress.apartmentRoomSuiteNumber) &&
        Objects.equals(this.buildingSiteNumber, edFiStudentEducationOrganizationAssociationAddress.buildingSiteNumber) &&
        Objects.equals(this.city, edFiStudentEducationOrganizationAssociationAddress.city) &&
        Objects.equals(this.congressionalDistrict, edFiStudentEducationOrganizationAssociationAddress.congressionalDistrict) &&
        Objects.equals(this.countyFIPSCode, edFiStudentEducationOrganizationAssociationAddress.countyFIPSCode) &&
        Objects.equals(this.doNotPublishIndicator, edFiStudentEducationOrganizationAssociationAddress.doNotPublishIndicator) &&
        Objects.equals(this.latitude, edFiStudentEducationOrganizationAssociationAddress.latitude) &&
        Objects.equals(this.longitude, edFiStudentEducationOrganizationAssociationAddress.longitude) &&
        Objects.equals(this.nameOfCounty, edFiStudentEducationOrganizationAssociationAddress.nameOfCounty) &&
        Objects.equals(this.postalCode, edFiStudentEducationOrganizationAssociationAddress.postalCode) &&
        Objects.equals(this.streetNumberName, edFiStudentEducationOrganizationAssociationAddress.streetNumberName) &&
        Objects.equals(this.periods, edFiStudentEducationOrganizationAssociationAddress.periods);
  }
