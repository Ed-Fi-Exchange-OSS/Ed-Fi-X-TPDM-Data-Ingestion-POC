...
/**
 * EdFiParentPersonalIdentificationDocument
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:29.493-07:00")
public class EdFiParentPersonalIdentificationDocument   {
  ...
  public EdFiParentPersonalIdentificationDocument identificationDocumentUseDescriptor(String identificationDocumentUseDescriptor) {
  ...
  **/
  ...
  public EdFiParentPersonalIdentificationDocument personalInformationVerificationDescriptor(String personalInformationVerificationDescriptor) {
  ...
  **/
  ...
  public EdFiParentPersonalIdentificationDocument issuerCountryDescriptor(String issuerCountryDescriptor) {
  ...
  **/
  ...
  public EdFiParentPersonalIdentificationDocument documentExpirationDate(LocalDate documentExpirationDate) {
  ...
  **/
  ...
  public EdFiParentPersonalIdentificationDocument documentTitle(String documentTitle) {
  ...
  **/
  ...
  public EdFiParentPersonalIdentificationDocument issuerDocumentIdentificationCode(String issuerDocumentIdentificationCode) {
  ...
  **/
  ...
  public EdFiParentPersonalIdentificationDocument issuerName(String issuerName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiParentPersonalIdentificationDocument edFiParentPersonalIdentificationDocument = (EdFiParentPersonalIdentificationDocument) o;
    return Objects.equals(this.identificationDocumentUseDescriptor, edFiParentPersonalIdentificationDocument.identificationDocumentUseDescriptor) &&
        Objects.equals(this.personalInformationVerificationDescriptor, edFiParentPersonalIdentificationDocument.personalInformationVerificationDescriptor) &&
        Objects.equals(this.issuerCountryDescriptor, edFiParentPersonalIdentificationDocument.issuerCountryDescriptor) &&
        Objects.equals(this.documentExpirationDate, edFiParentPersonalIdentificationDocument.documentExpirationDate) &&
        Objects.equals(this.documentTitle, edFiParentPersonalIdentificationDocument.documentTitle) &&
        Objects.equals(this.issuerDocumentIdentificationCode, edFiParentPersonalIdentificationDocument.issuerDocumentIdentificationCode) &&
        Objects.equals(this.issuerName, edFiParentPersonalIdentificationDocument.issuerName);
  }
  ...
  public String toString() {
    ...
    sb.append("class EdFiParentPersonalIdentificationDocument {\n");
