...
public class EdFiPayroll   {
  ...
  **/
   ...
   * @return asOfDate
  **/
  @ApiModelProperty(example = "null", required = true, value = "The date of the reported payroll element.")
  ...
  **/
   ...
   * @return amountToDate
  **/
  @ApiModelProperty(example = "null", required = true, value = "Current balance (amount paid to employee) for account for the fiscal year.")
