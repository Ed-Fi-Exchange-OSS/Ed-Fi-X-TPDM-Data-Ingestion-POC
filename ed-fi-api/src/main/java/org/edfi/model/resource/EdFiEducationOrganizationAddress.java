...
import org.edfi.model.resource.EdFiEducationOrganizationAddressPeriod;
...
public class EdFiEducationOrganizationAddress   {
  ...
  private List<EdFiEducationOrganizationAddressPeriod> periods = new ArrayList<EdFiEducationOrganizationAddressPeriod>();

  public EdFiEducationOrganizationAddress addressTypeDescriptor(String addressTypeDescriptor) {
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress localeDescriptor(String localeDescriptor) {
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress stateAbbreviationDescriptor(String stateAbbreviationDescriptor) {
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress apartmentRoomSuiteNumber(String apartmentRoomSuiteNumber) {
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress buildingSiteNumber(String buildingSiteNumber) {
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress city(String city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress congressionalDistrict(String congressionalDistrict) {
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress countyFIPSCode(String countyFIPSCode) {
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress doNotPublishIndicator(Boolean doNotPublishIndicator) {
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress latitude(String latitude) {
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress longitude(String longitude) {
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress nameOfCounty(String nameOfCounty) {
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress postalCode(String postalCode) {
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress streetNumberName(String streetNumberName) {
  ...
  **/
  ...
  public EdFiEducationOrganizationAddress periods(List<EdFiEducationOrganizationAddressPeriod> periods) {
    this.periods = periods;
    return this;
  }

  public EdFiEducationOrganizationAddress addPeriodsItem(EdFiEducationOrganizationAddressPeriod periodsItem) {
   ...
   * @return periods
  **/
  @ApiModelProperty(example = "null", value = "An unordered collection of educationOrganizationAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.")
  public List<EdFiEducationOrganizationAddressPeriod> getPeriods() {
    return periods;
  }

  public void setPeriods(List<EdFiEducationOrganizationAddressPeriod> periods) {
    this.periods = periods;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiEducationOrganizationAddress edFiEducationOrganizationAddress = (EdFiEducationOrganizationAddress) o;
    return Objects.equals(this.addressTypeDescriptor, edFiEducationOrganizationAddress.addressTypeDescriptor) &&
        Objects.equals(this.localeDescriptor, edFiEducationOrganizationAddress.localeDescriptor) &&
        Objects.equals(this.stateAbbreviationDescriptor, edFiEducationOrganizationAddress.stateAbbreviationDescriptor) &&
        Objects.equals(this.apartmentRoomSuiteNumber, edFiEducationOrganizationAddress.apartmentRoomSuiteNumber) &&
        Objects.equals(this.buildingSiteNumber, edFiEducationOrganizationAddress.buildingSiteNumber) &&
        Objects.equals(this.city, edFiEducationOrganizationAddress.city) &&
        Objects.equals(this.congressionalDistrict, edFiEducationOrganizationAddress.congressionalDistrict) &&
        Objects.equals(this.countyFIPSCode, edFiEducationOrganizationAddress.countyFIPSCode) &&
        Objects.equals(this.doNotPublishIndicator, edFiEducationOrganizationAddress.doNotPublishIndicator) &&
        Objects.equals(this.latitude, edFiEducationOrganizationAddress.latitude) &&
        Objects.equals(this.longitude, edFiEducationOrganizationAddress.longitude) &&
        Objects.equals(this.nameOfCounty, edFiEducationOrganizationAddress.nameOfCounty) &&
        Objects.equals(this.postalCode, edFiEducationOrganizationAddress.postalCode) &&
        Objects.equals(this.streetNumberName, edFiEducationOrganizationAddress.streetNumberName) &&
        Objects.equals(this.periods, edFiEducationOrganizationAddress.periods);
  }
