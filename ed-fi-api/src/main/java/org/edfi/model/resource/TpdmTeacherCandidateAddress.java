...
import org.edfi.model.resource.TpdmTeacherCandidateAddressPeriod;


/**
 * TpdmTeacherCandidateAddress
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:29.493-07:00")
public class TpdmTeacherCandidateAddress   {
  ...
  private List<TpdmTeacherCandidateAddressPeriod> periods = new ArrayList<TpdmTeacherCandidateAddressPeriod>();

  public TpdmTeacherCandidateAddress addressTypeDescriptor(String addressTypeDescriptor) {
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress localeDescriptor(String localeDescriptor) {
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress stateAbbreviationDescriptor(String stateAbbreviationDescriptor) {
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress apartmentRoomSuiteNumber(String apartmentRoomSuiteNumber) {
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress buildingSiteNumber(String buildingSiteNumber) {
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress city(String city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress congressionalDistrict(String congressionalDistrict) {
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress countyFIPSCode(String countyFIPSCode) {
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress doNotPublishIndicator(Boolean doNotPublishIndicator) {
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress latitude(String latitude) {
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress longitude(String longitude) {
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress nameOfCounty(String nameOfCounty) {
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress postalCode(String postalCode) {
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress streetNumberName(String streetNumberName) {
  ...
  **/
  ...
  public TpdmTeacherCandidateAddress periods(List<TpdmTeacherCandidateAddressPeriod> periods) {
    this.periods = periods;
    return this;
  }

  public TpdmTeacherCandidateAddress addPeriodsItem(TpdmTeacherCandidateAddressPeriod periodsItem) {
    this.periods.add(periodsItem);
    return this;
  }

   /**
   * An unordered collection of teacherCandidateAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.
   * @return periods
  **/
  @ApiModelProperty(example = "null", value = "An unordered collection of teacherCandidateAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.")
  public List<TpdmTeacherCandidateAddressPeriod> getPeriods() {
    return periods;
  }

  public void setPeriods(List<TpdmTeacherCandidateAddressPeriod> periods) {
    this.periods = periods;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmTeacherCandidateAddress tpdmTeacherCandidateAddress = (TpdmTeacherCandidateAddress) o;
    return Objects.equals(this.addressTypeDescriptor, tpdmTeacherCandidateAddress.addressTypeDescriptor) &&
        Objects.equals(this.localeDescriptor, tpdmTeacherCandidateAddress.localeDescriptor) &&
        Objects.equals(this.stateAbbreviationDescriptor, tpdmTeacherCandidateAddress.stateAbbreviationDescriptor) &&
        Objects.equals(this.apartmentRoomSuiteNumber, tpdmTeacherCandidateAddress.apartmentRoomSuiteNumber) &&
        Objects.equals(this.buildingSiteNumber, tpdmTeacherCandidateAddress.buildingSiteNumber) &&
        Objects.equals(this.city, tpdmTeacherCandidateAddress.city) &&
        Objects.equals(this.congressionalDistrict, tpdmTeacherCandidateAddress.congressionalDistrict) &&
        Objects.equals(this.countyFIPSCode, tpdmTeacherCandidateAddress.countyFIPSCode) &&
        Objects.equals(this.doNotPublishIndicator, tpdmTeacherCandidateAddress.doNotPublishIndicator) &&
        Objects.equals(this.latitude, tpdmTeacherCandidateAddress.latitude) &&
        Objects.equals(this.longitude, tpdmTeacherCandidateAddress.longitude) &&
        Objects.equals(this.nameOfCounty, tpdmTeacherCandidateAddress.nameOfCounty) &&
        Objects.equals(this.postalCode, tpdmTeacherCandidateAddress.postalCode) &&
        Objects.equals(this.streetNumberName, tpdmTeacherCandidateAddress.streetNumberName) &&
        Objects.equals(this.periods, tpdmTeacherCandidateAddress.periods);
  }
  ...
  public String toString() {
    ...
    sb.append("class TpdmTeacherCandidateAddress {\n");
