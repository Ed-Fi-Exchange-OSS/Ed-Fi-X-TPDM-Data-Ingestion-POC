...
public class Link   {
   ...
   * @return rel
  **/
  @ApiModelProperty(example = "null", value = "Describes the nature of the relationship to the referenced resource.")
   ...
   * @return href
  **/
  @ApiModelProperty(example = "null", value = "The URL to the related resource.")
