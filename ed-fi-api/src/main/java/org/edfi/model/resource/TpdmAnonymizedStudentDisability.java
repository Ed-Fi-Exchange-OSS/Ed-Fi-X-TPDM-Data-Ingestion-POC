...
import org.edfi.model.resource.TpdmAnonymizedStudentDisabilityDesignation;


/**
 * TpdmAnonymizedStudentDisability
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:29.493-07:00")
public class TpdmAnonymizedStudentDisability   {
  ...
  private List<TpdmAnonymizedStudentDisabilityDesignation> designations = new ArrayList<TpdmAnonymizedStudentDisabilityDesignation>();

  public TpdmAnonymizedStudentDisability disabilityDescriptor(String disabilityDescriptor) {
  ...
  **/
  ...
  public TpdmAnonymizedStudentDisability disabilityDeterminationSourceTypeDescriptor(String disabilityDeterminationSourceTypeDescriptor) {
  ...
  **/
  ...
  public TpdmAnonymizedStudentDisability disabilityDiagnosis(String disabilityDiagnosis) {
  ...
  **/
  ...
  public TpdmAnonymizedStudentDisability orderOfDisability(Integer orderOfDisability) {
  ...
  **/
  ...
  public TpdmAnonymizedStudentDisability designations(List<TpdmAnonymizedStudentDisabilityDesignation> designations) {
    this.designations = designations;
    return this;
  }

  public TpdmAnonymizedStudentDisability addDesignationsItem(TpdmAnonymizedStudentDisabilityDesignation designationsItem) {
    this.designations.add(designationsItem);
    return this;
  }

   /**
   * An unordered collection of anonymizedStudentDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.
   * @return designations
  **/
  @ApiModelProperty(example = "null", value = "An unordered collection of anonymizedStudentDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.")
  public List<TpdmAnonymizedStudentDisabilityDesignation> getDesignations() {
    return designations;
  }

  public void setDesignations(List<TpdmAnonymizedStudentDisabilityDesignation> designations) {
    this.designations = designations;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmAnonymizedStudentDisability tpdmAnonymizedStudentDisability = (TpdmAnonymizedStudentDisability) o;
    return Objects.equals(this.disabilityDescriptor, tpdmAnonymizedStudentDisability.disabilityDescriptor) &&
        Objects.equals(this.disabilityDeterminationSourceTypeDescriptor, tpdmAnonymizedStudentDisability.disabilityDeterminationSourceTypeDescriptor) &&
        Objects.equals(this.disabilityDiagnosis, tpdmAnonymizedStudentDisability.disabilityDiagnosis) &&
        Objects.equals(this.orderOfDisability, tpdmAnonymizedStudentDisability.orderOfDisability) &&
        Objects.equals(this.designations, tpdmAnonymizedStudentDisability.designations);
  }
  ...
  public String toString() {
    ...
    sb.append("class TpdmAnonymizedStudentDisability {\n");
