...
/**
 * TpdmEducationOrganizationSurveyResponseFacts
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:29.493-07:00")
public class TpdmEducationOrganizationSurveyResponseFacts   {
  @SerializedName("id")
  ...
  public TpdmEducationOrganizationSurveyResponseFacts id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TpdmEducationOrganizationSurveyResponseFacts factsAsOfDate(LocalDate factsAsOfDate) {
  ...
  **/
  ...
  public TpdmEducationOrganizationSurveyResponseFacts educationOrganizationReference(EdFiEducationOrganizationReference educationOrganizationReference) {
  ...
  **/
  ...
  public TpdmEducationOrganizationSurveyResponseFacts schoolYearTypeReference(EdFiSchoolYearTypeReference schoolYearTypeReference) {
  ...
  **/
  ...
  public TpdmEducationOrganizationSurveyResponseFacts surveyReference(TpdmSurveyReference surveyReference) {
  ...
  **/
  ...
  public TpdmEducationOrganizationSurveyResponseFacts etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmEducationOrganizationSurveyResponseFacts tpdmEducationOrganizationSurveyResponseFacts = (TpdmEducationOrganizationSurveyResponseFacts) o;
    return Objects.equals(this.id, tpdmEducationOrganizationSurveyResponseFacts.id) &&
        Objects.equals(this.factsAsOfDate, tpdmEducationOrganizationSurveyResponseFacts.factsAsOfDate) &&
        Objects.equals(this.educationOrganizationReference, tpdmEducationOrganizationSurveyResponseFacts.educationOrganizationReference) &&
        Objects.equals(this.schoolYearTypeReference, tpdmEducationOrganizationSurveyResponseFacts.schoolYearTypeReference) &&
        Objects.equals(this.surveyReference, tpdmEducationOrganizationSurveyResponseFacts.surveyReference) &&
        Objects.equals(this.etag, tpdmEducationOrganizationSurveyResponseFacts.etag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, factsAsOfDate, educationOrganizationReference, schoolYearTypeReference, surveyReference, etag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TpdmEducationOrganizationSurveyResponseFacts {\n");
