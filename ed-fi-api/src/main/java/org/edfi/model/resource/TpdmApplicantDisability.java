...
import org.edfi.model.resource.TpdmApplicantDisabilityDesignation;


/**
 * TpdmApplicantDisability
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:29.493-07:00")
public class TpdmApplicantDisability   {
  ...
  private List<TpdmApplicantDisabilityDesignation> designations = new ArrayList<TpdmApplicantDisabilityDesignation>();

  public TpdmApplicantDisability disabilityDescriptor(String disabilityDescriptor) {
  ...
  **/
  ...
  public TpdmApplicantDisability disabilityDeterminationSourceTypeDescriptor(String disabilityDeterminationSourceTypeDescriptor) {
  ...
  **/
  ...
  public TpdmApplicantDisability disabilityDiagnosis(String disabilityDiagnosis) {
  ...
  **/
  ...
  public TpdmApplicantDisability orderOfDisability(Integer orderOfDisability) {
  ...
  **/
  ...
  public TpdmApplicantDisability designations(List<TpdmApplicantDisabilityDesignation> designations) {
    this.designations = designations;
    return this;
  }

  public TpdmApplicantDisability addDesignationsItem(TpdmApplicantDisabilityDesignation designationsItem) {
    this.designations.add(designationsItem);
    return this;
  }

   /**
   * An unordered collection of applicantDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.
   * @return designations
  **/
  @ApiModelProperty(example = "null", value = "An unordered collection of applicantDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.")
  public List<TpdmApplicantDisabilityDesignation> getDesignations() {
    return designations;
  }

  public void setDesignations(List<TpdmApplicantDisabilityDesignation> designations) {
    this.designations = designations;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmApplicantDisability tpdmApplicantDisability = (TpdmApplicantDisability) o;
    return Objects.equals(this.disabilityDescriptor, tpdmApplicantDisability.disabilityDescriptor) &&
        Objects.equals(this.disabilityDeterminationSourceTypeDescriptor, tpdmApplicantDisability.disabilityDeterminationSourceTypeDescriptor) &&
        Objects.equals(this.disabilityDiagnosis, tpdmApplicantDisability.disabilityDiagnosis) &&
        Objects.equals(this.orderOfDisability, tpdmApplicantDisability.orderOfDisability) &&
        Objects.equals(this.designations, tpdmApplicantDisability.designations);
  }
  ...
  public String toString() {
    ...
    sb.append("class TpdmApplicantDisability {\n");
