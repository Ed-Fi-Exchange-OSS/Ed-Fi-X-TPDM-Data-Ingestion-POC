...
import org.edfi.model.resource.EdFiParentAddressPeriod;
...
public class EdFiParentAddress   {
  ...
  private List<EdFiParentAddressPeriod> periods = new ArrayList<EdFiParentAddressPeriod>();

  public EdFiParentAddress addressTypeDescriptor(String addressTypeDescriptor) {
  ...
  **/
  ...
  public EdFiParentAddress localeDescriptor(String localeDescriptor) {
  ...
  **/
  ...
  public EdFiParentAddress stateAbbreviationDescriptor(String stateAbbreviationDescriptor) {
  ...
  **/
  ...
  public EdFiParentAddress apartmentRoomSuiteNumber(String apartmentRoomSuiteNumber) {
  ...
  **/
  ...
  public EdFiParentAddress buildingSiteNumber(String buildingSiteNumber) {
  ...
  **/
  ...
  public EdFiParentAddress city(String city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public EdFiParentAddress congressionalDistrict(String congressionalDistrict) {
  ...
  **/
  ...
  public EdFiParentAddress countyFIPSCode(String countyFIPSCode) {
  ...
  **/
  ...
  public EdFiParentAddress doNotPublishIndicator(Boolean doNotPublishIndicator) {
  ...
  **/
  ...
  public EdFiParentAddress latitude(String latitude) {
  ...
  **/
  ...
  public EdFiParentAddress longitude(String longitude) {
  ...
  **/
  ...
  public EdFiParentAddress nameOfCounty(String nameOfCounty) {
  ...
  **/
  ...
  public EdFiParentAddress postalCode(String postalCode) {
  ...
  **/
  ...
  public EdFiParentAddress streetNumberName(String streetNumberName) {
  ...
  **/
  ...
  public EdFiParentAddress periods(List<EdFiParentAddressPeriod> periods) {
    this.periods = periods;
    return this;
  }

  public EdFiParentAddress addPeriodsItem(EdFiParentAddressPeriod periodsItem) {
    this.periods.add(periodsItem);
    return this;
  }

   /**
   * An unordered collection of parentAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.
   * @return periods
  **/
  @ApiModelProperty(example = "null", value = "An unordered collection of parentAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.")
  public List<EdFiParentAddressPeriod> getPeriods() {
    return periods;
  }

  public void setPeriods(List<EdFiParentAddressPeriod> periods) {
    this.periods = periods;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EdFiParentAddress edFiParentAddress = (EdFiParentAddress) o;
    return Objects.equals(this.addressTypeDescriptor, edFiParentAddress.addressTypeDescriptor) &&
        Objects.equals(this.localeDescriptor, edFiParentAddress.localeDescriptor) &&
        Objects.equals(this.stateAbbreviationDescriptor, edFiParentAddress.stateAbbreviationDescriptor) &&
        Objects.equals(this.apartmentRoomSuiteNumber, edFiParentAddress.apartmentRoomSuiteNumber) &&
        Objects.equals(this.buildingSiteNumber, edFiParentAddress.buildingSiteNumber) &&
        Objects.equals(this.city, edFiParentAddress.city) &&
        Objects.equals(this.congressionalDistrict, edFiParentAddress.congressionalDistrict) &&
        Objects.equals(this.countyFIPSCode, edFiParentAddress.countyFIPSCode) &&
        Objects.equals(this.doNotPublishIndicator, edFiParentAddress.doNotPublishIndicator) &&
        Objects.equals(this.latitude, edFiParentAddress.latitude) &&
        Objects.equals(this.longitude, edFiParentAddress.longitude) &&
        Objects.equals(this.nameOfCounty, edFiParentAddress.nameOfCounty) &&
        Objects.equals(this.postalCode, edFiParentAddress.postalCode) &&
        Objects.equals(this.streetNumberName, edFiParentAddress.streetNumberName) &&
        Objects.equals(this.periods, edFiParentAddress.periods);
  }
  ...
  public String toString() {
    ...
    sb.append("class EdFiParentAddress {\n");
