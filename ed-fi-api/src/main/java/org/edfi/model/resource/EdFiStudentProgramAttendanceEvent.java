...
public class EdFiStudentProgramAttendanceEvent   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, attendanceEventCategoryDescriptor, eventDate, educationOrganizationReference, programReference, studentReference, attendanceEventReason, educationalEnvironmentDescriptor, eventDuration, etag);
  }
