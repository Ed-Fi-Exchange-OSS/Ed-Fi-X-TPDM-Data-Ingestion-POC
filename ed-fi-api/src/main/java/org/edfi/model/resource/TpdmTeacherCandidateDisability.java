...
import org.edfi.model.resource.TpdmTeacherCandidateDisabilityDesignation;


/**
 * TpdmTeacherCandidateDisability
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-09T12:36:29.493-07:00")
public class TpdmTeacherCandidateDisability   {
  ...
  private List<TpdmTeacherCandidateDisabilityDesignation> designations = new ArrayList<TpdmTeacherCandidateDisabilityDesignation>();

  public TpdmTeacherCandidateDisability disabilityDescriptor(String disabilityDescriptor) {
  ...
  **/
  ...
  public TpdmTeacherCandidateDisability disabilityDeterminationSourceTypeDescriptor(String disabilityDeterminationSourceTypeDescriptor) {
  ...
  **/
  ...
  public TpdmTeacherCandidateDisability disabilityDiagnosis(String disabilityDiagnosis) {
  ...
  **/
  ...
  public TpdmTeacherCandidateDisability orderOfDisability(Integer orderOfDisability) {
  ...
  **/
  ...
  public TpdmTeacherCandidateDisability designations(List<TpdmTeacherCandidateDisabilityDesignation> designations) {
    this.designations = designations;
    return this;
  }

  public TpdmTeacherCandidateDisability addDesignationsItem(TpdmTeacherCandidateDisabilityDesignation designationsItem) {
    this.designations.add(designationsItem);
    return this;
  }

   /**
   * An unordered collection of teacherCandidateDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.
   * @return designations
  **/
  @ApiModelProperty(example = "null", value = "An unordered collection of teacherCandidateDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.")
  public List<TpdmTeacherCandidateDisabilityDesignation> getDesignations() {
    return designations;
  }

  public void setDesignations(List<TpdmTeacherCandidateDisabilityDesignation> designations) {
    this.designations = designations;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TpdmTeacherCandidateDisability tpdmTeacherCandidateDisability = (TpdmTeacherCandidateDisability) o;
    return Objects.equals(this.disabilityDescriptor, tpdmTeacherCandidateDisability.disabilityDescriptor) &&
        Objects.equals(this.disabilityDeterminationSourceTypeDescriptor, tpdmTeacherCandidateDisability.disabilityDeterminationSourceTypeDescriptor) &&
        Objects.equals(this.disabilityDiagnosis, tpdmTeacherCandidateDisability.disabilityDiagnosis) &&
        Objects.equals(this.orderOfDisability, tpdmTeacherCandidateDisability.orderOfDisability) &&
        Objects.equals(this.designations, tpdmTeacherCandidateDisability.designations);
  }
  ...
  public String toString() {
    ...
    sb.append("class TpdmTeacherCandidateDisability {\n");
