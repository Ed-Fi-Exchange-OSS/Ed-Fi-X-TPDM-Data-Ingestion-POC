...
public class EdFiCourseOfferingCourseLevelCharacteristic   {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "The type of specific program or designation with which the course offering is associated (e.g., AP, IB, Dual Credit, CTE). This collection should only be populated if it differs from the Course Level Characteristics identified at the Course level.")
