...
public class EdFiEducationOrganizationCategory   {
  @SerializedName("educationOrganizationCategoryDescriptor")
  private String educationOrganizationCategoryDescriptor = null;
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "The classification of the education agency within the geographic boundaries of a state according to the level of administrative and operational control granted by the state.")
